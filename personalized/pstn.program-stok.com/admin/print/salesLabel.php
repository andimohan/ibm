...
if($rs[0]['isdropship'] == 1){ 
    ...
    //sementara
    $tempCust = array(1,2,3,5,8);
    $companyName = (in_array($rs[0]['customerkey'],$tempCust )) ? 'POSITANO'  : $obj->loadSetting('companyName')  ;
...
if(!empty($rs[0]['trdesc'])){
    $desc = '<br><br>'.str_replace(chr(13),'<br>',$rs[0]['trdesc']);
}
