...
$useItemGroup = $obj->isActiveModule('AssetItem');
...
$arrPurchaseGroup = $obj->convertForCombobox($item->searchItemGroup(),'pkey', 'name');  
  ...
  <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>">
       ...
       <div class="div-table main-tab-table-2">
        ...
        <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; ">
                <div class="div-table-row"> 
                    <?php if ($useItemGroup) { ?>
                    <div class="div-table-col detail-col-header" style="width:120px;"><?php echo ucwords($obj->lang['itemType']); ?></div>
                    <?php } ?>
                    <div class="div-table-col detail-col-header"><?php echo ucwords($obj->lang['itemOrService']); ?></div>
                    <div class="div-table-col detail-col-header" style="width:100px; ">
                ...
                <?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $readOnlyGrouping = ($rsPurchaseDetail[$i]['itemgroupkey'] == 1) ? true : false;
                            $readOnlyGroupingUnit = ($rsPurchaseDetail[$i]['itemgroupkey'] == 2) ? true : false;
                            ...
                            $_POST['selPurchaseGroup[]'] =  $rsPurchaseDetail[$i]['itemgroupkey'];
                            ...
                            $_POST['serialNumber[]'] = $rsPurchaseDetail[$i]['serialnumber'];
                            $_POST['hidBrandDetailKey[]'] = $rsPurchaseDetail[$i]['brandkey'];
                            $_POST['brandNameDetail[]'] = $rsPurchaseDetail[$i]['brandname'];
                            $_POST['typeNameDetail[]'] = $rsPurchaseDetail[$i]['typename'];
                            $_POST['hidTypeDetailKey[]'] = $rsPurchaseDetail[$i]['typekey'];
                            $_POST['categoryDetailName[]'] = $rsPurchaseDetail[$i]['assetcategoryname'];
                            $_POST['hidCategoryDetailKey[]'] = $rsPurchaseDetail[$i]['categorykey'];

                            if($rsPurchaseDetail[$i]['itemgroupkey'] == 1) {
                                $isUnit = "display:none;";
                                $isSparePart = "";
                            } else {
                                $isUnit = "";
                                $isSparePart = "display:none;";
                            }
                            
                            // $arrUnit = $obj->convertForCombobox($item->getAvailableUnit($rsPurchaseDetail[$i]['itemkey']),'conversionunitkey','unitname'); 
                            $arrUnit = ($rsPurchaseDetail[$i]['itemgroupkey'] == 2) ? $arrDefaultUnit : $obj->convertForCombobox($item->getAvailableUnit($rsPurchaseDetail[$i]['itemkey']),'conversionunitkey','unitname');
                        } 
                          
                ?>
                <div class="div-table-row <?php echo $class; ?>">
                    <?php if ($useItemGroup) { ?>
                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputSelect('selPurchaseGroup[]',$arrPurchaseGroup, array('overwritePost' => $overwrite, 'etc' =>  $etc)); ?></div> 
                    <?php } ?>
                    ...
                    <div class="div-table-col detail-col-detail">
                        <div class="is-spare-part" style="<?php echo $isSparePart ?>">
                            <?php echo $obj->inputText('itemName[]',array('overwritePost' => $overwrite, 'etc' =>  $etc,'add-class'=>'mnv-barcode-input')); ?>
                        </div>
                        <div class="is-unit" style="<?php echo $isUnit ?>">
                            <?php echo $obj->inputText('detailName[]', array('overwritePost' => $overwrite, 'etc' => $etc, 'add-class' => 'mnv-barcode-input')); ?>
                        </div>
                    ...
                    <div class="div-table-col detail-col-detail">
                        <?php echo $obj->inputText('brandNameDetail[]', array('readonly' => $readOnlyGrouping, 'overwritePost' => $overwrite, 'etc' =>  $etc)); ?>
                        <?php echo $obj->inputHidden('hidBrandDetailKey[]', array('overwritePost' => $overwrite, 'etc' => $etc)); ?>
                    </div>
                    <div class="div-table-col detail-col-detail">
                        <?php echo $obj->inputText('typeNameDetail[]', array('readonly' => $readOnlyGrouping, 'overwritePost' => $overwrite, 'etc' =>  $etc)); ?>
                        <?php echo $obj->inputHidden('hidTypeDetailKey[]', array('overwritePost' => $overwrite, 'etc' => $etc)); ?>
                    </div>
                    <div class="div-table-col detail-col-detail">
                        <?php echo $obj->inputText('serialNumber[]', array('readonly' => $readOnlyGrouping, 'overwritePost' => $overwrite, 'etc' =>  $etc)); ?>
                    </div>
                    <div class="div-table-col detail-col-detail">
                        <?php echo $obj->inputText('categoryDetailName[]', array('readonly' => $readOnlyGrouping, 'overwritePost' => $overwrite, 'etc' =>  $etc)); ?>
                        <?php echo $obj->inputHidden('hidCategoryDetailKey[]', array('overwritePost' => $overwrite, 'etc' => $etc)); ?>
                    </div>
                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputNumber('qty[]', array('readonly' => $readOnlyGroupingUnit,'overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' .$etc)); ?></div>
