        ...
        <td style="width: 430px;">
            <table cellpadding="2" >
                ...
                <tr>
                    ...
                    <td class="colon">:</td>
                    <td class="footer-body">PT. Niagara Air Biru</td>
                </tr>
                <tr>
                    <td class="footer-title">A/C No.</td>
                    <td class="colon">:</td>
                    <td class="footer-body" >0733112244</td>
                </tr>
                <tr>
                    <td class="footer-title">Bank</td>
                    <td class="colon">:</td>
                    <td class="footer-body" >BCA KCP Tomang Tol</td>
                </tr>
                <tr>
                    <td class="footer-title">Bank Add.</td>
                    <td class="colon">:</td>
                    <td class="footer-body" >Jl. Arjuna Kav. 8 A/1 Jakarta 11470</td>
                </tr>
            </table>
        </td>
...
<table style="font-size: 0.9em;">
    ...
    <tr>
        ...
        <td>niagaraairbiru@gmail.com</td>
</tr>
</table>
';
