...
<tr><td class="header-row-header">AJU / PIB</td><td style="text-align:center">:</td><td>'.$rs[0]['aju'].' / '.$rs[0]['peb'].'</td></tr></table>
...
if(!empty($rsRefund)){ 
$html .='<div style="clear:both; text-align:left" class="subtitle"><strong>'.strtoupper($obj->lang['purchaseRefund']).'</strong></div>
<br>';                                 
