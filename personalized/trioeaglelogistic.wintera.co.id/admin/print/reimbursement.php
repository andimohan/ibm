...
<div style="font-size:2em; font-weight:bold">REIMBURSEMENT'.$draft.'</div><br>
...
$isreimburse = '<i>Invoice Reimbursement ini bukan merupakan Objek Pemotongan PPh 23.( PMK No. 141/PMK.03/2015 Pasal 1 ayat (3) huruf b angka 4 )</i>';
$html .='<div style="clear:both;"></div><u><strong>NOTE</strong></u>:<br>'. $isreimburse;   
...
$html .='<tr><td  style="width: 20px">1.</td><td style="width: 650px">Tagihan ini sudah mengenakan bea materai sebagaimana diatur  dalam Undang-undang No.10 tahun 2020.</td></tr>
</table>';
