...
if (isset($_POST) && !empty($_POST['hidAction'])){   
    ...
    $rsAPCol = $apCommission->searchDataRow( array($apCommission->tableName.'.pkey', 
                                      $apCommission->tableName.'.code', 
                                      $apCommission->tableName.'.refcode', 
                                      $apCommission->tableName.'.trdate', 
                                      $apCommission->tableName.'.amount',  
                                      $apCommission->tableName.'.rate',  
                                      $apCommission->tableName.'.reftabletype',  
                                      $apCommission->tableName.'.refheaderkey',  
                                      $apCommission->tableName.'.currencykey'), 
                                   ' and ' . $apCommission->tableName.'.pkey in ('.$class->oDbCon->paramString($arrDetailAPKey,',').')' 
                              ); 
	...
	// !!! REFUND BISA DARI JO ATAU JO HEADER KEDEPANNYA !!! , SKRG BARU DR JO SAJA
    ...
    $rsJOHeaderCol = array_column($rsJOHeaderCol,null,'pkey');
 	...
 	$obj->setLog($arrRefJOHeaderKey,true);
