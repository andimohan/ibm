...
includeClass(array("Warehouse.class.php", "Brand.class.php"));
...
if (!empty($_GET['id'])) {
    ...
    $_POST['location'] = $rs[0]['location'];
    $_POST['phone'] = $rs[0]['phone'];
    $_POST['defaultCommission'] = $obj->formatNumber($rs[0]['defaultcommission']);
    $_POST['hidSalesKey'] = $rs[0]['saleskey'];
    $_POST['hidBrandKey'] = $rs[0]['brandkey'];

    if (!empty($rs[0]['saleskey'])) {
        $rsEmployee = $employee->searchDataRow(
            array($employee->tableName . '.pkey', $employee->tableName . '.name'),
            ' and ' . $employee->tableName . '.pkey = ' . $obj->oDbCon->paramString($rs[0]['saleskey'])
        );
    ...
    if (!empty($rs[0]['brandkey'])) {
        $rsBrand = $brand->searchDataRow(
            array($brand->tableName . '.pkey', $brand->tableName . '.name'),
            ' and ' . $brand->tableName . '.pkey = ' . $obj->oDbCon->paramString($rs[0]['brandkey'])
        );
    ...
    $_POST['chkIsNonLabeling'] = $rs[0]['isnonlabeling'];
...
$arrPaymentMethod = ($class->isActiveModule('PaymentMethod')) ? $paymentMethod->searchData('', '', true, ' and (' . $paymentMethod->tableName . '.statuskey = 1)') : array();
                ...
                <div class="div-table-row">
                    <div class="div-table-col">
                        <div class="div-tab-panel">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['stock']); ?></label>
                                <div class="col-xs-9" style="padding-top:0.5em; padding-bottom:0.5em">
                                    <div class="flex">
                                        ...
                                        <div style="margin-left:1.5em">
                                            <?php echo $obj->inputCheckBox('webqoh', array('value' => 1)); ?>
                                        </div>
                                        <div> <?php echo ucwords($obj->lang['webstore']); ?></div>
                                        <div style="margin-left:1.5em"> <?php echo $obj->inputCheckBox('isrma'); ?>
                                        </div>
                                        <div> <?php echo $obj->lang['rma']; ?></div>
                                        <div style="margin-left:1.5em"> <?php echo $obj->inputCheckBox('isbus'); ?>
                                        </div>
                                        <div>BUS</div>
                                        <div style="margin-left:1.5em"> <?php echo $obj->inputCheckBox('isvendor'); ?>
                                        </div>
                                        <div>Vendor</div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['orderList']); ?></label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['commission']); ?></label>
                                <div class="col-xs-9">
                                    <?php echo $obj->inputNumber('defaultCommission'); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['brand']); ?></label>
                                <div class="col-xs-9">
                                    <?php
                            ...
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['primarySalesman']); ?></label>
                                <div class="col-xs-9">
                                    <?php
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 control-label" style="padding-top:0">
                                    <?php echo ucwords($obj->lang['isNonLabeling']); ?>
                                </label>
                                <div class="col-xs-9">
                                    <?php echo $obj->inputCheckBox('chkIsNonLabeling'); ?>
                                </div>
                            </div>
                    ...
                    <div class="div-table-col">
                        ...
                        <div class="div-tab-panel">
                            <div class="div-table-caption border-purple"><?php echo ucwords($obj->lang['location']); ?>
                            </div>
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['address']); ?></label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['zipcode']); ?></label>
                                <div class="col-xs-9">
                                    <?php echo $class->inputText('zip'); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['location']); ?>
                                    <div style="font-size:0.9em;" class="text-muted">(Lat, Lng)</div>
                                </label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['phone']); ?></label>
                                <div class="col-xs-9">
                                    <?php echo $class->inputText('phone'); ?>
                                </div>
                            </div>
                ...
                <div class="div-table main-tab-table-2">
                    ...
                    <div class="div-table-row">
                        <div class="div-table-col">
                            ...
                            <div class="div-tab-panel">
                                <div class="div-table-caption border-green"><?php echo strtoupper($obj->lang['coalink']); ?>
                                </div>
                                ...
                                <?php for ($i = 0; $i < count($arrPaymentMethod); $i++) {
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo $arrPaymentMethod[$i]['name']; ?></label>
                                        <div class="col-xs-9">
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['opsCashBank']); ?></label>
                                    <div class="col-xs-9">
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['driverCashBank']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <?php if ($obj->isActiveModule('AssetItem')) { ?>
                                    <div class="col-xs-12 section-title">
                                        <?php echo strtoupper($obj->lang['inventoryAssetItem']); ?>
                                    </div>

                                    <?php
                                    // persediaan  per gudang
                            
                                    $rsCOALink = $coaLink->getCOALink('inventoryassetitem', $obj->tableName, $warehousekey, 0);
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo ucwords($obj->lang['inventoryAssetItem']); ?></label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'inventoryassetitem')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
                                    <?php

                                    $rsCOALink = $coaLink->getCOALink('inventoryassetitemtemp', $obj->tableName, $warehousekey, 0);
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo ucwords($obj->lang['tempAssetItemInventory']); ?></label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'inventoryassetitemtemp')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="col-xs-12 section-title"><?php echo strtoupper($obj->lang['inventory']); ?>
                                </div>
                                ...
                                if ($obj->loadSetting('inventoryCOAType') == 1) {
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo ucwords($obj->lang['inventory']); ?></label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                if ($obj->loadSetting('inventoryCOAType') == 1) {
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo ucwords($obj->lang['tempInventory']); ?></label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo strtoupper($obj->lang['cogs']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="col-xs-12 section-title"><?php echo strtoupper($obj->lang['purchasing']); ?>
                                </div>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['purchaseRetailDiscount']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9"> 
                                ...
                                <div class="col-xs-12 section-title">
                                    <?php echo strtoupper($obj->lang['sales']) . ' &amp; ' . strtoupper($obj->lang['revenue']); ?>
                                </div>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['salesService']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['salesServiceDiscount']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['salesRetail']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['salesRetailDiscount']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['otherRevenue']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['profitLossRate']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <?php if (PLAN_TYPE['categorykey'] == COMPANY_TYPE['property']) { ?>
                                    <?php

                                    $rsCOALink = $coaLink->getCOALink('orlead', $obj->tableName, $warehousekey, 0);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'orlead')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
                                    ...
                                    $rsCOALink = $coaLink->getCOALink('bankprovision', $obj->tableName, $warehousekey, 0);
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo ucwords($obj->lang['bankProvision']); ?></label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'bankprovision')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
                                    ...
                                    $rsCOALink = $coaLink->getCOALink('adminrevenue', $obj->tableName, $warehousekey, 0);
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo ucwords($obj->lang['adminRevenue']); ?></label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'adminrevenue')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xs-12 section-title"><?php echo strtoupper($obj->lang['downpayment']); ?>
                                </div>
                                <?php
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['customerDownpayment']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['supplierDownpayment']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                        ...
                        <div class="div-table-col">
                            ...
                            <div class="div-tab-panel">
                                <div class="div-table-caption border-green" style="border-color:#fff !important">&nbsp;
                                </div>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['accountsReceivable']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <?php if ($obj->loadSetting('splitARReimbursement') == 1) { ?>
                                    <?php
                                    $rsCOALink = $coaLink->getCOALink('arreimbursement', $obj->tableName, $warehousekey, 0);
                                    $_POST['hidcoakey[]'] = '';
                                    $_POST['coalink[]'] = '';
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo ucwords($obj->lang['arReimbursement']); ?></label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'arreimbursement')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['employeeAR']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['writeOffAccountsReceivable']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
...
-->
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['accountsPayable']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['employeeAP']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['commissionAP']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">  
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['operationalCost']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['outsourceCost']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['maintenanceCost']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label class="col-xs-3 control-label"
                                        style="padding-top:0"><?php echo ucwords($obj->lang['commissionCost']); ?>
                                        (<?php echo ucwords($obj->lang['employee']); ?>)</label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <?php
                                if (PLAN_TYPE['categorykey'] == 8) {
                                    $rsCOALink = $coaLink->getCOALink('driverincentive', $obj->tableName, $warehousekey, 0);
                                    $_POST['hidcoakey[]'] = '';
                                    $_POST['coalink[]'] = '';
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo ucwords($obj->lang['driverIncentive']); ?></label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'driverincentive')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <?php
                                // kedepanny hanya forwarding
                                if (in_array(PLAN_TYPE['categorykey'], array(COMPANY_TYPE['trucking'], COMPANY_TYPE['forwarding']))) { ?>
                                    <?php
                                    $rsCOALink = $coaLink->getCOALink('purchaserefundcost', $obj->tableName, $warehousekey, 0);
                                    $_POST['hidcoakey[]'] = '';
                                    $_POST['coalink[]'] = '';
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"
                                            style="padding-top:0"><?php echo ucwords($obj->lang['commissionCost']); ?>
                                            (<?php echo ucwords($obj->lang['supplier']); ?>)</label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'purchaserefundcost')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['shippingCost']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['inventoryAdjustment']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                $rsCOALink = $coaLink->getCOALink('adminfeecost', $obj->tableName, $warehousekey, 0);
                                $_POST['hidcoakey[]'] = '';
                                $_POST['coalink[]'] = '';
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['adminFee']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                        <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'adminfeecost')); ?>
                                        <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                    </div>
                                </div>
                                ...
                                $rsCOALink = $coaLink->getCOALink('stampfee', $obj->tableName, $warehousekey, 0);
                                $_POST['hidcoakey[]'] = '';
                                $_POST['coalink[]'] = '';
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['stampFee']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                        <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'stampfee')); ?>
                                        <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['otherCost']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <?php if ($obj->loadSetting('usePrepaidExpense') == 1) { ?>
                                    <?php

                                    $rsCOALink = $coaLink->getCOALink('prepaidexpense', $obj->tableName, $warehousekey, 0);
                                    $_POST['hidcoakey[]'] = '';
                                    $_POST['coalink[]'] = '';
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-xs-3 control-label"><?php echo ucwords($obj->lang['prepaidExpense']); ?></label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'prepaidexpense')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
                                <?php } ?>

                                <div class="col-xs-12 section-title"><?php echo strtoupper($obj->lang['asset']); ?></div>

                                <?php
                                $rsCOALink = $coaLink->getCOALink('asset', $obj->tableName, $warehousekey, 0);
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['asset']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                        <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'asset')); ?>
                                        <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                    </div>
                                </div>

                                <?php
                                $rsCOALink = $coaLink->getCOALink('depreciationExpense', $obj->tableName, $warehousekey, 0);
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['depreciationExpense']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                        <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'depreciationExpense')); ?>
                                        <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                    </div>
                                </div>

                                <?php
                                $rsCOALink = $coaLink->getCOALink('accumulatedDepreciation', $obj->tableName, $warehousekey, 0);
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['accumulatedDepreciation']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                        <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'accumulatedDepreciation')); ?>
                                        <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['vatOut']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['vatIn']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['payableTax23']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['prepaidTax23']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                ...
                                <?php if ($obj->loadSetting('tax23GLInInvoice') == 1) { ?>

                                    <?php
                                    // pajak pph 23 prepaid
                                    $rsCOALink = $coaLink->getCOALink('prepaidtax23Counter', $obj->tableName, $warehousekey, 0);
                                    $_POST['hidcoakey[]'] = '';
                                    $_POST['coalink[]'] = '';
                                    ...
                                    ?>
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['prepaidTax23']); ?>
                                            (<?php echo ucwords($obj->lang['counterAccount']); ?>)</label>
                                        <div class="col-xs-9">
                                            <?php echo $obj->inputHidden('hidrefkey[]', array('overwritePost' => false)); ?>
                                            <?php echo $obj->inputHidden('hidcategorykey[]', array('overwritePost' => false, 'value' => 'prepaidtax23Counter')); ?>
                                            <?php echo $obj->inputAutoComplete($arrAutoComplete); ?>
                                        </div>
                                    </div>
