...
$_POST['chkNeedSN'] = (USE_SN) ? 1 : 0; // default nol saja, kalo gk nanti harus isi SN terus, kecuali settingnanya show SN
...
$jewelryType = (in_array(PLAN_TYPE['categorykey'], array(COMPANY_TYPE['jewelry']))) ? true : false;
...
if (!empty($_GET['id'])){ 
	...
	$_POST['alcoholContent'] = $obj->formatNumber($rs[0]['alcoholcontent'],2);
	$_POST['mililiter'] = $obj->formatNumber($rs[0]['mililiter'],2);
	...
	$_POST['purity'] = $obj->formatNumber($rs[0]['purity'],2);      
...
/*    if ($showItemFilter) { 
    ...
    if ($showItemImage){
        ...
        //update file 
        if($useStorage){ 
            $rsImageDetail = $obj->getFileDetail($id, $obj->tableImage);
...
<script type="text/javascript">   
  ...
  jQuery(document).ready(function(){  
        ...
        cons.USE_STORAGE = <?php echo ($useStorage) ? "true" : "false"; ?>
              ...
              <div class="div-table-row">
                    <div class="div-table-col">  
                  		   	<div class="div-tab-panel">  
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['mililiter']); ?></label> 
                                        <div class="col-xs-9"> 
                                            <?php echo $obj->inputNumber('mililiter'); ?>
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['alcohol']); ?> %</label> 
                                        <div class="col-xs-9"> 
                                            <?php echo $obj->inputDecimal('alcoholContent'); ?>
                                        </div>
                                    </div> 
                                    <?php if($jewelryType) { ?>
                                     <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['carat']); ?></label> 
                                        <div class="col-xs-9">  
                                            <div class="flex">
                                             <div class="consume"><?php echo $obj->inputDecimal('carat'); ?></div>
                                             <div style="padding-left:1em"><?php echo ucwords($obj->lang['purity']); ?></div>
                                             <div class="consume"><?php echo $obj->inputDecimal('purity'); ?></div>
                                            </div>
                                        </div> 
                                     </div>    
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                            <div class="flex">          
                                                <div style="width: 8em"><?php echo $obj->inputDecimal('gramasi'); ?></div>
                                                <div><?php echo  $obj->inputSelect('selWeightUnit', $arrWeight); ?></div>
                                                 <?php if($jewelryType) { ?>
                                                    <div  style="margin-left:1em"><?php echo $obj->inputCheckBox('chkWeightFixed'); ?></div>
                                                    <div  class="consume"  style="margin-left:1em"><?php echo $obj->lang['fixedWeight'] ?></div>
                                                <?php } ?>
                                             </div> 
                                        </div> 
                                    </div>   
                          	...
                          	<div class="div-table-caption border-purple"><?php echo ucwords($obj->lang['transactionInformation']); ?></div> 
                                    ...
                                    <div class="col-xs-6"> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12"> 
                                                 <?php echo $obj->inputNumber('sellingPrice',array('readonly' => !$hasUpdatePriceAccess)); ?>
                                            </div> 
                                        </div>  
                                    </div> 
                                    <div class="col-xs-6"> 
                             ...
                             <div class="div-table" style="width:100%">
                                 ...
                                 <div class="div-table-row"> 
                                    <div class="div-table-col-5"> 
                                        ...
                                        <?php if($useStorage) {  ?>
                                             <?php echo $obj->inputUploadFilePlugin($rs,$rsImageDetail,   array('elName' => 'imageDetail[]', 'elDetailPkey' => 'hidDetailImageKey[]') ); ?>   
                                        <?php }else { ?> 
                                                      <!-- image uploader --> 
                            ...
                            <?php }  ?>  
                   			...
                   			<div class="div-tab-panel"> 
                                <div class="div-table-caption border-green"><?php echo ucwords($obj->lang['stockInformation']); ?></div>  
                                          ...
                                          echo '<div class="div-table" style="margin:auto;  width:95%; "> 
                                                     ...
                                                     for($i=0;$i<count($rsWarehouse);$i++){
                                                         ...
                                                         if (!empty($id)) 
                                                            ...
                                                            $rsItemUnit = (!empty($rs)) ? $itemUnit->getDataRowById($rs[0]['baseunitkey']) : '';
                                                         ...
                                                         <div class="div-table-row"> 
                                                             ...
                                                             <div class="div-table-col-5 '.$colorClass.'" style="border-bottom:1px solid #dedede; text-align:right;" > '.$qoh.'</div> 
                                                             <div class="div-table-col-5" style="border-bottom:1px solid #dedede; text-align:left;" > '.$baseUnitName.'</div> 
                                                         </div> 
                                                         ';
                                                      }
                                            echo '</div>';          
                                    ...
                                    <?php if ($rs[0]['needsn'] == 1) { ?>
                                        <div style="clear:both; height: 2em"></div>
                                        <div style="max-height:20em;  overflow-y : scroll;">
                                            <div class="div-table" style="margin:auto;  width:95%;position:relative; "> 
                                                <div class="div-table-row" style="position:sticky; top: 0; background-color:#fff; "> 
                                                    <div class="div-table-col-5" style="border-top:1px solid #666;border-bottom:1px solid #666; width: 11em;" ><strong><?php echo $obj->lang['serialNumber']; ?></strong></div> 
                                                    <div class="div-table-col-5" style="border-top:1px solid #666;border-bottom:1px solid #666; width: 11em;" ><strong><?php echo $obj->lang['warehouse']; ?></strong></div> 
                                                    <div class="div-table-col-5" style="border-top:1px solid #666;border-bottom:1px solid #666; width: 8em; text-align:center" ><strong><?php echo $obj->lang['date']; ?></strong></div> 
                                                    <div class="div-table-col-5" style="border-top:1px solid #666;border-bottom:1px solid #666; text-align:right;" ><strong><?php echo $obj->lang['cogs']; ?></strong></div>  
                                                </div>
                                                
                                                <?php $rsSN = (!empty($rs[0]['pkey'])) ? $item->searchSerialNumber($rs[0]['pkey']) : array(); ?>
                                                <?php
                                                    foreach($rsSN as $snRow){
                                                        echo '<div class="div-table-row"> 
                                                                <div class="div-table-col-5" style="border-bottom:1px solid #dedede;" >'.$snRow['serialnumber'].'</div> 
                                                                <div class="div-table-col-5" style="border-bottom:1px solid #dedede;" >'.$snRow['warehousename'].'</div> 
                                                                <div class="div-table-col-5" style="border-bottom:1px solid #dedede;  text-align:center" >'.$obj->formatDBDate($snRow['itemindate']).'</div> 
                                                                <div class="div-table-col-5" style="border-bottom:1px solid #dedede;text-align:right;" >'.$obj->formatNumber($snRow['costinbaseunit']).'</div>  
                                                            </div>'; 
                                                    }                  
                                               ?>
