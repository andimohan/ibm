...
$rsInvoiceType = $customCode->searchData($customCode->tableName.'.reftabletype',$tablekey, true);
...
$html .= ' 
<table cellpadding="2" > 
<tr><td><div class="title">'.$invoiceTitle.'</div></td></tr>
...
<tr><td colspan="3"  style="width: 670px;">'.$rsCustomer[0]['name'].'</td></tr>  
</table> 
</td>
<td></td>
</tr>
...
<tr class="col-header" ><td style="width:360px;">Item</td><td style="width:70px;text-align:right" >Jumlah</td><td style="width:60px;" >Unit</td><td style="width:80px;text-align:right" >Harga @</td><td style="text-align:right; width:110px;">Subtotal</td></tr>';
...
if ($rsDetail[$i]['discounttype'] == 2)
  ...
  $html .= '<tr><td>'.$rsDetail[$i]['itemname'].'. '.$rsDetail[$i]['trdesc'].'</td><td style="text-align:right">'.$obj->formatNumber($rsDetail[$i]['qty']).'</td><td>'. $rsDetail[$i]['unitname'] .'</td><td style="text-align:right">'.$obj->formatNumber($rsDetail[$i]['priceinunit']).'</td><td style="text-align:right">'.$obj->formatNumber($rsDetail[$i]['total']).'</td></tr>' ; 
}
$html .= '</table>' ;
