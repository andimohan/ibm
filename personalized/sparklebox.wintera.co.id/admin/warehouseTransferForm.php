...
//                            }
                            ...
                            $_POST['qtyInPcs[]'] =   $obj->formatNumber($rsDetail[$i]['qtyinpcs'],2);  
                                        ...
                                        <div class="div-table" style="width: 100%">
                                         <div class="div-table-row"> 
                                            ...
                                            <div class="div-table-col detail-col-detail" style="vertical-align:top; width:100px;"><?php echo $obj->inputSelect('selUnit[]',$arrUnit, array('overwritePost' => $overwrite, 'etc' => $etc)); ?></div>
                                             <div class="div-table-col detail-col-detail" style="vertical-align:top; width:80px; "><?php echo $obj->inputDecimal('qtyInPcs[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyWeightFixed, 'etc' => 'style="text-align:right;" ' .$etc)); ?></div>
                                            </div>
                                        </div> 
                                    </div>
