...
$imgSignature = HTTP_HOST.'template/wintera.co.id/img/ttd-cap.png';    
...
<tr><td style="width:100px">Account Name</td><td style="width:10px">:</td><td style="width:200px">'.$obj->loadSetting('companyName').'</td></tr>
<tr><td style="width:100px">Bank</td><td style="width:10px">:</td><td style="width:180px">Bank Central Asia</td></tr>
<tr><td style="width:100px">Bank Account</td><td style="width:10px">:</td><td style="width:180px">690 0386 999</td></tr>
</table>
</td> 
...
<tr><td></td><td style="height:80px;text-align:center;"><img src="'.$imgSignature.'" /></td></tr>
<tr>
<td></td>
