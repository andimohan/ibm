...
if (!empty($_GET['id'])){ 
    ...
    $_POST['hidCountryKey'] = $rs[0]['countrykey']; 
    if (!empty($rs[0]['countrykey'])){
		$rsCountry = $country->getDataRowById($rs[0]['countrykey']); 
		$_POST['countryName'] = $rsCountry[0]['name'];
	}
                    ...
                    <div class="div-table-col">  
                           ...
                           <div class="div-tab-panel">    
                             ...
                             <div class="map-panel" style="cursor:crosshair; position:relative;  height: 370px; width: 1000px; margin:auto; border:1px solid #dedede; margin-top:1em; margin-bottom: 2em; background-position: center; background-repeat: no-repeat; background-size: contain; background-image:url('/include/img/map-indo.png')">
                                <div class="marker" style="position: absolute;  border:1px solid #333; height: 10px; width: 10px; background-color: #f00; border-radius: 50em;"></div>
                             </div>
                        </div>
                  </div> 
             </div>
