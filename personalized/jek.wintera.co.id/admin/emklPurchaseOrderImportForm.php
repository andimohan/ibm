...
$obj= $emklPurchaseOrderImport;
$securityObject = $obj->securityObject; // the value of security object is manually inserted to handle 
										// some modules that have different security object from that of their class

if(!$security->isAdminLogin($securityObject,10,true));
 
$formAction = 'emklPurchaseOrderImportList';
...
$rsJOType = $obj->getTableKeyAndObj($emklJobOrderImport->tableName,array('key'));
$rsJOHeaderType = $obj->getTableKeyAndObj($emklJobOrderHeaderImport->tableName,array('key'));
...
if (!empty($_GET['id'])){ 
    ...
    if($rs[0]['reftabletype']==$rsJOType['key']){
        // JO
        $rsEmkl = $emklJobOrderImport->searchData($emklJobOrderImport->tableName.'.pkey',$rs[0]['refkey']); 
        ...
        $_POST['depot'] = $rsEmkl[0]['depotname']; 
         ...
         // JO HEADER 
         $rsEmkl = $emklJobOrderHeaderImport->searchData($emklJobOrderHeaderImport->tableName.'.pkey',$rs[0]['refjoheaderkey']); 
    ...
    $_POST['pibRegistrationNumber'] = $rsEmkl[0]['pibregistrationnumber'];
    $_POST['ajuNumber'] = $rsEmkl[0]['aju'];
...
<div style="width:100%; margin:auto; " class="tab-panel-form">   
  ...
  <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>" >
                                                    ...
                                                    <div class="isheader" style="margin-right:0">
                                                         <?php    
                                                            echo $obj->inputAutoComplete(array( 
                                                                                            ...
                                                                                            'callbackFunction' => 'getTabObj().onChangeJobHeader('.EMKL['jobType']['import'].')'
                                                                                          )
                                                                                    );  
                                                        ?> 
                                                    </div> 
                                                      ...
                                                      <?php    
                                                            echo $obj->inputAutoComplete(array( 
                                                                                            ...
                                                                                            'source' =>array(
                                                                                                                ...
                                                                                                                'data' => array( 'action' =>'searchData', 'statuskey' => '(1,2,3)', 'jobtypekey' => EMKL['jobType']['import'])
                                                                                                            ) , 
                                                                                            'allowedStatusForEdit' => array(1),
                                                                                            'callbackFunction' => 'getTabObj().onChangeJobOrder('.EMKL['jobType']['import'].')'
                                                                                          )
                                                                                    );  
                                                        ?> 
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9  mnv-currency"> 
                                           <div class="flex">
                                               ...
                                               <div class="consume"><?php echo $obj->inputDecimal('currencyRate'); ?></div>
                                           </div>
                                        </div> 
                                    </div>
                        ...
                        <div class="div-tab-panel"> 
                            <div class="div-table-caption border-purple"><?php echo ucwords($obj->lang['jobInformation']); ?></div>
                             <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['aju']); ?></label> 
                                        <div class="col-xs-9"> 
                                            <?php echo $obj->inputText('ajuNumber', array('readonly' => true) ); ?>  
                                        </div> 
                                    </div> 
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['pibRegistrationNumber']); ?></label> 
                                        <div class="col-xs-9"> 
                                            <?php echo $obj->inputText('pibRegistrationNumber', array('readonly' => true) ); ?>  
                                        </div> 
                                    </div> 
                                    <div class="form-group">
    ...
    <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; ">
                <div class="div-table-row">   
                    <div class="div-table-col detail-col-header fcl-only"  style="width:100px;"><?php echo ucwords($obj->lang['containerType']); ?></div> 
                    ...
                    <div class="div-table-col detail-col-header" style="width:120px; text-align:right;"><?php echo ucwords($obj->lang['subtotal']); ?> <span class="mnv-active-currency text-muted"><?php echo $activeCurrency; ?></span></div> 
                    ...
                    <div class="div-table-row <?php echo $class; ?>"> 
                            <div class="div-table-col  fcl-only detail-col-detail">
                            ...
                            <div class="div-table-col detail-col-detail"><?php echo $obj->inputDecimal('qty[]', array('overwritePost' => $overwrite,'value' => 0, 'etc' => 'style="text-align:right;"', 'disabled' =>  $disable)); ?></div>
                           ...
                           <div class="div-table-col detail-col-detail"><?php echo $obj->inputText('description[]',$arrCurrency, array('overwritePost' => $overwrite, 'disabled' =>  $disable)); ?></div>
                            ...
                            <div class="div-table-col detail-col-detail"><?php echo $obj->inputDecimal('priceInUnit[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' , 'disabled' =>  $disable)); ?></div>
