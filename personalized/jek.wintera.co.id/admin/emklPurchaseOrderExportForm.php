                        ...
                        <div class="div-tab-panel"> 
                            <div class="div-table-caption border-purple"><?php echo ucwords($obj->lang['jobInformation']); ?></div>
                             <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['aju']); ?>
                                        </label>
                                        <div class="col-xs-9"> 
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-3 control-label">
                                                <?php echo ucwords($obj->lang['pibRegistrationNumber']); ?>
                                            </label>
                                            <div class="col-xs-9">
    ...
    <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; ">
                <div class="div-table-row">   
                    ...
                    <div class="div-table-row <?php echo $class; ?>"> 
                            ...
                            <div class="div-table-col detail-col-detail"><?php echo $obj->inputDecimal('detailSubtotal[]', array('overwritePost' => $overwrite,'readonly' => true, 'etc' => 'style="text-align:right;" ',  'disabled' =>  $disable)); ?></div>
