...
if (!empty($_GET['id'])) {
    ...
    $rsActivityProgress = $activityProgress->getActivityProgressByJobOrder($id);
    ...
    $_POST['pibRegistrationNumber'] = $rs[0]['pibregistrationnumber'];
    $_POST['pibRegistrationDate'] =  $obj->formatDBDate($rs[0]['pibregistrationdate'], 'd / m / Y', $dateReturnOnEmpty);
...
<body>
    <div style="width:100%; margin:auto; " class="tab-panel-form">
        ...
        <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>">
                ...
                <div class="div-table-row">
                    <div class="div-table-col">
                        <div class="div-tab-panel">
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['importir']); ?> /
                                    <?php echo ucwords($obj->lang['consignee']); ?></label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['pibRegistrationNumber']); ?></label>
                                <div class="col-xs-9">
                                    <div class="flex">
                                        <div class="consume">
                                            <?php echo $obj->inputText('pibRegistrationNumber', array('etc' => 'style="r"')); ?>
                                        </div>
                                        <div>/</div>
                                        <div class="consume">
                                            <?php echo $obj->inputDate('pibRegistrationDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                        </div>
                                    </div>
                    ...
                    <div class="div-table-col">
                        <div class="div-tab-panel">
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['container']); ?> /
                                    <?php echo ucwords($obj->lang['seal']); ?></label>
                                <div class="col-xs-9">
                                    <div class="div-table mnv-transaction transaction-detail" style="width:100%">
                                        <?php
                                            ...
                                            <div class="div-table-row <?php echo $class; ?>  odd-style-adjustment">
                                                <div class="div-table-col">
                                                    ...
                                                    <div class="flex" style="margin-top:5px;" width="100%">
                                                        <div style="width:100%;">
                                                            <?php echo $obj->inputTextArea('deliveryAddress[]', array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disabled, 'class' => 'form-control label-style', 'etc' => 'style="height:5em" placeholder="' . $obj->lang['deliveryAddress'] . '"')); ?>
                                                        </div>
                                                        <div class="icon-col <?php echo $obj->hideOnDisabled(); ?>"></div>
                                                        <div class="icon-col <?php echo $obj->hideOnDisabled(); ?>"></div>
                                                    </div>
                                                    ...
                                                    <?php if ($containerQtyUnit == 1) { ?>
                                                        ...
                                                        <div class="flex" style="width:100%">
                                                            ...
                                                            <div style="width:40%">
                                                                <?php echo $obj->inputSelect('selUnit[]', $arrUnit, array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disabled, 'add-class' => 'label-style')); ?>
                                                            </div>
                                                            <div style="width:50%;">
            ...
            <?php if (!empty($rsActivityProgress)) { ?>                                           
            <div style="clear:both; height:1em;"></div>
            <div class="div-tab-panel">
                <div class="div-table-caption border-green"><?php echo ucwords($obj->lang['activityProgress']); ?></div>
            
                <div class="div-table" style="width:100%">
                    <div class="div-table-row ">
                        <div class="div-table-col-5 col-header" style="width:120px;">
                        ...
                        <div class="div-table-col-5 col-header" style="">
                            <?php echo ucwords($obj->lang['activity']); ?> 
                        </div>
                        <div class="div-table-col-5 col-header" style="width:230px">
                            <?php echo ucwords($obj->lang['response']); ?> 
                        </div>
                        <div class="div-table-col-5 col-header" style="width:250px">
                        ...
                        if (!empty($_GET['id'])) {
                            for ($i = 0; $i < count($rsActivityProgress); $i++) {
                                ...
                                echo '
                                        <div class="div-table-row"> 
                                            <div class="div-table-col-5 row-bb" >' . $rsActivityProgress[$i]['code'] . '</div> 
                                            <div class="div-table-col-5 row-bb" style="text-align:center" >' . $obj->formatDBDate($rsActivityProgress[$i]['date']) . '</div> 
                                            <div class="div-table-col-5 row-bb" style="" >' . $rsActivityProgress[$i]['activityname'] . '</div>
                                            <div class="div-table-col-5 row-bb" style="" >' . $rsActivityProgress[$i]['response'] . '</div>
                                            <div class="div-table-col-5 row-bb" style="" >' . $rsActivityProgress[$i]['trdesc'] . '</div>
                                        </div> 
                                    ';
                ...
                <div class="div-table main-tab-table-2">
                    <div class="div-table-row">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="flex">
                                            ...
                                            <div class="consume">
                                                B/L Original<br>
                                                <?php echo $obj->inputDate('originalDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                            <div class="consume">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="flex">
                                            <div class="consume">
                                                Surat Kuasa<br>
                                                <?php echo $obj->inputDate('procurationDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                            <div class="consume">
                                                SK Pabean<br>
                                                <?php echo $obj->inputDate('procurationPabeanDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                            <div class="consume">
                                                SK DO<br>
                                                <?php echo $obj->inputDate('procurationDoDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="flex">
                                            <div class="consume">
                                                LS / Dokumen lain<br>
                                                <?php echo $obj->inputDate('lsDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                            <div class="consume"> -->
                                                
                                                <!--<?php echo ucwords($obj->lang['others']); ?><br>
                                                    <?php echo $obj->inputDate('others', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>-->
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="flex">
                                            <div class="consume">
                                                SPPB Final<br>
                                                <?php echo $obj->inputDate('sppbDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                            <div class="consume">
                                                
                                                <?php echo $obj->inputText('sppb'); ?>
                                            </div>
                                            <div class="consume"> </div>
                                        </div>
                                    </div>
                        ...
                        <div class="div-table-col">
                            <div class="div-tab-panel">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="flex">
                                            <div class="consume">
                                                Lift Off<br>
                                                <?php echo $obj->inputDate('liftOffDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                            <div class="consume">
                                                Lift On<br>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="flex">
                                            <div class="consume">
                                                Agency Fee<br>
                                                <?php echo $obj->inputDate('agencyDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                            <div class="consume">
                                                Mekanis<br>
                                                <?php echo $obj->inputDate('mechanicDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                            <div class="consume">
                                                Demurrage<br>
                                                <?php echo $obj->inputDate('demurrageDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="flex">
                                            <div class="consume">
                                                Tgl. Pengambilan DO<br>
                                                <?php echo $obj->inputDate('doDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                            <div class="consume">
                                                Penyerahan PIB / COO <br>
                                                <?php echo $obj->inputDate('deliveryPIBDate', array('etc' => 'style="text-align:center"', 'allowEmpty' => true)); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <?php echo ucwords($obj->lang['destuffingLocation']); ?><br>
                            ...
                            <div class="form-group">
                                    <div class="col-xs-12">
                                        <?php echo ucwords($obj->lang['container']); ?> / <?php echo ucwords($obj->lang['seal']); ?><br>
                                        <div class="div-table mnv-transaction transaction-detail" style="width:100%">
                                        <?php
                                        $totalRows = count($rsContainerDetail);
                                        for ($j = 0; $j <= $totalRows; $j++) {
                ...
                <div class="div-table mnv-transaction transaction-detail no-odd-even-style" style="width:100%;"
                    ...
                    for ($i = 0; $i <= $totalRows; $i++) {
                        ...
                        if ($i == $totalRows) {
                            ...
                            $_POST['detailGrossWeight[]'] = $obj->formatNumber($rsSalesDetail[$i]['grossweight'], 2);
                            $_POST['detailChargeWeight[]'] = $obj->formatNumber($rsSalesDetail[$i]['chargeweight'], 2);
                            $_POST['detailLength[]'] = $obj->formatNumber($rsSalesDetail[$i]['length'], 2);
                            $_POST['detailWidth[]'] = $obj->formatNumber($rsSalesDetail[$i]['width'], 2);
                            $_POST['detailHeight[]'] = $obj->formatNumber($rsSalesDetail[$i]['height'], 2);
                            $_POST['detailMeas[]'] = $obj->formatNumber($rsSalesDetail[$i]['meas'], 2);
                                        ...
                                        <div class="div-table-col detail-col-detail" style="padding:1em 0;">
                                                ...
                                                <div class="div-table-row customer-row-header">
                                                    <div class="div-table-col" style="width:450px;">
                                                        <div class="div-table" style="width:96%;">
                                                            ...
                                                            <div class="div-table-row">
                                                                <div class="div-table-col" style="font-weight:bold">GW / CW</div>
                                                                <div class="div-table-col">
                                                                    <div class="flex">
                                                                        <div style="width:175px">
                                                                            <?php echo $obj->inputDecimal('detailGrossWeight[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyDetail, 'disabled' => $disable, 'add-class' => 'label-style', 'etc' => 'style="text-align:right"')); ?>
                                                                        </div>
                                                                        <div style="font-weight:bold">/</div>
                                                                        <div style="width:175px">
                                                                            <?php echo $obj->inputDecimal('detailChargeWeight[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyDetail, 'disabled' => $disable, 'add-class' => 'label-style', 'etc' => 'style="text-align:right"')); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="div-table-row">
                                                                <div class="div-table-col" style="font-weight:bold">Dimension</div>
                                                                <div class="div-table-col">
                                                                    <div class="flex">
                                                                        <div style="width:110px">
                                                                            <?php echo $obj->inputDecimal('detailLength[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyDetail, 'disabled' => $disable, 'add-class' => 'label-style', 'etc' => 'style="text-align:right"')); ?>
                                                                        </div>
                                                                        <div style="font-weight:bold"> x </div>
                                                                        <div style="width:110px">
                                                                            <?php echo $obj->inputDecimal('detailWidth[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyDetail, 'disabled' => $disable, 'add-class' => 'label-style', 'etc' => 'style="text-align:right"')); ?>
                                                                        </div>
                                                                        <div style="font-weight:bold"> x </div>
                                                                        <div style="width:110px">
                                                                            <?php echo $obj->inputDecimal('detailHeight[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyDetail, 'disabled' => $disable, 'add-class' => 'label-style', 'etc' => 'style="text-align:right"')); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="div-table-row">
                                                                <div class="div-table-col" style="font-weight:bold">MEAS</div>
                                                                <div class="div-table-col">
                                                                    <div class="flex">
                                                                        <div style="width:365px">
                                                                            <?php echo $obj->inputDecimal('detailMeas[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyDetail, 'disabled' => $disable, 'add-class' => 'label-style', 'etc' => 'style="text-align:right"')); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="div-table transaction-detail detail-item"
                                                ...
                                                <div class="div-table-row">
                                                    ...
                                                    <div class="div-table-col detail-col-header">
                                                        <?php echo ucwords($obj->lang['service']); ?></div>
