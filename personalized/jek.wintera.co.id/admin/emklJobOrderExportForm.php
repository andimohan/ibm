...
if (!empty(PARTNER_ACCOUNT['TMS']))
    $_POST['chkIsTrucking'] = 1;
                ...
                <div class="div-table-row">
                    <div class="div-table-col">
                        <div class="div-tab-panel">
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['exportir']); ?> /
                                    <?php echo ucwords($obj->lang['shipper']); ?></label>
                                <div class="col-xs-9">
                        ...
                        <?php /*dipindah ke header*/ if (false) { ?>
                            <div class="div-tab-panel">
                                <div class="div-table-caption border-green">
                                    <?php echo ucwords($obj->lang['shippingIntruction']); ?></div>
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['billType']); ?></label>
                                    <div class="col-xs-9">
                                ...
                                <div class="form-group">
                                    <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['consignee']); ?>
                                        <?php echo ucwords($obj->lang['name']); ?></label>
                                    <div class="col-xs-9">
                                ...
                                <div class="form-group">
                                    <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['consignee']); ?>
                                        <?php echo ucwords($obj->lang['address']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputTextArea('siConsigneeAddress', array('etc' => 'style="height:10em;"')); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['notifyParty']); ?>
                                    </label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputAutoComplete(
                                            array(
                                ...
                                <div class="form-group">
                                    <label
                                        class="col-xs-3 control-label"><?php echo ucwords($obj->lang['placeOfIssue']); ?></label>
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputAutoComplete(
                                            array(
                                                'objRefer' => $city,
                    ...
                    <div class="div-table-col">
                        <div class="div-tab-panel">
                            <div class="div-table-caption border-blue">
                                <?php echo ucwords($obj->lang['shippingInformation']); ?></div>
                            <div class="form-group">
                                <label
                            ...
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['closingDate']); ?></label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <?php echo $obj->inputTextArea('itemDescription', array('etc' => 'style="height:10em;"')); ?>
                                </div>
                            </div>
                            <?php if ($useShippingInstruction == 1) { ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <?php echo $obj->inputTextArea('attachment', array('etc' => 'style="height:10em;"')); ?>
                                    </div>
                                </div>
                            <?php } ?>
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['note']); ?>
                                </label>
                                <div class="col-xs-9">
                ...
                <div class="div-table mnv-transaction transaction-detail no-odd-even-style" style="width:100%;"
                    ...
                    for ($i = 0; $i <= $totalRows; $i++) {
                        ...
                        <div class="div-table-row customer-row <?php echo $class; ?>"
                            refhblcode="<?php echo $refhblcode; ?>" refhblkey="<?php echo $refhblkey; ?>">
                                                                    ...
                                                                    <div class="flex">
                                                                        <?php if ($isActiveMasterHBL) { ?>
                                                                            <div style="margin-right:0.5em">
                                                                                <?php echo $obj->inputCheckBox('chkIsManual[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyDetail, 'disabled' => $disable, 'class' => 'form-control ')); ?>
                                                                            </div>
                                                                        <?php } ?>
                                                                        ...
                                                                        <div class="icon-button add-hbl"
                                                                            style="<?php echo $showButtonHBL; ?>"><i
...
-->
                                            ...
                                            <div class="div-table transaction-detail detail-item"
                                                style="margin-top:1em; width:100%; border-bottom:1px solid #333;"
