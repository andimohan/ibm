...
<!--    <div class="div-tab-panel" style="overflow-x:scroll"> -->
...
<!--            <div class="div-table-col detail-col-header icon-col" style="width:25px;"></div>-->
        </div>
...
<!--                <?php echo $obj->inputHidden('hidCostDetailCargoKey[]',array('overwritePost' => $overwrite, 'disabled' => $disabled, 'etc' => $etc)); ?> -->
            ...
            ?>
                <div class="div-table-col detail-col-detail"> 
                    ...
                    <?php 
                        if (!$sellingPriceAllowed) echo '<div style="display:none">';
                    ?>
                    <?php echo $obj->inputNumber('sellingCostCargoDetail_'.$rsTruckingCost[$j]['pkey'].'[]', array('overwritePost' => $overwrite, 'readonly' => false, 'etc' => 'style="text-align:right" '. $etc .'')); ?>
                    <?php
                        if (!$sellingPriceAllowed) echo '</div><label style="margin-top:2.2em;"></label>';
                    ?>
            ...
            <div class="div-table-col detail-col-detail">
                ...
                <?php 
                    if (!$sellingPriceAllowed) echo '<div style="display:none">';
                ?>
                <?php echo $obj->inputNumber('sellingAmountCargo[]', array('overwritePost' => $overwrite, 'readonly' => true, 'etc' => 'style="text-align:right"'. $etc .'')); ?>
                <?php 
                    if (!$sellingPriceAllowed) echo '</div><label style="margin-top:2.2em;"></label>';
                ?>
...
<!--            <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col" style="background-color:#fff; position:sticky; right:30px"><?php echo $obj->inputLinkButton('btnAddCargoRow' , '<i class="fas fa-plus-circle"></i>', array('class' => 'btn btn-link add-row-button', 'etc' => 'style="margin-bottom:2.5em;" attr-template="detail-row-template"')); ?></div>-->
