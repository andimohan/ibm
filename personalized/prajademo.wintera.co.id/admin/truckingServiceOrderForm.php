...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        var objAndValueForDetailCarCategoryAutoComplete = {};    
		objAndValue = new Array;
		objAndValue.push({object:'hidCarCategoryKey[]', value :'pkey'});  
        objAndValueForDetailCarCategoryAutoComplete[tabID] = objAndValue;  
		...
		// DETAIL CLONE
		 $("#"+tabID+" [name=btnAddRows]").on('click', function() {
            ...
            bindAutoCompleteForTransactionDetail('carCategoryName[]',objAndValueForDetailCarCategoryAutoComplete[tabID],'ajax-car-category.php?action=searchData');
      						 ...
      						 <div class="div-tab-panel"> 
                                   <div class="div-table-caption border-orange"><?php echo ucwords($obj->lang['generalInformation']); ?></div> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-xs-3 control-label"><?php echo $obj->lang['shipment']; ?></label> 
                                        <div class="col-xs-9"> 
											<?php echo $obj->inputText('doNumber', array('readonly' => $isCustomerInvoiced)); ?>
                                        </div> 
                                    </div>   
                                    <!-- <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['bookingNumber']) . ' / '. $obj->lang['mbl']; ?></label> 
                                        <div class="col-xs-9"> 
											<div class="flex">
												<div class="consume"><?php echo $obj->inputText('shipmentNumber', array('readonly' => $isCustomerInvoiced)); ?></div>
												<div>/</div>
												<div class="consume"><?php echo $obj->inputText('mbl', array('readonly' => $isCustomerInvoiced)); ?></div>
											</div>  
                                        </div> 
                                    </div>    -->

                                    <!-- <div class="form-group">
                                        <label class="col-xs-3 control-label">AJU PEB/PIB</label> 
                                        <div class="col-xs-9"> 
                                             <?php echo $obj->inputText('aju', array('readonly' => $isCustomerInvoiced)); ?>
                                        </div> 
                                    </div>   -->
                    ...
                    <div class="div-table-col" style="padding:0">
                        <div class="div-table" style="width:100%">
                            <div class="div-table-row"> 
                                    ...
                                    <div class="div-table-col detail-col-header" style="width:140px; text-align:left"><?php echo ucwords($obj->lang['carCategory']); ?></div>   
				...
				<?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $_POST['hidCarCategoryKey[]'] =  $rsSalesDetail[$i]['carcategorykey'];
                            $_POST['carCategoryName[]'] =  $rsSalesDetail[$i]['carcategoryname'];
                            ...
                            $rsDetailWorkOrder = $truckingServiceWorkOrder->searchData($truckingServiceWorkOrder->tableName.'.refdetailkey',$rsSalesDetail[$i]['pkey'],true,' and ' .$truckingServiceWorkOrder->tableName.'.statuskey in (1,2,3) ', 'order by stuffingdatetime asc');
                            ...
                            if(!empty($rsDetailWorkOrder)){ 
                                ...
                                $detail .= '<div class="div-table-col col-header" style="width: 120px; ">'.$obj->lang['driver'].' / <span class="text-blue-munsell">'.$obj->lang['supplier'].'</span></div>';  
                                ...
                                for($j=0;$j<count($rsDetailWorkOrder);$j++){
                                    ...
                                    if (empty($rsDetailWorkOrder[$j]['TL'])){ 
                    ...
                    <div class="div-table-col"  style="padding: 0.3em 0">
                        <div class="div-table" style="width:100%">
                            <div class="div-table-row">
                                ...
                                <div class="div-table-col detail-col-detail" style="width:140px;">
                                    <?php echo $obj->inputText('carCategoryName[]',array('overwritePost' => $overwrite,'disabled' => $disabled,  'allowedStatusForEdit' => $readonlyServices)); ?>
                                    <?php echo $obj->inputHidden('hidCarCategoryKey[]',array('disabled' => $disabled, 'overwritePost' => $overwrite )); ?>
                                </div> 
...
*/
                        ...
                        <div class="div-table-col-5" style="vertical-align:top; padding-left: 2em"> 
                            ...
                            <div class="div-table transaction-detail green-scheme" style="width:100%; border-bottom:1px solid #333">
                                ...
                                <?php  
                                      ...
                                      for ($i=0;$i<=$totalRows; $i++){  
                                            ...
                                            if ($i == $totalRows ){
                                                ...
                                                //kalau harga jual dari SPK maka readonly true
                                                if($rsSalesDetailCost[$i]['islocked'] != 0) $isLockedCost = true;
                                                ...
                                                $_POST['hidWorkOrderKeyCost[]'] = $rsSalesDetailCost[$i]['workorderkey']; 
                                ...
                                <div class="div-table-row  <?php echo $class; ?>" <?php echo $style; ?> >
                                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputNumber('qtyCost[]', array('overwritePost' => $overwrite, 'value'=> 1, 'readonly' => $isLockedCost, 'etc' =>  'style="text-align:right;" onChange="truckingServiceOrder.calculateDetailCost(this)" ','class' => 'form-control s-input',  'disabled' => $disabledSellingCost )); ?></div>
                                    <?php if ($showInvoicedQty) {?><div class="div-table-col detail-col-detail text-muted"  style="width:40px;">/ <span class="<?php echo $qtyInvoicedClass; ?>" style="text-align:right; width: 35px"><?php echo $obj->formatNumber($qtyInvoiced); ?></span></div><?php } ?>
                                    <div class="div-table-col detail-col-detail">
                                        <?php echo $obj->inputText('itemNameCost[]',array('overwritePost' => $overwrite,'readonly' => $readonlyOnInvoiced || $isLockedCost,  'etc' => '  onChange="truckingServiceOrder.calculateDetailCost(this)" ','class' => 'form-control s-input',  'disabled' => $disabledSellingCost )); ?>
                                        <?php echo $obj->inputHidden('hidItemKeyCost[]',array('overwritePost' => $overwrite, 'disabled' => $disabledSellingCost)); ?>
                                        <?php echo $obj->inputHidden('hidDetailCostKey[]',array('overwritePost' => $overwrite , 'disabled' => $disabledSellingCost)); ?>
                                        <?php echo $obj->inputHidden('hidWorkOrderKeyCost[]',array('overwritePost' => $overwrite, 'disabled' => $disabledSellingCost)); ?> 
                                    </div> 
                                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputNumber('priceCost[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyOnInvoiced || $isLockedCost,   'etc' => 'style="text-align:right;"  onChange="truckingServiceOrder.calculateDetailCost(this)" ' ,'class' => 'form-control inputnumber s-input',  'disabled' => $disabledSellingCost)); ?></div>
     ...
     <?php if (!$readonlyOnInvoiced && !$isLockedCost) {
                                            echo $obj->inputLinkButton('btnDeleteRows', '<i class="fas fa-times"></i>', array('class' => 'btn btn-link remove-button', 'etc' => 'tabIndex="-1" attrhandler="truckingServiceOrder.calculateTotalCost()" style="padding:6px 0"'));
                                        } ?>                                    </div>
                                </div> 
