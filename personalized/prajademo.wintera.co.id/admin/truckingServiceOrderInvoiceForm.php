            ...
            <div class="div-table-row">
                <div class="div-table-col"> 
					    ...
					    <div class="div-tab-panel"> 
						 ...
						 <div class="form-group <?php echo $obj->hideOnDisabled(); ?>" style="margin-bottom:3em"> 
							<div class="col-xs-12"> 
                        ...
                        if ($i == $totalRows ){
                            ...
                            if ( $rsSalesOrderInvoiceDetail[$i]['invoicetype'] == 1){ 
                               ...
                               // $_POST['salesOrderDate[]'] =  $obj->formatDBDate($rsSalesOrderInvoiceDetail[$i]['sodate']);  
                                $_POST['salesOrderDate[]'] =  $obj->formatDBDate($rsSalesOrderInvoiceDetail[$i]['trdate']);  
                                    ...
                                    <div class="div-table-col detail-col-detail">
                                        <div class="type-1" style="<?php echo $showSO ; ?>"> 
                                            <div class="flex">
                                                ...
                                                <div style="width: 100px"><?php echo $obj->inputDate('salesOrderDate[]', array('value' => $defaultSODate,'overwritePost' => $overwrite, 'readonly' => false,  'disabled' => $disabled, 'etc' => 'style="text-align:center;"  placeholder="'.$obj->lang['jobOrderDate'].'"' )); ?></div>
