    ...
    <?php prepareOnLoadDataForm($obj); ?>     
      ...
      <div class="div-table transaction-detail table-scroll" style="width:100%;">
        <div class="div-table-row"> 
            ...
            <?php
                $totalCols = count($arrCarCategory); 
                for($a=0; $a<$totalCols; $a++){
                ?>
                <div class="div-table-col detail-col-header" style="width:0; text-align:right">
                    <?php echo $obj->inputHidden('hidItemKey[]',array('value' => $arrCarCategory[$a]['pkey'])); ?>
                </div>  
            <?php
                }
            ?>
                        ...
                        <div class="div-table-row">
                            ...
                            <?php  for($k=0; $k<$totalCols; $k++){  ?>
                              <div class="div-table-col detail-col-detail"  style="width:<?php echo $costColWidth;?>px; text-align:right; font-weight: bold;">
                                    <?php echo ucwords($arrCarCategory[$k]['name']); ?> 
                                </div>  
                            <?php  } ?> 
                        </div>
                    </div>
                            ...
                            <?php   
                                ...
                                if (!empty($rsDetail[$i]['jobtypekey'])) {    
                                    ...
                                    for($ctr=0;$ctr<count($rsJobCost);$ctr++)
                                        $arrCost[$rsJobCost[$ctr]['carcategorykey']] = $rsJobCost[$ctr]['price'];
                                }
                                    
                                for($k=0; $k<$totalCols; $k++){ 
                                    $_POST['cost_'.$rsCost[$j]['pkey'].'_'.$arrCarCategory[$k]["pkey"].'[]'] =  (empty($arrCost[$arrCarCategory[$k]["pkey"]])) ? 0 : $obj->formatNumber($arrCost[$arrCarCategory[$k]["pkey"]]);
                            ?>
                                <div class="div-table-col detail-col-detail" style="width:<?php echo $costColWidth;?>px; text-align:right">
                                    <?php  echo $obj->inputNumber('cost_'.$rsCost[$j]['pkey'].'_'.$arrCarCategory[$k]["pkey"].'[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;" ' .$etc));    ?>
                                </div>
                            <?php } ?>   
                        </div>
