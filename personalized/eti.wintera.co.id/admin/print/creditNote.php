...
for($i=0;$i<count($rsDetail);$i++){ 
    ...
    <div style="clear:both"></div> 
    <table cellpadding="4"> 
    <tr><td style="width:440px"><strong>'.$obj->lang['saidAmount'].'</strong> :<br>'.ucwords($sayNumber).' '.$currencySay.'.</td><td style="text-align:right; font-weight:bold;  width:130px; ">Total</td><td style="text-align:right; font-weight:bold;  width:110px;"  >'.$obj->formatNumber($rs[0]['grandtotal'],$decimalNumber).'</td></tr>
    </table>
    <div style="clear:both"></div>  
    ';
