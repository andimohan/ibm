...
if (!empty($_GET['id'])){ 
    ...
    $rsDetailCommission = $obj->getDetailCommission($id);   
    $rsDetailCommission = array_column($rsDetailCommission, null, 'servicekey');          
...
$rsService = $service->searchDataRow(
    array($service->tableName . '.pkey as servicekey', $service->tableName . '.name as servicename', $service->tableName . '.code'),
    ' and ' . $service->tableName . '.statuskey = 1  and ' . $service->tableName . '.itemtype = 3'
);
                    ...
                    <div class="div-tab-panel"> 
                        ...
                        <!-- <div class="div-tab-panel" style="margin-bottom:0"> 
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                            <?php echo $obj->inputDecimal('commissionPercentage'); ?> 
                                        </div> 
                               </div>               
                                <div class="form-group">
...
-->
                       ...
                       <div class="div-tab-panel"> 
     <div class="div-table-caption border-purple"><?php echo ucwords($obj->lang['teleSalesCommissionInfornation']); ?></div>
                            ...
                            <div class="div-table-row">
                                ...
                                <div class="div-table-col detail-col-header" style="width:200px; text-align:right;"><?php echo ucwords($obj->lang['commission']); ?></div>
                            </div>

                            <?php
                            $totalItemRows = count($rsService);
                            ...
                            for ($i = 0; $i <= $totalItemRows; $i++) {
                                ...
                                if ($i == $totalItemRows) {
                                    ...
                                    $detailCommissionCol =  $rsDetailCommission[$rsService[$i]['servicekey']];
                                    $_POST['hidDetailKey[]'] =  $detailCommissionCol['pkey'];
                                    $_POST['hidServiceKey[]'] =  $rsService[$i]['servicekey'];
                                    $_POST['serviceName[]'] =  $rsService[$i]['servicename'];
                                    $_POST['employeeCommission[]'] =   $obj->formatNumber($detailCommissionCol['commission']);
                                }

                            ?>
                                <div class="div-table-row <?php echo $class; ?>">
                                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputText('serviceName[]', array('overwritePost' => $overwrite, 'etc' =>  $etc)); ?><?php echo $obj->inputHidden('hidServiceKey[]', array('overwritePost' => $overwrite, 'etc' => $etc)); ?><?php echo $obj->inputHidden('hidDetailKey[]', array('overwritePost' => $overwrite, 'etc' => $etc)); ?></div>
                                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputNumber('employeeCommission[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' . $etc)); ?></div>
                                </div>
                            <?php  }   ?>
   ...
   <?php if ($hasSecurityPrivileges) { ?>
    ...
    <div style="clear:both; height:2em;"></div>   
     ...
     <?php if(MULTI_COMPANY) { ?> 
       ...
       <div class="title"><?php echo ucwords($obj->lang['warehousePrivileges']); ?></div>
     ...
     <?php } ?>    
      <?php if($obj->useSalesPrivileges()) { ?> 
       ...
       <div class="title"><?php echo ucwords($obj->lang['salesmanPrivileges']); ?></div>
       <div class="section-panel-content div-table-tab-form" style="float:left;  width:100%; "> 
                    <div style="clear:both; height:0.5em"></div>  
                    <div class="div-table" style="width: 100%">
                        <div class="div-table-row"> 
     ...
     <?php } ?>   
      <?php if($obj->useCustomerPrivileges()) { ?> 
       ...
       <div class="title"><?php echo ucwords($obj->lang['customerPrivileges']); ?></div>
       <div class="section-panel-content div-table-tab-form" style="float:left;  width:100%; "> 
                    <div style="clear:both; height:0.5em"></div>  
                    <div class="div-table" style="width: 100%">
                        <div class="div-table-row"> 
     ...
     <?php if (USE_GL) { ?>   
       ...
       <div class="title"><?php echo $obj->lang['coaPrivileges']; ?></div>
       <div class="section-panel-content div-table-tab-form" style="float:left;  width:100%; "> 
                    <div style="clear:both; height:0.5em"></div> 
                    <div class="div-table" style="width: 100%">
                        <div class="div-table-row"> 
