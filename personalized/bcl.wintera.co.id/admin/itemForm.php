...
if (!empty($_GET['id'])){ 
    ...
    $_POST['barcode'] = $rs[0]['barcode'];
    $_POST['chkIsPeriodically'] = $rs[0]['isperiodically'];
              ...
              <div class="div-table-row">
                    <div class="div-table-col">  
                  		   	<div class="div-tab-panel">  
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['periodically']); ?></label> 
                                        <div class="col-xs-9"> 
                                            <?php echo  $obj->inputCheckBox('chkIsPeriodically'); ?>   
                                        </div>
                                    </div> 
