...
includeClass(array('EMKLJobOrder.class.php', 'EMKLCommission.class.php', 'EMKLCommission.class.php', 'CreditNote.class.php', 'DebitNote.class.php'));
...
$generateReportContent = function ($dataset) {
    ...
    $emklPurchaseOrderExportAccess = $security->hasSecurityAccess($obj->userkey, $security->getSecurityKey($emklPurchaseOrderExport->securityObject), 10);
