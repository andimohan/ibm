...
$content = function ($dataset) {
    ...
    $generateHeaderTable = function ($dataset, $param) {
        ...
        if($shippingType == EMKL['shipping']['sea']) {
            ...
            if ($isShowTitle == 1) {
                ...
                $hblType = '<h1 style="text-align:center;font-size:22px;">OCEAN BILL OF LANDING</h1>';
            ...
            $html .= '
                <table cellpadding="2"> 
                    <tr>
                        ...
                        <span style="' . $showTitle . '">Bill of Landing No.</span>
                        </td>
                    </tr>
        ...
        if($shippingType == EMKL['shipping']['sea']) {
            ...
            $html .= '<table cellpadding="2">
                ...
                <tr>
                    ...
                    <tr><td style="border-bottom:1px dotted solid;'. $showTitle .'">PT. CIF TRANSPORTATION INDONESIA</td></tr>  
    ...
    $setXYContent = function ($dataset, $param) {
        ...
        if($shippingType == EMKL['shipping']['sea']) {
            ...
            $notifyParty = 'NOFITY PARTY : ' . $rs[0]['carriername'];
        ...
        $detailContainerInformation ='<table><thead><tr><td style="width:80px;font-size:0.9em;font-weight:bold;">CONTAINER</td><td style="width:80px;font-size:0.9em;font-weight:bold;">QTY</td><td style="width:80px;font-size:0.9em;font-weight:bold;">G.W</td><td style="width:80px;font-size:0.9em;font-weight:bold;">MEAS</td></tr></thead><tbody>';
        ...
        $agentAddress = nl2br($rsAgent[0]['address']);
        ...
        $flightDate1 = $rs[0]['connectingvesselnumber'] . ' / ' . $obj->formatDBDate($rs[0]['transit1date'], 'd', array('returnOnEmpty' => true));
        ...
        if($shippingType == EMKL['shipping']['sea']) {  
            ...
            $content2 = '
                <table>
                    <tr>
                        <td style="font-weight:bold;font-size:1.3em;font-weight:bold;">'. $HBLCode .'</td>
                    </tr>
                </table>';//hbl content
            ...
            $content3 = '
                <table style="font-size:1.1em; font-weight: bold">
                    <tr>
                        <td  style="width:338px;font-size:0.9em;font-weight:bold;">' . strtoupper(htmlspecialchars_decode($rs[0]['consigneename'])) . '<br>' . str_replace(chr(13), '<br>', strtoupper($rs[0]['consigneeaddress'])) . '</td>
                    </tr>
            ...
            $content4 = '
                <table style="font-size:1.1em; font-weight: bold" cellpadding="2">
                    <tr>
                        <td  style="width:338px;font-size:0.9em;font-weight:bold;">' . strtoupper(htmlspecialchars_decode($rsData[0]['carriername'])) . '<br>' . str_replace(chr(13), '<br>', strtoupper($rsData[0]['carrieraddress'])) . '</td>
                    </tr>
            ...
            $content5 = '
                <table style="font-size:1.1em; font-weight: bold" cellpadding="2">
                    <tr>
                        <td  style="width:174px;font-size:0.9em;font-weight:bold;">' . $polName . '</td>
                        <td  style="width:169px;font-size:0.9em;font-weight:bold;">' . $polName . '</td>
                    </tr>
            ...
            $content7 = '
                <table style="font-size:1.1em; font-weight: bold" cellpadding="2">
                    <tr>
                        <td  style="width:174px;font-size:0.9em;font-weight:bold;">' . $podName . '</td>
                        <td  style="width:183px;font-size:0.9em;font-weight:bold;">'. $placeOfDelivery .'</td>
            ...
            $descriptionCustom = '
                    <table style="width:270px;text-align:left;   font-weight: bold">
            ...
            $contentFooter1 = '
                ...
                $contentFooter2 = '
                    <table style="font-size:1.1em; font-weight: bold" cellpadding="2">
                        <tr>
                            <td  style="width:200.5px;font-size:0.9em;font-weight:bold;">' . $prepaidAt . '</td>
                            <td  style="width:158.5px;font-size:0.9em;font-weight:bold;">' . $payableAt . '</td>
                        </tr>
                    ...
                    $contentFooter4 = '
                        <table style="font-size:1.1em; font-weight: bold" cellpadding="2">
                            <tr>
                                <td  style="width:338px;font-size:0.9em;font-weight:bold;">JAKARTA, ' . strtoupper($obj->formatDBDate($rs[0]['trdate'], 'M d, Y', array('returnOnEmpty' => true))) . '</td>
                            </tr>
                        </table>
                    ...
                    $contentByInformation = '<table style="font-size:1.1em; font-weight: bold" cellpadding="2">
                        <tr><td style="font-weight:bold;">'. $byInformationData .'</td></tr>
                        <tr><td></td></tr>
                    </table>';
                    $contentBy2Information = '<table style="font-size:1.1em; font-weight: bold" cellpadding="2">
                        <tr>
                            <td style="font-size:1em;font-weight:bold;text-align:center;width:280px">' . $by2InformationData . '</td>
                        </tr>
                        </table></td>';
            ...
            array_push($arrTestXY, array('x' => 12, 'y' => 106.5, 'content' => $content6));
            ...
            if(!$attachment) { 
                ...
                array_push($arrTestXY, array('x' => 12, 'y' => 152, 'content' => $content8B));
                ...
                array_push($arrTestXY, array('x' => 83, 'y' => 190, 'content' => $descriptionCustom));
                ...
                array_push($arrTestXY, array('x' => 10, 'y' => 138, 'content' => $content8));
            }
            ...
            if ($rs[0]['isrelease'] == 1 && !$attachment) {
                ...
                $surrenderHTML = '<table><tr><td style="width:150px"><div class="surrender" style="color:#000; width:10px;  border:1px solid #000; font-weight:bold;  font-size: 2em; text-align:center;">SURRENDER</div></td></tr></table>';
            ...
            $content4 = '<table celpadding="2">
                <tr>
                    <td style="width:300px; font-size:0.9em; font-weight:bold;">' . strtoupper(htmlspecialchars_decode($rs[0]['consigneename'])) . '<br>' . str_replace(chr(13), '<br>', strtoupper($rs[0]['consigneeaddress'])) . '</td>
                </tr>
            </table>'; //consignee content
            ...
            $content10 = '<table celpadding="2">
                <tr>
                    <td style="text-align:center;font-size:0.6em;width:35px;font-weight:bold;">'. $connectingAirport .'</td>
                    <td style="text-align:center;font-size:0.6em;width:146px;font-weight:bold;">&nbsp;' . $firstByCarrier . '</td>
                    <td style="text-align:center;font-size:0.6em;width:40px;font-weight:bold;">'. $connecting2Airport .'</td>
                    <td style="text-align:center;font-size:0.6em;width:30px;font-weight:bold;">' . $connectingCode . '</td>
                    <td style="text-align:center;font-size:0.6em;width:36px;font-weight:bold;">'. $connecting3Airport .'</td>
                    <td style="text-align:center;font-size:0.6em;width:35px;font-weight:bold;">' . $connecting2Code . '</td>
                </tr>
            </table>'; //to, By First Carier, to content

            $content11 = '<table celpadding="2">
                <tr>
                    <td style="text-align:center;font-size:0.7em;width:40px;font-weight:bold;"> '. $currencyName .' </td>
                    <td style="text-align:center;font-size:0.5em;width:20px;font-weight:bold;"> PP </td>
                </tr>
            </table>'; //CHGS content

            $content12 = '<table celpadding="2">
                <tr>
                    <td style="width:156px;font-size:0.9em;font-weight:bold;">' . $finalDestination . '</td>
                </tr>
            ...
            $content14 = '<table celpadding="2">
                <tr>
                    <td style="width:30px;font-size:0.7em;font-weight:bold;">' . $obj->formatNumber($totalPkgs) . '</td>
                    <td style="width:40px;font-size:0.7em;font-weight:bold;">' . $obj->formatNumber($GW, 3) . '</td>
                    <td style="width:10px;font-size:0.7em;font-weight:bold;"></td>
                    <td style="width:10px;font-size:0.7em;font-weight:bold;"></td>
                    <td style="width:10px;font-size:0.7em;font-weight:bold;"></td>
                    <td style="width:20px;font-size:0.7em;font-weight:bold;"></td>
                    <td style="width:65px;font-size:0.7em;font-weight:bold;"></td>
                    <td style="width:50px;font-size:0.7em;font-weight:bold;">' . $obj->formatNumber($CW, 3) . '</td>
                </tr>
            ...
            $content19 = '<table><tr><td class="border-right" style="font-size:0.6em;font-weight:bold;text-align:center;width:96px">NVD</td>
                        <td class="border-right" style="font-size:0.6em;font-weight:bold;text-align:center;width:96px">NVC</td></tr></table>';
            ...
            $content18 = '<table celpadding="2"><tr><td style="width:50px;font-size:0.6em;font-weight:bold;text-align:center;">'. $flightDate1 .'</td><td style="width:55px;font-size:0.6em;font-weight:bold;text-align:center;"></td><td style="width:50px;font-size:0.6em;font-weight:bold;">'. $flightDate2 .'</td></tr></table>';
            ...
            array_push($arrTestXY, array('x' => 18, 'y' => 119, 'content' => $content12));
            array_push($arrTestXY, array('x' => 48, 'y' => 135, 'content' => $content13));

            array_push($arrTestXY, array('x' => 16, 'y' => 150, 'content' => $content14));
            // body right
            array_push($arrTestXY, array('x' => 147, 'y' => 150, 'content' => $content15));
            array_push($arrTestXY, array('x' => 91, 'y' => 150, 'content' => $content16));
            array_push($arrTestXY, array('x' => 61, 'y' => 120, 'content' => $content18));
            array_push($arrTestXY, array('x' => 147, 'y' => 112, 'content' => $content19));
            array_push($arrTestXY, array('x' => 81, 'y' => 268, 'content' => $content20));
            
            if (!$attachment) {
                //array_push($arrTestXY, array('x' => 10, 'y' => 204, 'content' => $contentFooter));
                $x = ($freightTerm == '1' ? 12 : 53); //Prepaid / Collect
                array_push($arrTestXY, array('x' => $x, 'y' => 213, 'content' => $content17));
