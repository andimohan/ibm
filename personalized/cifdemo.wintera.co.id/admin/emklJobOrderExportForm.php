...
if (!empty($_GET['id'])){
    ...
    if(!empty($rs[0]['finaldestinationkey'])) {
        ...
        $_POST['finalDestinationName'] = $rsCity[0]['citycategoryname'];
    }
                    ...
                    <?php 
                            ...
                            for ($j=0;$j<=$totalRows; $j++){ 
                                    ...
                                    if ($j == $totalRows ){
										...
										$_POST['detailNetWeight[]'] = $obj->formatNumber($rsContainerDetail[$j]['netweight'],);
                                ...
                                ?>
                                    <div class="div-table-row <?php echo $class; ?> " > 
                                        ...
                                        <div class="div-table-col detail-col-detail" style="vertical-align:top"><?php echo $obj->inputDecimal('detailGrossWeight[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' . $etc, 'disabled' => $disabled)); ?></div>
                                        <div class="div-table-col detail-col-detail air-only" style="vertical-align:top"><?php echo $obj->inputDecimal('detailChargeWeight[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' . $etc, 'disabled' => $disabled)); ?></div>
                                        <div class="div-table-col detail-col-detail sea-only" style="vertical-align:top">
                                        ...
                                        <div class="div-table-col detail-col-detail sea-only" style="vertical-align:top">
										    <?php echo $obj->inputDecimal('detailMeas[]', array('overwritePost' => $overwrite, 'readonly' => false, 'disabled' => $disabled,  'etc' => 'style="text-align:right"' .$etc )); ?>
                                        </div> 
                                        <div class="div-table-col detail-col-detail" style="vertical-align:top">
                    ...
                    <div class="div-table transaction-detail detail-item" style="margin-top:1em; width:100%; border-bottom:1px solid #333;"  attr-level="1" attr-group="hidDetailItemKey">
                      <div class="div-table-row">   
                        ...
                        <div class="div-table-row <?php echo $class; ?>"> 
                            ...
                            <div class="div-table-col detail-col-detail"><?php echo $obj->inputDecimal('qty[]', array('overwritePost' => $overwrite,'readonly' => $readonly, 'value' => 1, 'etc' => 'style="text-align:right;" mnv-attr-decimal="3";', 'disabled' =>  $disable)); ?></div>
