...
if (!empty($_GET['id'])){ 
    ...
    $_POST['sumGrossWeight'] = $obj->formatNumber($rs[0]['sumgrossweight'], 3);
    $_POST['sumNetWeight'] = $obj->formatNumber($rs[0]['sumnetweight'], 3);
    $_POST['sumMeas'] = $obj->formatNumber($rs[0]['summeas'],3);
    $_POST['sumQty'] = $obj->formatNumber($rs[0]['sumqty']);
    $_POST['sumChargeWeight'] = $obj->formatNumber($rs[0]['sumchargeweight'], 3);
                    ...
                    <div class="div-table-col">
                    		<div class="div-tab-panel">  
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['placeOfDelivery']); ?></label> 
                                        <div class="col-xs-9"> 
                                             <?php    
                                                echo $obj->inputAutoComplete(array( 
                                                                                    'objRefer' => $port,
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords('Ship To'); ?></label> 
                                        <div class="col-xs-9"> 
                            ...
                            <div class="form-group">
								...
								<div class="col-xs-9">   
									<div class="flex">
                                        ...
                                        <div class="text-muted" style="margin-right:3px">KG</div>
                                        <div><?php echo $obj->inputDecimal('sumChargeWeight'); ?></div>
                                        <div class="text-muted" style="margin-right:3px">KG</div>
									</div>
								</div> 
							</div> 
