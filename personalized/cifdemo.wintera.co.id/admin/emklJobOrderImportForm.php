                    ...
                    <div class="div-table transaction-detail detail-item" style="width:100%; margin-top:1em; border-bottom:1px solid #333;"  attr-level="1" attr-group="hidDetailItemKey">
                      <div class="div-table-row">   
                        ...
                        <div class="div-table-row <?php echo $class; ?>"> 
							...
							<?php } ?>                            <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col"><?php echo  $obj->inputLinkButton('btnAddDetailRow' , '<i class="fas fa-plus-circle"></i>', array('class' => 'btn btn-link add-row-button', 'etc' => 'attr-template="item-row-template"')); ?></div>
