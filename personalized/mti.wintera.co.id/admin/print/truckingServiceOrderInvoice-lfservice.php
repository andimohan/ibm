...
$generateReportContent = function ($dataset) {
    ...
    $rsDetail = $obj->getDetailWithRelatedInformation($rs[0]['pkey'],'', 'order by '.$obj->tableNameDetail.'.orderlist, '.$obj->tableNameDetail.'.pkey asc');
                ...
                <tr>
                    ...
                    <td style="width:200px;">
                        <table cellpadding="3">
                            ...
                            <tr><td></td></tr>
                            <tr>
                                <td style="width:190px;' . $fontSize . '" class="align-center font-bold">' . (empty($invoiceSignature) ? 'Kiki Ramadhani Siregar' : $invoiceSignature) . '</td>
                            </tr>        
                        </table>
                    </td>
                </tr>
