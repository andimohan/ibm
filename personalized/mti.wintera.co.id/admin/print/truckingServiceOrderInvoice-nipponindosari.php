...
$generateReportContent = function ($dataset) {
    ...
    usort($arrJOSummary, function ($a, $b) {
    ...
    $html .=    '<table cellpadding="2" width="100%">
                    <tr>
                        ...
                        <td style="width:200px">
                            <table cellpadding="3">
                                <tr><td style="width:190px;" class="align-center font-bold" >Bekasi, ' . $obj->toLocalDate($obj->formatDBDate($rs[0]['trdate'], 'd F Y')) . '</td></tr>
                                <tr><td></td></tr>
                                <tr><td></td></tr>
                                <tr><td></td></tr>
                                <tr><td></td></tr>
                                <tr><td></td></tr>
                                <tr><td style="width:190px;" class="align-center">' . (empty($invoiceSignature) ? 'Lana Lainufar' : $invoiceSignature) . '</td></tr>
                            </table>
                        </td>
                    </tr>
                </table>';
