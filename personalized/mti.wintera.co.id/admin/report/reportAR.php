...
includeClass(array('AR.class.php','ARPayment.class.php','Currency.class.php','Warehouse.class.php','Customer.class.php'));
...
$arrCategory = array('0' => 'Semua', '1' => 'Normal', '2' => $obj->lang['unCollected']);
...
if($isGrouping){
    ...
    switch($EXPORT_TYPE){
        ...
        default :
            ...
            $arrDataStructure['category'] = array('title'=>ucwords($obj->lang['unCollected']), "align" =>"center",'dbfield' => 'category','width'=>"110px","sortable" => false);
...
switch($EXPORT_TYPE){
    ...
    if($isGrouping){
        ...
        if ( in_array(PLAN_TYPE['categorykey'], array(COMPANY_TYPE['trucking'],COMPANY_TYPE['forwarding']))){
            $arrDataDetailStructure['tax23Value'] = array('title'=>ucwords($obj->lang['tax23']),'dbfield' => 'tax23value', 'width'=>"90px" ,'format'=>'number','calculateTotal' => true);
        }
...
$arrTwigVar['inputSelCategory'] =  $class->inputSelect('selCategory[]', $arrCategory, array('etc' => '', 'class' => 'multi-selectbox'));
...
if (isset($_POST) && !empty($_POST['hidAction'])){   
    ...
    if(isset($_POST) && !empty($_POST['selCategory'])) {
        ...
        switch($_POST['selCategory'][0]){
            case '0' : $arrCategorykey = array(0,1); break;
            case '1' : $arrCategorykey = array(0); break;
            case '2' : $arrCategorykey = array(1); break;
            default : $arrCategorykey = array(0,1); break;
                
        }
        $arrCategorykey = implode(",", $class->oDbCon->paramString($arrCategorykey));   

        $criteria .= ' AND '.$obj->tableName.'.categorykey in ('.$arrCategorykey.')';  
...
//
            ...
            $rs[$i]['category'] = ($rs[$i]['categorykey'] == 1) ? $obj->lang['unCollected'] : '';
