...
$arrDataStructure['year'] = array('title'=>ucwords($obj->lang['year']),  'width'=>"70px", 'dbfield' => 'year', 'align' =>'center'); 
...
$arrDataStructure['totalRevenue'] = array('title'=>ucwords($obj->lang['revenue']), 'dbfield' => 'totalRevenue', 'width'=>"110px" ,'format'=>'integer', "sortable" => false, 'textColor' => '568203', 'calculateTotal' => true);
$arrDataStructure['totalCost'] = array('title'=>ucwords($obj->lang['cost']), 'dbfield' => 'totalCost', 'width'=>"110px" ,'format'=>'integer', "sortable" => false,  'textColor' => 'C41E3A', 'calculateTotal' => true);
$arrDataStructure['totalBalance'] = array('title'=>ucwords($obj->lang['balance']), 'dbfield' => 'totalBalance', 'width'=>"110px" ,'format'=>'integer', "sortable" => false , 'calculateTotal' => true);
...
//	} 
	...
	if(isset($_POST) && !empty($_POST['trStartDate'])){
		...
		$serviceCriteria .= ' and '.$orderByDetailService.' between '.$class->oDbCon->paramDate( $_POST['trStartDate'],' / ').' AND '.$class->oDbCon->paramDate( $_POST['trEndDate'],' / ','Y-m-d 23:59');
    ...
    $orderBy = (!empty($_POST['hidOrderBy'])) ? $obj->oDbCon->paramOrder($_POST['hidOrderBy']) : 'year'; // order by harus dr kolom yg terdaftar saja
