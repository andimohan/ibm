...
$html .= '<table>
    <tr>
        ...
        <table cellpadding="2"> 
            <tr><td class="header-row-header"  style="width:400px">'.$companyName.'<br>'.str_replace(chr(13),'<br>',$companyAddress).'</td></tr>
        ...
        <td style="width:300px"><table cellpadding="2"> 
            <tr><td><div class="title" style="text-align:right">ORDER PEMBELIAN</div></td></tr>
            <tr><td><div class="subtitle"  style="text-align:right">'.$rs[0]['code'].'</div></td></tr>
            </table>  
        </td>
    </tr> 
</table>
