...
if (!empty($_GET['id'])){ 
   ...
   // $rsTariff = $truckingSellingRate->searchData($truckingSellingRate->tableName.'.pkey',$rsServiceOrder[0]['contractkey']);
	...
	$_POST['coDriverNotes'] = $rs[0]['codrivernotes']; 
	$_POST['driverNotes'] = $rs[0]['drivernotes']; 
    ...
    $_POST['routeLast'] = $rs[0]['routelast'];
                    ...
                    <div class="div-table-col"> 
      						 <div class="div-tab-panel"> 
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group inhouse">
                                        <label class="col-xs-3 control-label"><?php echo $obj->lang['note']; ?> (<?php echo $obj->lang['driver']; ?>)</label> 
                                        <div class="col-xs-9">     
                                        <?php echo  $obj->inputTextArea('driverNotes', array('etc' => 'style="height:4em;"')); ?>
                                        </div> 
                                    </div> 
                                <div class="form-group inhouse">
                                ...
                                <div class="form-group inhouse">
                                    <label class="col-xs-3 control-label"><?php echo $obj->lang['note']; ?> (<?php echo $obj->lang['codriver']; ?>)</label> 
                                    <div class="col-xs-9">     
                                    <?php echo  $obj->inputTextArea('coDriverNotes', array('etc' => 'style="height:4em;"')); ?>
                                    </div> 
                                </div> 
                                <div class="form-group inhouse">                                    
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-xs-9" > 
                                    <div class="flex">
                                     ...
                                     <div>-</div>
                                     <div class="consume"><?php echo $obj->inputText('routeLast',array( 'allowedStatusForEdit' => array (1))); ?></div>
                                    </div>
                                </div>   
                            </div>  
                        </div>
