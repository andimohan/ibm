...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        var objAndValueForDetailCarAutoComplete = {};    
        objAndValue = new Array;
        objAndValue.push({object:'hidCarKeyCost[]', value :'carkey'});  
        objAndValue.push({object:'hidWorkOrderKeyCost[]', value :'pkey'});  
        objAndValueForDetailCarAutoComplete[tabID] = objAndValue; 
        ...
        $("#"+tabID+" [name=btnAddCostRows]").on('click', function() {
			...
			bindAutoCompleteForTransactionDetail('policeNumberCost[]',objAndValueForDetailCarAutoComplete[tabID],'ajax-trucking-service-work-order.php?action=searchDataCarForSalesOrder&refkey='+$("#" + tabID + " [name=hidId]").val());   
        });
                        ...
                        <?php    if ($sellingPriceAllowed) {   ?>
                            ...
                            <div class="div-table transaction-detail green-scheme" style="width:100%; border-bottom:1px solid #333">
                                <div class="div-table-row">  
                                        ...
                                        <?php if ($showInvoicedQty) {?><div class="div-table-col detail-col-header"  style="width:40px;"></div><?php } ?>
                                        <div class="div-table-col detail-col-header"><?php echo ucwords($obj->lang['services']); ?></div>    
                                        <div class="div-table-col detail-col-header" style="width:90px;"><?php echo ucwords($obj->lang['car']); ?></div>
                                ...
                                <?php  
                                      ...
                                      for ($i=0;$i<=$totalRows; $i++){  
                                            ...
                                            if ($i == $totalRows ){
                                                ...
                                                $_POST['policeNumberCost[]'] = $rsSalesDetailCost[$i]['policenumber']; 
                                                $_POST['hidCarKeyCost[]'] = $rsSalesDetailCost[$i]['carkey']; 
                                ...
                                <div class="div-table-row  <?php echo $class; ?>" <?php echo $style; ?> >
                                    ...
                                    <div class="div-table-col detail-col-detail">
                                        <?php echo $obj->inputText('policeNumberCost[]',array('overwritePost' => $overwrite,'readonly' => $readonlyOnInvoiced,  'etc' => '  onChange="truckingServiceOrder.calculateDetailCost(this)" ','class' => 'form-control s-input',  'disabled' => $disabledSellingCost )); ?>
                                        <?php echo $obj->inputHidden('hidCarKeyCost[]',array('overwritePost' => $overwrite, 'disabled' => $disabledSellingCost)); ?>
