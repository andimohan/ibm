...
$generateReportContent = function ($dataset) {
    ...
    $stuffingDate = $obj->formatDBDate($rsSOHeader[0]['trdate'], 'M-Y');
    ...
    <table cellpadding="2" width="100%">
        <thead>
            <tr>
                <th class="border-left-top-right-bottom" style="text-align:center;' . $itemWidth . '">Date</th>
    ...
    for ($i = 0; $i < count($rsDetail); $i++) {
        ...
        if ($rsInvoiceType[0]['isreimburse'] == 1) {
            ...
            $html .= '<tr>
                        <td class="border-left border-right" style="text-align:center;' . $itemWidth . '">' . $obj->formatDBDate($rsSOHeaderCol[0]['trdate'], 'd-M-Y') . '</td>
            ...
            foreach ($rsItemDetailCol as $key => $rowItem) {
                ...
                $html .= '<tr>
                            <td class="border-left border-right" style="text-align:center;' . $heighBody . $itemWidth . '">' . $obj->formatDBDate($rsSOHeaderCol[0]['trdate'], 'd-M-Y') . '</td>
                            <td class="border-left border-right" style="' . $heighBody . $descriptionWidth . '">' . $itemName . '</td>
                            <td class="border-left border-right" style="text-align:center;' . $heighBody . $qtyWidth . '">' . $obj->formatNumber($rowItem['qtyinbaseunit']) . '</td>
                            <td style="text-align:center;' . $heighBody . $currWidth . '">Rp</td>
                            <td class="border-right" style="text-align:right;' . $heighBody . $unitPriceWidth . '">' . $obj->formatNumber($rowItem['priceinunit']) . '</td>
    ...
    if ($taxValue > 0) {
        $html .= '
            <tr>
                <td class="border-left border-right" style="' . $itemWidth . '"></td>
                <td class="border-left border-right" style="' . $descriptionWidth . '">PPN' . ($isPriceIncludeTax == 1 ? ' [Include]' : '') . ' - ' . $obj->formatNumber($taxPercentage,-2) . '%  (PPN Dibebaskan berdasarkan PP Nomor 49 Tahun 2022)</td>
                <td class="border-left border-right" style="' . $qtyWidth . '"></td>
                <td class="" style="text-align:center;' . $heighBody . $currWidth . '"> </td>
                <td class="border-right" style="' . $unitPriceWidth . '"></td>
                <td class="" style="text-align:center;' . $heighBody . $currWidth . '">Rp</td>
    ...
    $totalInvoice = $obj->formatNumber($rs[0]['grandtotal']);
    ...
    $html .= '
        <table cellpadding="2" width="100%">
            <tr>
                ...
                <td class="border-left-top-right-bottom" style="text-align:right;line-height:40px;font-weight:bold;width:16%;">' . $totalInvoice . '</td>
            </tr>
        </table>
    ';
