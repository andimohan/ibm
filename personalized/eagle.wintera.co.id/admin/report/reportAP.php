...
includeClass(array('EMKLPurchaseOrder.class.php','EMKLCommission.class.php'));
...
if($isGrouping){
     ...
     switch($EXPORT_TYPE){
        ...
        default :
            ...
            $arrDataStructure['emkljocode'] = array('title'=>ucwords($obj->lang['JOCode']),'dbfield' => 'emkljocode', 'width'=>"100px");
            $arrDataStructure['bookingnumber'] = array('title'=>ucwords($obj->lang['bookingNumber']),'dbfield' => 'bookingnumber', 'width'=>"100px", "sortable" => true );
            $arrDataStructure['mblnumber'] = array('title'=>'MBL','dbfield' => 'mblnumber', 'width'=>"100px", "sortable" => true );
...
switch($EXPORT_TYPE){
    ...
    default :
        ...
        if($isGrouping){
            ...
            $arrDataDetailStructure['emkljocode'] = array('title'=>ucwords($obj->lang['soCode']),'dbfield' => 'emkljocode', 'width'=>"80px", "sortable" => false );
    ...
    if(isset($_POST) && !empty($_POST['trStartDate'])){
        ...
        switch($_POST['selDateType']){
            case '1' :  $criteria .= ' and  '.$obj->tableName.'.trdate'.$dateCriteria;  
                        ...
                        break;
            case '2' :  $criteria .= ' and  (emkl_order_header_1.etdpol'.$dateCriteria.' or emkl_order_header_2.etdpol'.$dateCriteria.')';  
                        $label = $obj->lang['etd'];
                        break;   
        }
...
echo $twig->render('@custom/reportAP.html', $arrTwigVar);   
?>
