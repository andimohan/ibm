...
if ($rs[0]['taxvalue'] != 0){
    ...
    array_push($arrSubtotal, '<tr><td colspan="3" style="border:1px solid #333; text-align:right; font-weight:bold;">'.strtoupper($obj->lang['tax']).' ' .$obj->formatNumber($rs[0]['taxpercentage'],-2).'%</td><td style="border:1px solid #333; text-align:center">'.$rsCurrency[$rs[0]['currencykey']].'</td><td style="border:1px solid #333;"></td><td style="border:1px solid #333; text-align:right;"  >'.$obj->formatNumber($rs[0]['taxvalue'],$currencyDecimal,'.',',').'</td></tr>');
...
$html .= '<div style="clear:both;"></div>
    ...
    if($rs[0]['taxvalue'] != 0) { 
        ...
        $html .='<tr><td style="width: 20px">1.</td><td  style="width: 650px">Revisi efaktur maksimal adalah tanggal 5 bulan berikutnya.</td></tr>';
