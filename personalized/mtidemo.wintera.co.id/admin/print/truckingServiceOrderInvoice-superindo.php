...
$generateReportContent = function ($dataset) {
    ...
    $html .= '<table cellpadding="2" width="100%">
        ...
        <tr>
            ...
            <td class="align-center font-bold">Bekasi, '. $obj->toLocalDate($obj->toLocalDate($obj->formatDBDate($rs[0]['trdate'], 'd F Y'))) .'</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width:50px;"></td>
            <td style="width:410px;"></td>
            <td class="align-center font-bold">'. (empty($invoiceSignature) ? 'Lana Lainufar' : $invoiceSignature) .'</td>
        </tr>
