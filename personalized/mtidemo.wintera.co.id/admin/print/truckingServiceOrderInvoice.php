...
$generateReportContent = function ($dataset) {
    ...
    $html .= '<table cellpadding="2" width="100%">
            <thead>
                <tr>
                    ...
                    <th class="border-top-right-bottom align-center font-bold bg-blue" style="' . $widthDate . $fontSize . '">Date</th>
                    <th class="border-top-right-bottom align-center font-bold bg-blue" style="' . $widthKet . $fontSize . '">Ket</th>
                    <th class="border-top-right-bottom align-center font-bold bg-blue" style="' . $widthTruckType . $fontSize . '">Type Truck</th>
                    <th class="border-top-right-bottom align-center font-bold bg-blue" style="' . $widthTruckNo . $fontSize . '">No Truck</th>
                    <th class="border-top-right-bottom align-center font-bold bg-blue" style="' . $widthPrice . $fontSize . '">Price</th>
                    <th class="border-top-right-bottom align-center font-bold bg-blue" style="' . $widthAddCost . $fontSize . '">Add Cost</th>
                    <th class="border-top-right-bottom align-center font-bold bg-blue" style="' . $widthTotalPrice . $fontSize . '">Total Price</th>
                </tr>
            </thead>
            <tbody>
        ';
    for ($i = 0; $i < count($rsDetail); $i++) {
        ...
        $html .= '
                    <tr>
                        <td class="border-left-right-bottom align-right" style="' . $widthNo  . $fontSize. '">' . ($i + 1) . '</td>
                        <td class="border-right-bottom align-center" style="' . $widthDate . $fontSize . '">' . $obj->formatDBDate($rsDetail[$i]['trdate'], 'd/m/Y') . '</td>
                        <td class="border-right-bottom align-center" style="' . $widthKet . $fontSize . '">' . $detailJODesc . '</td>
                        <td class="border-right-bottom align-center" style="' . $widthTruckType . $fontSize . '">' . $rsWO[0]['containername'] . '</td>
                        <td class="border-right-bottom align-center" style="' . $widthTruckNo . $fontSize . '">' . $policeNumber . '</td>
                        <td class="border-right-bottom align-right" style="' . $widthPrice . $fontSize . '">' . $obj->formatNumber($truckingCost) . '</td>
                        <td class="border-right-bottom align-right" style="' . $widthAddCost . $fontSize . '">' . $additionalCost . '</td>
                        <td class="border-right-bottom align-right" style="' . $widthTotalPrice . $fontSize . '">' . $obj->formatNumber($rsDetail[$i]['amount']) . '</td>
                    </tr>
            ';
    }

    $total = $rs[0]['subtotal'];
    $dpp = $rs[0]['beforetaxtotal'];
    ...
    $html .= '<table cellpadding="3" width="100%">
        <tr>
            <td style="width:50px;'. $fontSize.'"></td>
            <td class="font-bold" style="width:100px;'. $fontSize.'">Terbilang:</td>
        </tr>
        <tr>
            <td style="width:50px;'. $fontSize.'"></td>
            <td class="border-left-top-right-bottom align-center font-bold" style="width:510px;'. $fontSize.'">' . ucwords($sayNumber) . ' Rupiah</td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:200px;' . $fontSize . '" class="align-center font-bold"  style="border:1px solid #333">Bekasi, ' .$obj->toLocalDate($obj->formatDBDate($rs[0]['trdate'], 'd F Y')) . '</td>
        </tr>
        <tr>
