...
if($isGrouping){
    ...
    if(count($rsCurrency) == 1){
        ...
        $arrDataStructure['outstanding'] = array('title'=>ucwords($obj->lang['outstanding']),'dbfield' => 'totaloutstanding', 'width'=>"150px" ,'format'=>'number','calculateTotal' => true,"sortable" => false,'mergeExcelCell' => ( in_array(PLAN_TYPE['categorykey'], array(COMPANY_TYPE['trucking'],COMPANY_TYPE['forwarding'])) ) ? 12 : 9 );       
    }else{ 
    ...
    switch($EXPORT_TYPE){
        ...
        default :
            ...
            $arrDataStructure['refcode'] = array('title'=>ucwords($obj->lang['invoiceCode']),  'width'=>"170px", 'dbfield' => 'refcode');
			 ...
			 if( in_array(PLAN_TYPE['categorykey'], array(COMPANY_TYPE['trucking'],COMPANY_TYPE['forwarding'])) ) { 
                ...
                $arrDataStructure['poReference'] = array('title'=>ucwords($obj->lang['poReference']),'dbfield' => 'poreference', 'width'=>"180px", 'sortable' => false);
                $arrDataStructure['shipmentNumber'] = array('title'=>ucwords($obj->lang['bookingNumber']),'dbfield' => 'shipmentnumber', 'width'=>"100px", 'sortable' => false);
             }
            ...
            $arrDataStructure['invoicedate'] = array('title'=>ucwords($obj->lang['invoiceDate']),'dbfield' => 'invoicedate', 'width'=>"100px",'format'=>'date','returnOnEmpty' => array('returnOnEmpty' => true, 'value' => ''), 'sortable' => false);
            $arrDataStructure['receiptdate'] = array('title'=>ucwords($obj->lang['dateSent']),'dbfield' => 'receiptdate', 'width'=>"140px",'format'=>'date','returnOnEmpty' => array('returnOnEmpty' => true, 'value' => ''), 'sortable' => false);
            $arrDataStructure['receiveddate'] = array('title'=>ucwords($obj->lang['invoiceReceivedDate']),'dbfield' => 'receiveddate', 'width'=>"140px",'format'=>'date','returnOnEmpty' => array('returnOnEmpty' => true, 'value' => ''), 'sortable' => false);
...
switch($EXPORT_TYPE){
    ...
    if($isGrouping){
        ...
        $arrDataDetailStructure['refcode'] = array('title'=>ucwords($obj->lang['invoiceCode']),  'width'=>"160px", 'dbfield' => 'refcode');
        
		if(in_array(PLAN_TYPE['categorykey'], array(COMPANY_TYPE['trucking'],COMPANY_TYPE['forwarding']))){ 
            $arrDataDetailStructure['jocode'] = array('title'=>ucwords($obj->lang['JOCode']),'dbfield' => 'jocode', 'width'=>"150px", 'sortable' => false);
            $arrDataDetailStructure['poReference'] = array('title'=>ucwords($obj->lang['poReference']),'dbfield' => 'poreference', 'width'=>"180px", 'sortable' => false);
            $arrDataDetailStructure['shipmentNumber'] = array('title'=>ucwords($obj->lang['bookingNumber']),'dbfield' => 'shipmentnumber', 'width'=>"100px", 'sortable' => false);
		}else{ 
        	if($_POST['selGroupBy'] == 1)
        ...
        $arrDataDetailStructure['invoicedate'] = array('title'=>ucwords($obj->lang['invoiceDate']),'dbfield' => 'invoicedate', 'width'=>"100px",'format'=>'date','returnOnEmpty' => array('returnOnEmpty' => true, 'value' => ''), 'sortable' => false);
        $arrDataDetailStructure['receiptdate'] = array('title'=>ucwords($obj->lang['dateSent']),'dbfield' => 'receiptdate', 'width'=>"140px",'format'=>'date','returnOnEmpty' => array('returnOnEmpty' => true, 'value' => ''), 'sortable' => false);
        $arrDataDetailStructure['receiveddate'] = array('title'=>ucwords($obj->lang['invoiceReceivedDate']),'dbfield' => 'receiveddate', 'width'=>"140px",'format'=>'date','returnOnEmpty' => array('returnOnEmpty' => true, 'value' => ''), 'sortable' => false);
...
//
                    ...
                    for($j=0;$j<count($rsDetail);$j++){
                        ...
                        $arrInvoice = $rsInvoice[$rsDetail[$j]['refkey']];
                        $rsDetail[$j]['invoicedate'] = $arrInvoice['trdate'];
                        $rsDetail[$j]['receiptdate'] = $arrInvoice['receiptdt'];
                        $rsDetail[$j]['receiveddate'] = $arrInvoice['receiveddate'];
                        ...
                        if(in_array(PLAN_TYPE['categorykey'], array(COMPANY_TYPE['trucking'],COMPANY_TYPE['forwarding']))){  
                            ...
                            $rsDetail[$j]['poreference'] =  implode('<br>',$joPOReference);
                            $rsDetail[$j]['shipmentnumber'] =  implode('<br>',$joShipmentNumber);
                ...
                $arrInvoice = $rsInvoice[$rs[$i]['refkey']];
