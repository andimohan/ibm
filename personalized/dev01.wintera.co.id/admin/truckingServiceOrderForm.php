...
if (!empty($_GET['id'])){ 
    ...
    $rsContainerDetail = $obj->getContainerDetail($id);
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        truckingServiceOrder.tablekey = <?php echo  $obj->getTableKeyAndObj($obj->tableName ,array('key'))['key']; ?> // test
        setOnDocumentReady(tabID,truckingServiceOrder);   
        ...
        $("#"+tabID+" [name=btnAddDetailRow]").on('click', function() {
          	var newRow = addNewTemplateRow("container-row-template"); 
        });
    ...
    <?php if (empty($rsSalesHeaderCost) ){ ?>     
        var newRow = addNewTemplateRow("cost-row-template"); 
    <?php } ?>    
        <?php if (empty($rsContainerDetail) ){ ?>     
        var newRow = addNewTemplateRow("container-row-template"); 
    <?php } ?>              
    bindAutoCompleteForTransactionDetail('itemName[]',objAndValueForDetailAutoComplete[tabID],'ajax-item.php?action=searchData&itemtype=2&serviceCost=0','truckingServiceOrder.updateDetail');   
    bindAutoCompleteForTransactionDetail('itemNameCost[]',objAndValueForDetailCostAutoComplete[tabID],'ajax-item.php?action=searchData&itemtype=2&serviceCost=1');   
...
<div style="width:100%; margin:auto; " class="tab-panel-form">   
  ...
  <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>" >
       ...
       <div class="div-table main-tab-table-2">
                <div class="div-table-row">
                    <div class="div-table-col"> 
      						 <div class="div-tab-panel"> 
                                   <div class="div-table-caption border-orange"><?php echo ucwords($obj->lang['generalInformation']); ?></div> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                            <?php echo $obj->inputText('shipmentNumber', array('readonly' => $isCustomerInvoiced)); ?>
                                        </div> 
                                    </div>   
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-3">  
                                            <?php echo $obj->inputSelect('hidCargoType', $arrCargoType, array('readonly' => !$overwriteContractAllowed, 'allowedStatusForEdit' => array (1) )); ?> 
                                        </div> 
                                        ...
                                        <?php 
                                            ...
                                            for ($i=0;$i<=$totalRows; $i++){ 
                                                ...
                                                if ($i == $totalRows ){
                                                    ...
                                                    if ( !empty($rsContainerDetail[$i]['refspkkey'])){
                                                        $readonly = true;
                                                        $hideDeleteIcon = "display:none";
                                                    }  
                                                    
                                                    $_POST['hidContainerDetailKey[]'] =  $rsContainerDetail[$i]['pkey'];
                                                    $_POST['containerDetail[]'] =  $rsContainerDetail[$i]['container'];
                                                    $_POST['sealDetail[]'] =  $rsContainerDetail[$i]['seal'];
                                                    $_POST['hidRefSPKKey[]'] =  $rsContainerDetail[$i]['refspkkey'];
                                                    $_POST['hidRefSPKDetailKey[]'] =  $rsContainerDetail[$i]['refspkdetailkey'];                                                
                                                }
                                            ...
                                            <div class="div-table-row <?php echo $class; ?> odd-style-adjustment" > 
                                                <div class="div-table-col"> 
                                                    <div class="flex">     
                                                        <div class="consume">
                                                            <?php echo $obj->inputHidden('hidContainerDetailKey[]',array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disabled)); ?>
                                                            <?php echo $obj->inputHidden('hidRefSPKKey[]',array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disabled)); ?>
                                                            <?php echo $obj->inputHidden('hidRefSPKDetailKey[]',array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disabled)); ?>
                                                            <?php echo $obj->inputText('containerDetail[]', array('overwritePost' => $overwrite ,'readonly' => $readonly, 'disabled' => $disabled )); ?>
                                                        </div>
                                                        <div class="consume">
                                                            <?php echo $obj->inputText('sealDetail[]', array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disabled )); ?>
                                                        </div>
                                                        <div class="icon-col <?php echo $obj->hideOnDisabled(); ?>"><?php echo $obj->inputLinkButton('btnAddDetailRow' , '<i class="fas fa-plus-circle"></i>', array('class' => 'btn btn-link add-row-button', 'etc' => 'attr-template="container-row-template" style="'.$hideAddIcon.'"')); ?></div>
                     ...
                     <div class="div-table-col">   
                        <div class="div-tab-panel"> 
                            <div class="div-table-caption border-green"><?php echo ucwords($obj->lang['consigneeInformation']); ?></div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">  
                                   <?php
                                                    echo $obj->inputAutoComplete(array(
                                                                            ...
                                                                            'callbackFunction' => 'truckingServiceOrder.updateConsigneeInformation()'
                                                                          )
                                                                    );  
                                    ?> 
                                </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9"> 
                                    <?php echo  $obj->inputTextArea('address', array('readonly'=>true, 'etc' => 'style="height:10em;"',  'allowedStatusForEdit' => array(1))); ?>
                                </div> 
                            </div> 
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">                                                
                                ...
                                <div class="col-xs-9" >     
                                    <?php echo $obj->inputText('vesselNumber', array('readonly' => $isCustomerInvoiced)); ?> 
                                 <!--   <div class="flex">
                                        <div class="consume">
                                        ...
                                        <div style="width: 8em"> <?php echo $obj->inputText('vesselNumber', array('readonly' => $isCustomerInvoiced)); ?> </div> 
                    ...
                    <div class="div-table-col" style="padding:0">
                        <div class="div-table" style="width:100%">
                            <div class="div-table-row"> 
                                    ...
                                    <div class="div-table-col detail-col-header"  style="width:60px; text-align:right;"><?php echo ucwords($obj->lang['party']); ?></div>
				...
				<?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $_POST['qty[]'] = $obj->formatNumber($qty,0);
                            ...
                            if(!empty($rsDetailWorkOrder)){ 
                                ...
                                $detail .= '<div class="div-table-col col-header" style="width: 120px; ">'.$obj->lang['supplier'].'</div>';  
                                ...
                                for($j=0;$j<count($rsDetailWorkOrder);$j++){
                                    ...
                                    $rsCarDetail = $truckingServiceWorkOrder->getCarDetail($rsDetailWorkOrder[$j]['pkey']);
                                    $containerNumber = implode(', ',array_column($rsCarDetail,'container'));
                                    $policenumber = implode(', ',array_column($rsCarDetail,'carregistrationnumber'));
                                    ...
                                    $rsSupplier = $supplier->getDataRowById($rsDetailWorkOrder[$j]['supplierkey']);
                                    $drivername = '<span class="text-blue-munsell">'.$rsSupplier[0]['name'].'</span>';
                    ...
                    <div class="div-table-col"  style="padding: 0.3em 0">
                        <div class="div-table" style="width:100%">
                            <div class="div-table-row">
                                ...
                                <div class="div-table-col detail-col-detail" style="width:60px;"><?php echo $obj->inputInteger('qty[]', array('overwritePost' => $overwrite, 'value'=> 1,'disabled' => $disabled, 'etc' =>  'style="text-align:right;" onChange="truckingServiceOrder.calculateDetail(this)" ' )); ?></div>
                              ...
                              <!--  <div class="div-table-col detail-col-detail status-label <?php echo $statusStyle; ?>" style="width:90px; text-align: center"><?php echo $statusName; ?></div> -->
                                <div class="div-table-col detail-col-detail" style="width:40px;  text-align:center"><?php echo $obj->inputCheckBox('chkIsGroup[]',array('value' => 1,'overwritePost' => $overwrite, 'disabled' => $disabled, 'allowedStatusForEdit' => array (1))); ?></div>
                        ...
                        <div class="div-table" style="width:100%">
                            <div class="div-table-row">
                                  ...
                                  <div class="div-table-col detail-col-detail"><?php echo $obj->inputText('detailNotes[]',array('overwritePost' => $overwrite,'disabled' => $disabled,'allowedStatusForEdit' => $readonlyServices , 'etc' => 'placeholder="'.$obj->lang['note'].'"')); ?></div> 
      ...
      <div style="float:left; display:inline-block;"><?php echo $obj->inputButton('btnAddRows',ucwords($obj->lang['addRows']), array('class' =>'btn btn-primary btn-second-tone', 'allowedStatusForEdit' => array(1,2))); ?></div>
       ...
       <div class="title"><?php echo ucwords($obj->lang['costList']); ?></div>
                               ...
                               <div class="div-table green-scheme cost-detail outsource-detail" style="width:100%;">
                                ...
                                <?php 
                                        ...
                                        for($i=0;$i<count($rsCost);$i++){
                                            ...
                                            $_POST['hidWorkOrderQty[]'] =  $rsCost[$i]['qty'];
                                            $_POST['hidWorkOrderSubtotal[]'] = $subtotal;
                                            $_POST['hidWorkOrderIsReimburse[]'] = $rsCost[$i]['reimburse'];
                                            ...
                                            <div class="div-table-col-03">'.$rsCost[$i]['workordercode'].'</div>  
                                            <div class="div-table-col-03">'.$rsCost[$i]['cashoutcode'].'</div>  
                                            <div class="div-table-col-03" style="text-align:right">'.$obj->formatNumber($rsCost[$i]['total']).'</div>
                                            </div>
                                            ';
                                ...
                                <?php  
                                      ...
                                      for ($i=0;$i<=$totalRows; $i++){  
                                            ...
                                            if ($i == $totalRows ){
                                                ...
                                                $_POST['qtyHeaderCost[]'] = $obj->formatNumber($rsSalesHeaderCost[$i]['qty'],0);
                        ...
                        <div class="div-table-col-5" style="vertical-align:top; padding-left: 2em"> 
                            ...
                            <div class="div-table transaction-detail green-scheme" style="width:100%; border-bottom:1px solid #333">
                                <div class="div-table-row">  
                                        ...
                                        <div class="div-table-col detail-col-header <?php echo $obj->hideOnDisabled(); ?>" style="width:25px;"></div> 
                                </div> 
                                ...
                                <?php  
                                      ...
                                      for ($i=0;$i<=$totalRows; $i++){  
                                            ...
                                            if ($i == $totalRows ){
                                                ...
                                                $_POST['qtyCost[]'] = $obj->formatNumber($qty,0);
                                ...
                                <div class="div-table-row  <?php echo $class; ?>" <?php echo $style; ?> >
                                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputNumber('qtyCost[]', array('overwritePost' => $overwrite, 'value'=> 1,'etc' =>  'style="text-align:right;" onChange="truckingServiceOrder.calculateDetailCost(this)" ','class' => 'form-control s-input',  'disabled' => $disabledSellingCost )); ?></div>
                                    <?php if ($showInvoicedQty) {?><div class="div-table-col detail-col-detail text-muted"  style="width:40px;">/ <span class="<?php echo $qtyInvoicedClass; ?>" style="text-align:right; width: 35px"><?php echo $obj->formatNumber($qtyInvoiced); ?></span></div><?php } ?>
                                    <div class="div-table-col detail-col-detail">
                                    ...
                                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputNumber('priceCost[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyOnInvoiced,   'etc' => 'style="text-align:right;"  onChange="truckingServiceOrder.calculateDetailCost(this)" ' ,'class' => 'form-control inputnumber s-input',  'disabled' => $disabledSellingCost)); ?></div>
                                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputNumber('subtotalCost[]', array('overwritePost' => $overwrite,'readonly' => true, 'etc' => 'style="text-align:right;"  onChange="truckingServiceOrder.calculateDetailCost(this)" ' , 'class' => 'form-control inputnumber s-input', 'disabled' => $disabledSellingCost)); ?></div>
