...
array_push($cellArray, array('label' => $obj->lang['jobOrderCode'], 'width' => '130' ));
...
for ($i=0;$i<count($rsDetail);$i++){   
  ...
  $html .= '<tr><td>'.$rsAp[0]['code'].'</td><td>'.$rsAp[0]['reftranscode2'].'</td><td>'.$rsAp[0]['customername'].'</td><td style="text-align:right">'.$obj->formatNumber($rsDetail[$i]['amount']).'</td></tr>' ; 
}
$html .= '</table>' ;
...
$payment .= '<tr>';
$payment .= '<td style="width: 150px;">'.$rsAPPaymentMethodDetail[$j]['paymentmethodname'].'</td>';
