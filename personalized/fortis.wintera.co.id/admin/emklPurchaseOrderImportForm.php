...
if (!empty($_GET['id'])){ 
    ...
    if($autoSellingReimburse)
        $rsJODetail = $emklJobOrderImport->getDetailByColumn('refkey', $rs[0]['refkey']);
    ...
    if($rs[0]['reftabletype']==$rsJOType['key']){
        ...
        $rsVolumeDetail = $emklJobOrderImport->getDetailVolume($rs[0]['refkey']);
        ...
        $_POST['depot'] = $rsEmkl[0]['depotname']; 
         ...
         $rsVolumeDetail =  $emklJobOrderHeaderImport->getDetailWithRelatedInformation($rs[0]['refjoheaderkey']);
                        ...
                        <div class="div-tab-panel"> 
                            <div class="div-table-caption border-purple"><?php echo ucwords($obj->lang['jobInformation']); ?></div>
                             <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['importir']); ?></label> 
                                        <div class="col-xs-9"> 
