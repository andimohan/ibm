...
$formAction = 'emklJobOrderExportHeaderList';
...
$_POST['closingDate'] = date('d / m / Y H:i');
$_POST['etaPod'] = $emptyDate;
$_POST['etdPol'] = $emptyDate;
$_POST['stuffingIn'] = $emptyDate;
$_POST['stuffingOut'] = $emptyDate;
$_POST['pebDate'] = $emptyDate;
...
if (!empty($_GET['id'])){ 
    ...
    $_POST['etdPol'] = $obj->formatDBDate($rs[0]['etdpol'],'d / m / Y', array('returnOnEmpty'=>true, 'value' => $emptyDateString));
    $_POST['etaPod'] = $obj->formatDBDate($rs[0]['etapod'],'d / m / Y', array('returnOnEmpty'=>true, 'value' => $emptyDateString));
    $_POST['stuffingIn'] = $obj->formatDBDate($rs[0]['stuffingin'],'d / m / Y', array('returnOnEmpty'=>true, 'value' => $emptyDateString));
    $_POST['closingDate'] = $obj->formatDBDate($rs[0]['closingdate'],'d / m / Y H:i', array('returnOnEmpty'=>true, 'value' => $emptyDateString)); 
    $_POST['aju'] = $rs[0]['aju'];  
    ...
    if (!empty($rs[0]['depotkey'])){
        $rsDepot = $depot->getDataRowById($rs[0]['depotkey']);
        $_POST['hidDepotlKey'] = $rs[0]['depotkey'];
        $_POST['depotName'] = $rsDepot[0]['name'];
    }
    ...
    if (!empty($rs[0]['billtokey'])){
        $rsCustomer = $customer->getDataRowById($rs[0]['billtokey']);
        $_POST['billToName'] = $rsCustomer[0]['name'] ;
        $_POST['hidBillToKey'] = $rsCustomer[0]['pkey'] ;
    }    
   ...
   if (!empty($rs[0]['placeofreceiptkey'])){
    ...
    $_POST['pebDate'] = $obj->formatDBDate($rs[0]['pebdate'],'d / m / Y', array('returnOnEmpty'=>true, 'value' => $emptyDateString)); 
...
$arrBillType = $class->convertForCombobox($emklJobOrderExport->getBillType(),'pkey','name');  
$arrFreight = $class->convertForCombobox($emklJobOrderExport->getFreightTerm(),'pkey','name'); 
$arrUnit = $class->convertForCombobox($itemUnit->searchData('','',true, ' and ('.$itemUnit->tableName.'.statuskey = 1 )'),'pkey','name');
      						 ...
      						 <div class="div-tab-panel"> 
                                   <div class="div-table-caption border-orange"><?php echo ucwords($obj->lang['generalInformation']); ?></div> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">  
                                            <?php echo $obj->inputText('quotationNumber'); ?>  
                                        </div> 
                                    </div> 
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                              <?php  echo $obj->inputAutoComplete(array(   
                                                                                'element' => array('value' => 'billToName',
                                                                                                   'key' => 'hidBillToKey'),
                                                                                'source' =>array(
                                                                                                    'url' => 'ajax-customer.php',
                                                                                                    'data' => array(  'action' =>'searchData' )
					...
					<?php if($useShippingInstruction){ ?>
                         <div class="div-tab-panel"> 
                             <div class="div-table-caption border-green"><?php echo ucwords($obj->lang['shippingIntruction']); ?></div>
                               ...
                               <div class="form-group">
                                    <label class="col-xs-3 control-label">PEB DATE</label> 
                                    <div class="col-xs-9">     
                                           <?php echo $obj->inputDate('pebDate'); ?>
                                    </div>  
                                </div> 
                               <div class="form-group">
                     ...
                     <div class="div-table-col">    
                        ...
                        <div class="div-tab-panel"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['closingDate']); ?> / <?php echo ucwords($obj->lang['stuffingDate']); ?></label> 
                                    <div class="col-xs-9">
                                            <div class="flex">
                                                <div class="consume"><?php echo $obj->inputDateTime('closingDate', array('etc'=>'style="text-align:center"','allowEmpty' => true )); ?> </div>
                                                <div>/</div>
                                                <div class="consume"><?php echo $obj->inputDate('stuffingIn', array('etc'=>'style="text-align:center"','allowEmpty' => true )); ?> </div>
                                            </div>                                        
                                    </div> 
                                </div> 
                                <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['terminal']); ?> / <?php echo ucwords($obj->lang['depot']); ?></label> 
 				                   <div class="col-xs-9">     
                                    <div class="flex"> 
                                            <div class="consume">
                                                <?php  echo $obj->inputAutoComplete(array( 
                                ...
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['container']); ?> / <?php echo ucwords($obj->lang['seal']); ?></label> 
                                  ...
                                  <!--<div class="form-group">
                                    <label class="col-xs-3 control-label">Lokasi Gudang Customer</label> 
                                        <div class="col-xs-9" >  
                                            <div class="flex">
                                                <div class="consume">
                                                    <?php  echo $obj->inputAutoComplete(array( 
