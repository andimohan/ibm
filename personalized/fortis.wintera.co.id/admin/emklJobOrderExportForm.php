...
if (!empty($_GET['id'])){
    ...
    $_POST['quotationNumber'] = $rs[0]['quotationnumber'];
                    ...
                    <div class="div-table-col"> 
      						 <div class="div-tab-panel"> 
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['quotation']); ?></label> 
                                        <div class="col-xs-9">  
                                            <?php echo $obj->inputText('quotationNumber', array('etc' => $attrHeader) ); ?>  
                                        </div> 
                                    </div> 
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label class="col-xs-3 control-label">Customer Ref.</label> 
                                        <div class="col-xs-9">
                                  ...
                                  <div class="form-group lcl-only lclnc">
                                    ...
                                    <div class="col-xs-9">   
                                        <div class="flex">
                                            ...
                                            <div class="consume"><?php echo  $obj->inputDecimal('volume', array('etc' => 'style="text-align:right;" mnv-attr-decimal="3"')); ?></div>
                     ...
                     <div class="div-table-col">   
                        <div class="div-tab-panel"> 
							...
							<div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-xs-3 control-label"> <?php echo ucwords($obj->lang['stuffingLocation']); ?></label> 
                                    <div class="col-xs-9"><?php echo $obj->inputText('stuffingLocation'); ?> </div>  
                                </div> 
         ...
         <?php  
                ...
                for($i=0;$i<=$totalRows;$i++){ 
                    ...
                    if ($i == $totalRows ){
                        ...
                        $_POST['detailMeasurement[]'] =  $obj->formatNumber($rsSalesDetail[$i]['measurement'],3);
                                 ...
                                 <div class="div-table-row">
                                    ...
                                    <div class="div-table-col"> 
                                        <div class="flex">
                                            ...
                                            <div style="width:60px"><?php echo $obj->inputDecimal('detailMeasurement[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyDetail,'disabled' =>  $disable,'add-class' => 'label-style', 'etc' => 'style="text-align:right;" mnv-attr-decimal="3" ')); ?></div>
...
-->
							...
							<?php if ($updateTaxAtJobOrder == 1) { ?>
                                ...
                                <div class="div-table-col detail-col-detail" style="width:30px;text-align:center; vertical-align:top">
							...
							<?php } ?>
                            <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col"  style="vertical-align:top; padding-top:5px !important"><?php echo $obj->inputLinkButton('btnAddDetailRow' , '<i class="fas fa-plus-circle"></i>', array('class' => 'btn btn-link add-row-button', 'etc' => 'attr-template="item-row-template"')) ?></div>
                            <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col"  style="vertical-align:top; padding-top:5px !important"><?php echo (!$readonly && !$isPurchaseReimburse) ? $obj->inputLinkButton('btnDeleteSalesRows' , '<i class="fas fa-times"></i>', array('class' => 'btn btn-link remove-button', 'etc' => 'tabIndex="-1"')) : ''; ?></div>
                        </div>
