...
$formAction = 'emklPurchaseOrderDomesticList';
...
$rsJOHeaderType = $obj->getTableKeyAndObj($emklJobOrderHeaderDomestic->tableName,array('key'));
...
if (!empty($_GET['id'])){ 
    ...
    if($autoSellingReimburse)
        $rsJODetail = $emklJobOrderDomestic->getDetailByColumn('refkey', $rs[0]['refkey']);
    ...
    if($rs[0]['reftabletype']==$rsJOType['key']){
        ...
        $rsVolumeDetail = $emklJobOrderDomestic->getDetailVolume($rs[0]['refkey']); 
        ...
        $_POST['depot'] = $rsEmkl[0]['depotname']; 
         ...
         $rsVolumeDetail =  $emklJobOrderHeaderDomestic->getDetailWithRelatedInformation($rs[0]['refjoheaderkey']);
...
$arrJob = $class->convertForCombobox($emklJobOrderDomestic->getJobType(),'pkey','name');  
$arrTransportType = $class->convertForCombobox($emklJobOrderDomestic->getTransportationType(),'pkey','name');  
$arrContainer = $class->convertForCombobox($emklJobOrderDomestic->getLoadContainer(),'pkey','name');  
...
//$arrVolume = $class->convertForCombobox($emklJobOrderDomestic->getVolumeUnit(),'pkey','name');  
                                                         ...
                                                         <?php    
                                                            echo $obj->inputAutoComplete(array( 
                                                                                            ...
                                                                                            'source' =>array(
                                                                                                                ...
                                                                                                                'data' => array( 'action' =>'searchData', 'statuskey' => '(1)', 'jobtypekey' => EMKL['jobType']['domestic'])
                                                                                                            ) , 
                                                                                            'allowedStatusForEdit' => array(1),
                                                                                            'callbackFunction' => 'getTabObj().onChangeJobHeader('.EMKL['jobType']['domestic'].')'
                                                                                          )
                                                                                    );  
                                                        ?> 
                                                    </div> 
                                                      ...
                                                      <?php    
                                                            echo $obj->inputAutoComplete(array( 
                                                                                            ...
                                                                                            'source' =>array(
                                                                                                                ...
                                                                                                                'data' => array( 'action' =>'searchData', 'statuskey' => '(1,2,3)', 'jobtypekey' => EMKL['jobType']['domestic'])
                                                                                                            ) , 
                                                                                            'allowedStatusForEdit' => array(1),
                                                                                            'callbackFunction' => 'getTabObj().onChangeJobOrder('.EMKL['jobType']['domestic'].')'
                                                                                          )
                                                                                    );  
                                                        ?> 
                                                    </div>
