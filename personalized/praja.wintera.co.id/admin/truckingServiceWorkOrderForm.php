...
-->
      ...
      <div class="div-table mnv-transaction transaction-detail" style="width:1650px; border-bottom:1px solid #333; ">
        <div class="div-table-row"> 
            <div class="div-table-col detail-col-header" style="width:300px;"><?php echo ucwords($obj->lang['destination']); ?></div>
...
<!--                <?php echo $obj->inputHidden('hidCostDetailCargoKey[]',array('overwritePost' => $overwrite, 'disabled' => $disabled, 'etc' => $etc)); ?> -->
                ...
                <div><?php echo $obj->inputText('destinationCargo[]',array('overwritePost' => $overwrite, 'readonly' => true, 'etc' => 'style="" ' . $etc)); ?></div>
		    </div> 
