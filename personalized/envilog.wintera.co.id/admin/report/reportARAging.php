...
$splitReimbursement = 0;// khusus logol

// kalo bkn truckign pasti gk ad reimbursement
//if (!$isTruckingPlanType) $splitReimbursement = 0;
...
$arrDataStructure['customerName'] = array('title'=>ucwords($obj->lang['customer']),  'width'=>"325px", 'dbfield' => 'customername',"sortable" => false, 'mergeExcelCell' => 3);
...
$arrDataDetailStructure['arcode'] = array('title'=>ucwords($obj->lang['arCode']),  'dbfield' => 'arcode', 'width'=>'120px', 'format' => 'string' ); 
$arrDataDetailStructure['refCode'] = array('title'=>ucwords($obj->lang['refCode']),  'dbfield' => 'refcode', 'width'=>'140px', 'format' => 'string' ); 
