...
array_push($cellArray, array('label' => $obj->lang['dateRef'], 'align' => 'center','width' => '80'));
...
$payment .= '<tr>';
$payment .= '<td style="width: 150px; padding-left:0">'.$rsARPaymentMethodDetail[$j]['paymentmethodname'].'</td>';
...
array_push($arrSignLabel, array('Dissetujui', 'Lastri'));
...
for ($i=0;$i<count($arrSignLabel);$i++){
	$html .='<td  class="sign-col" style="height:70px;"><strong>'.$arrSignLabel[$i][0].'</strong></td>';
