...
$serviceJO .= '<tr class="row-header"><td style="width:245px">Description</td><td style="width: 40px;"></td><td style="width: 40px; text-align:right">Qty</td><td  style="width: 35px;"></td><td style="text-align:right; width: 80px">Unit Price</td><td  style="width: 35px;"></td><td style="text-align:right; width: 80px">Disc Unit Price</td><td  style="width: 35px;"></td><td style="text-align:right">Amount</td></tr>';
...
//                }
                ...
                // khusus ktaro
                $priceUnit = $rsInvoiceItemDetail[$j]['priceinunit'];
...
//                <td style="border-top:1px solid #ccc; border-bottom:1px solid #ccc; text-align:right; ">'.$obj->formatNumber($totalServiceJo  + $totalPPN).'</td>  
//                </tr>';  
//    
    
// khusus ktaro gk pake ppn
...
// khusus Ktaro
$grandTotal = $totalServiceJo+$totalReimburseJo; 
...
$html .= '<table style="font-size:9px; ">
    <tr>
        ...
        <td  class="lite-color" style="width:190px; text-align:center">
                ...
                <br><br>
                <img src="/personalized/logol.wintera.co.id/img/ttd.jpg" style="width:150px">
                <br>
