...
$arrDataStructure['ajuPIB'] = array('title'=>ucwords($obj->lang['ajuPIB']),'dbfield' => 'aju', 'width'=>"100px" );
$arrDataStructure['sppbFinal'] = array('title'=>'SPPB Final','dbfield' => 'sppbdate', 'width'=>"100px",'format'=>'date','returnOnEmpty' => array('returnOnEmpty' => true, 'value' => ''));
$arrDataStructure['itemDescription'] = array('title'=>ucwords($obj->lang['goodsDescription']),'dbfield' => 'itemdescription', 'width'=>"200px" );
