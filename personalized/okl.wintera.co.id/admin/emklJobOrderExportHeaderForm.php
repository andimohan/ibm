...
if (!empty($_GET['id'])){ 
    ...
    $_POST['stuffingIn'] = $obj->formatDBDate($rs[0]['stuffingin'],'d / m / Y', array('returnOnEmpty'=>true, 'value' => '00 / 00 / 0000'));
    $_POST['closingDate'] = $obj->formatDBDate($rs[0]['closingdate'],'d / m / Y H:i', array('returnOnEmpty'=>true, 'value' => '00 / 00 / 0000')); 
    $_POST['aju'] = $rs[0]['aju'];  
	...
	$_POST['total'] = $obj->formatNumber($rs[0]['grandtotal']);
        ...
        //FORM BARU
    $_POST['truckingPlanningDate'] = $obj->formatDBDate($rs[0]['truckingplanningdate'],'d / m / Y', array('returnOnEmpty'=>true, 'value' => '00 / 00 / 0000'));
      						 ...
      						 <div class="div-tab-panel"> 
                                   <div class="div-table-caption border-orange"><?php echo ucwords($obj->lang['generalInformation']); ?></div> 
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                    <label class="col-xs-3 control-label">PO Number</label> 
                                    <div class="col-xs-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                     ...
                                     <div class="form-group">
                                    <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['planningSPPB']); ?></label> 
                                    <div class="col-xs-9">
                                       <?php echo $obj->inputDate('truckingPlanningDate',array( 'allowEmpty' => true)); ?> 
                                    </div> 
                                </div>
                                  <div class="form-group">
