...
<table style="'.$borderTop.$borderRight.$borderLeft.'width:660px">
    <tr>
        ...
        <td style="width:280px">
            ...
            <tr><td></td></tr>
            <tr><td style="width:40px;"></td><td style="text-algin:center"><div class="title">BON SEMENTARA</div></td></tr>
...
<tr><td style="width:30px"></td><td class="header-row-header" style="font-size:1.2em;">Dibayar kepada :</td><td style="width:530px;font-size:1.2em;">'.$rsEmployee[0]['name'].'</td></tr> 
</table>   ';
...
//        $itemName = $rsDetail[$i]['costname'].'<br>'.$itemName;      
    ...
    $html .= '<tr><td style="'.$borderRight.'">'.$rsCOA[0]['code'].' - '.$rsCOA[0]['name'].'</td><td style="'.$borderRight.'; font-size:1.2em">'.$rs[0]['trdesc'].'</td><td style="text-align:right">'.$obj->formatNumber($rs[0]['amount']).'</td></tr>' ; 
...
<tr class="" ><td style="width:235px;"></td><td style="width:335px;text-align:right" ></td><td style="'.$borderRight.$borderBottom.$borderLeft.'text-align:right; width:110px;">'.$obj->formatNumber($rs[0]['amount']).'</td></tr>
