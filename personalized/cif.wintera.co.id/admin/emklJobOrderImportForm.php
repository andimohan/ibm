...
/*  
    ...
    if(!empty($rs[0]['reftemplatekey'])) {
        $rsTemplate = $templateEMKLJobOrderImport->getDataRowById($rs[0]['reftemplatekey']);
...
<div style="width:100%; margin:auto; " class="tab-panel-form">   
  ...
  <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>" >
       ...
       <div class="div-table main-tab-table-2 header-panel">
                                        ...
                                        <div class="col-xs-9"> 
                                              <?php  echo $obj->inputAutoComplete(array(  
                                                                                        ...
                                                                                        'source' =>array(
                                                                                                        ...
                                                                                                        'data' => array('action' =>'searchData', 'statuskey' => '(1)', 'jobtypekey' => EMKL['jobType']['import'])
                                                                                                    ),  
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-xs-9">
				                    ...
				                    <div class="form-group lcl-only">
                                        ...
                                        <div class="col-xs-9"> 
                                            <div class="flex">
                                                <div><?php echo $obj->inputCheckBox('chkIsMaster', array('etc' => $attrHeader)); ?></div> 
                                                <div  class="consume"> 
                                                        <?php    
                                                        echo $obj->inputAutoComplete(array(
        ...
        <div class="div-table-caption" style="width:250px"><h4 class="container-detail-title"><?php echo ucwords($obj->lang['container']); ?> /
                <?php echo ucwords($obj->lang['seal']); ?></h4>
        </div>
        ...
        <div class="div-table transaction-detail no-odd-even-style" style="width:100%;border-bottom:1px solid #333;">
            ...
            <div class="div-table-row">
                ...
                <div class="div-table-col detail-col-header" style="width:250px">
                    <?php echo ucwords($obj->lang['deliveryAddress']); ?></div>
            ...
            for ($j = 0; $j <= $totalRows; $j++) {
                ...
                <div class="div-table-row <?php echo $class; ?> ">
                    ...
                    <div class="div-table-col detail-col-detail" style="vertical-align:top">
                        <?php echo $obj->inputDecimal('detailGrossWeight[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"  mnv-attr-decimal="3"' . $etc, 'disabled' => $disabled)); ?>
                    </div>
                        ...
                        <?php  
                            ...
                            for ($j=0;$j<=$totalItemRows; $j++){  
                                ...
                                if ($j == $totalItemRows ){
                                    ...
                                    $_POST['chkIncludeTaxDetail[]'] = $rsItemDetail[$j]['ispriceincludetax'];  
