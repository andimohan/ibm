...
includeClass(array('CashAdvanceRealization.class.php','Tax.class.php'));
...
if (!empty($_GET['id'])){ 
    ...
    $_POST['totalPPH'] = $obj->formatNumber($rs[0]['totalpph']); 
                    ...
                    <div class="div-table-col" style="padding:0">
                        <div class="div-table" style="width:100%">
                            <div class="div-table-row">
                                ...
                                <div class="div-table-col detail-col-header" style="width:120px;"><?php echo ucwords($obj->lang['reimburse']); ?></div>  
                                ...
                                <div class="div-table-col detail-col-header pph-field" style="width:100px;"><?php echo ucwords($obj->lang['PPhType']); ?></div> 
                                <div class="div-table-col detail-col-header pph-field" style="width:80px;text-align:right;"><?php echo ucwords($obj->lang['PPhValue']); ?></div> 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        $style = '';
			             ...
			             if ($i == $totalRows ){
                            ...
                            $_POST['pphAmount[]'] =  $obj->formatNumber($rsDetail[$i]['pphamount']);
                        ...
                        <div class="div-table" style="width:100%">
                            <div class="div-table-row">
								...
								<div class="div-table-col detail-col-detail" style="width:120px;text-align:center;">
									<?php echo $obj->inputSelect('chkIsReimburse[]', $arrReimburseType,array('value' => -1,'overwritePost' => $overwrite, 'readonly' => $readonly , 'disabled' =>  $disable ,  'etc' => 'style="" ' .$etc)); ?>
								 </div>   
								...
								<div class="div-table-col detail-col-detail" style="width:80px;text-align:center;">
									<?php echo $obj->inputNumber('pphAmount[]',array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' =>  $disable ,  'etc' => 'style="text-align:right;" ' .$etc)); ?>
								</div> 
								<div class="div-table-col detail-col-detail" style="width:120px;text-align:center;">
									<?php echo $obj->inputNumber('subtotal[]',array('overwritePost' => $overwrite, 'readonly' => true,   'disabled' =>  $disable ,  'etc' => 'style="text-align:right;" ' .$etc)); ?>
								</div>  
        ...
        <div class="div-table transaction-detail" style="float:right;">
                <div class="mnv-total-group mnv-cost" style="margin-top:1em">  
                    ...
                    <div class="div-table" style="width: 100%">
                              ...
                              <div class="div-table-row  form-group"> 
                                    <div class="div-table-col-3" style="text-align:right;"> 
                                           <?php echo $obj->lang['total']; ?> PPH
                                    </div>  
                                    <div class="div-table-col-3" style="width:120px;"> 
                                            <?php echo $obj->inputNumber('totalPPH', array('readonly' => true, 'etc' => 'style="text-align:right;" ' )); ?> 
                                    </div> 
                                    <div class="div-table-col-3  <?php echo $obj->hideOnDisabled(); ?> icon-col"></div> 
                              </div>
                        </div>
