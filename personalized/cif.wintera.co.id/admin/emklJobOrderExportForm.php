...
includeClass('EMKLJobOrder.class.php','TemplateEMKLJobOrder.class.php');
...
$autoUpdateEMKLJobOrderContainer = $obj->loadSetting('autoUpdateEMKLJobOrderContainer');
...
if (!empty($_GET['id'])){
    ...
    if(!empty($rs[0]['connectingcountrykey'])) {
        $rsCountry = $country->getDataRowById($rs[0]['connectingcountrykey']);
        $_POST['connectingCountryName'] = $rsCountry[0]['name'];
    }
    if(!empty($rs[0]['connectingcountry2key'])) {
        $rsCountry = $country->getDataRowById($rs[0]['connectingcountry2key']);
        $_POST['connectingCountry2Name'] = $rsCountry[0]['name'];
    }
    if(!empty($rs[0]['connectingcountry3key'])) {
        $rsCountry = $country->getDataRowById($rs[0]['connectingcountry3key']);
        $_POST['connectingCountry3Name'] = $rsCountry[0]['name'];
    }
...
// shiping instruction
    ...
    $_POST['weightQty'] = $obj->formatNumber($rs[0]['weightqty'],4);
    $_POST['measurement'] = $obj->formatNumber($rs[0]['measurement'],4);

    $_POST['hidTemplateKey'] = $rs[0]['reftemplatekey'];
    if(!empty($rs[0]['reftemplatekey'])) {
        $rsTemplate = $templateEMKLJobOrderExport->getDataRowById($rs[0]['reftemplatekey']);
        $_POST['templateName'] = $rsTemplate[0]['name'];
    }
...
$defaultTransporType = [['pkey' => 0, 'name' => '----']];
$rsTransporType = $obj->getTransportationType();
$arrTransportType = array_merge($defaultTransporType, $rsTransporType);
$arrTransportType = $class->convertForCombobox($arrTransportType,'pkey','name');
...
$defaultShipmentType = [['pkey' => 0, 'name' => '----']];
$arrShipmentType = $obj->getShipmentType();
$arrShipmentType = array_merge($defaultShipmentType, $arrShipmentType); 
$arrShipmentType = $obj->generateComboboxOpt(array('data' =>$arrShipmentType));
...
<script type="text/javascript">  
	jQuery(document).ready(function(){  
         ...
         var varConstant = {  
                            ...
                            autoUpdateEMKLJobOrderContainer :  <?php echo ($autoUpdateEMKLJobOrderContainer == 1) ? 'true' : 'false' ; ?> ,
                            };
         ...
         var fieldValidation =  { code: { 
                                  ...
                                  salesName: { 
                                        validators: {
                                            notEmpty: {
                                                message: phpErrorMsg.emklJobOrder[4]
                                            }, 
                                        }
                                    }, 
                                    ...
                                    agentName: { 
                                        validators: {
                                            notEmpty: {
                                                message: phpErrorMsg.emklJobOrder[5]
                                            }, 
                                        }
                                    }, 
...
//        $(".shortcut-hbl").click(function(){ 
//            openTabForShortCutEdit("emklHouseBLForm",$(this).closest(".div-table-row").find("[name=\"hidDetailHBLKey[]\"]").val(),{'title' : "Test"}); 
//        });
...
-->
                                    ...
                                    <div class="form-group">
     <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['templateJobOrder']); ?></label> 
                                        <div class="col-xs-9"> 
                                              <?php  echo $obj->inputAutoComplete(array(  
                                                                                        'revalidateField' => false,
                                                                                        'element' => array('value' => 'templateName',
                                                                                                        'key' => 'hidTemplateKey'),
                                                                                        'source' =>array(
                                                                                        ...
                                                                                        'callbackFunction' => 'getTabObj().importTemplate()'
                                                                                    ) 
                                                                                );  
                                            ?> 
                                        </div> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">   
                                            <div class="flex">
                                                ...
                                                <div ><?php echo  $obj->inputDecimal('weightQty', array('etc' => 'mnv-attr-decimal=4')); ?></div>
                                                <div class="text-muted" style="margin-right:3px">KG</div> 
                                                <div ><?php echo  $obj->inputDecimal('measurement', array('etc' => 'mnv-attr-decimal=4')); ?></div>
  ...
  <div class="form-group">
        ...
        <div class="div-table-caption" style="width:250px"><h4 class="container-detail-title"><?php echo ucwords($obj->lang['container']); ?> / <?php echo ucwords($obj->lang['seal']); ?></h4></div>
            ...
            <div class="div-table transaction-detail no-odd-even-style" style="width:100%;border-bottom:1px solid #333;">
                ...
                <div class="div-table-row">   
                        <div class="div-table-col detail-col-header sea-only"  style="width:145px;"><?php echo ucwords($obj->lang['containerNumber']); ?> *</div> 
                        <div class="div-table-col detail-col-header sea-only" style="width:145px;"><?php echo ucwords($obj->lang['sealNumber']); ?> *</div>
                        <div class="div-table-col detail-col-header sea-only" style="width:90px;"><?php echo ucwords($obj->lang['type']); ?> *</div>
                        <div class="div-table-col detail-col-header " style="width:70px; text-align:right;"><?php echo ucwords($obj->lang['qty']); ?></div>
                        ...
                        <div class="div-table-col detail-col-header sea-only" style="width:100px; text-align:right;">Meas (Cbm)</div> 
                        <div class="div-table-col detail-col-header" style="width:250px"><?php echo ucwords($obj->lang['deliveryAddress']); ?></div> 
                    ...
                    <?php 
                            ...
                            for ($j=0;$j<=$totalRows; $j++){ 
                                    ...
                                    if ($j == $totalRows ){
                                        ...
                                        $_POST['deliveryAddress[]'] = $rsContainerDetail[$j]['deliveryaddress'];
                                    }
                                    $hideDeleteIcon = '';  
                                ?>
                                    <div class="div-table-row <?php echo $class; ?> " > 
                                        ...
                                        <div class="div-table-col detail-col-detail sea-only" style="vertical-align:top">
								            <?php echo $obj->inputText('sealNo[]', array('overwritePost' => $overwrite, 'etc' => 'style="" ' . $etc, 'readonly' => $readonly, 'disabled' => $disabled )); ?>
                                        </div>
                                        <div class="div-table-col detail-col-detail sea-only" style="vertical-align:top">
								            <?php echo $obj->inputSelect('selContainerTypeDetail[]', $arrContainerVolume , array('overwritePost' => $overwrite, 'etc' => 'style="" ' . $etc, 'readonly' => $readonly, 'disabled' => $disabled )); ?>
                                        </div>
                                        ...
                                        <div class="div-table-col detail-col-detail" style="vertical-align:top">
                                                <?php echo $obj->inputSelect('selUnit[]', $arrUnit, array('overwritePost' => $overwrite, 'etc' => 'style="" ' . $etc, 'readonly' => $readonly,'disabled' =>  $disabled)); ?>
                                        </div> 
                                        <div class="div-table-col detail-col-detail" style="vertical-align:top"><?php echo $obj->inputDecimal('detailGrossWeight[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;" mnv-attr-decimal="3"' . $etc, 'disabled' => $disabled)); ?></div>
                                        <div class="div-table-col detail-col-detail air-only" style="vertical-align:top"><?php echo $obj->inputDecimal('detailChargeWeight[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"  mnv-attr-decimal="3"' . $etc, 'disabled' => $disabled)); ?></div>
                                        <div class="div-table-col detail-col-detail sea-only" style="vertical-align:top">
										        <?php echo $obj->inputDecimal('detailNetWeight[]', array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disabled,  'etc' => 'style="text-align:right"  mnv-attr-decimal="3" ' . $etc )); ?>
                                        </div>                                                
                                        <div class="div-table-col detail-col-detail sea-only" style="vertical-align:top">
                                        ...
                                        <div class="div-table-col detail-col-detail" style="vertical-align:top">
										     <?php echo $obj->inputTextArea('deliveryAddress[]', array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disabled, 'class' => 'form-control label-style', 'etc' => 'style="height:6em"' . $etc)); ?>
                                        </div> 

                                                
										<div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col" style="vertical-align:top"><?php echo $obj->inputLinkButton('btnAddDetailRow' , '<i class="fas fa-plus-circle"></i>', array('class' => 'btn btn-link add-row-button', 'etc' => 'attr-template="container-row-template"')); ?></div>
										<div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col" style="vertical-align:top"><?php echo $obj->inputLinkButton('btnDeleteRows' , '<i class="fas fa-times"></i>', array('class' => 'btn btn-link remove-button', 'etc' =>  'tabIndex="-1" style=" '.$hideDeleteIcon.'"')); ?></div>
                ...
                for($i=0;$i<=$totalRows;$i++){ 
                    ...
                    if ($i == $totalRows ){
						...
						if($isActiveMasterHBL){ 
							...
							$_POST['refDetailHBL[]'] = $rsSalesDetail[$i]['refdetailhbl'];
						}
                        ...
                        $_POST['detailWeight[]'] =  $obj->formatNumber($rsSalesDetail[$i]['weight'],4);
                        $_POST['detailMeasurement[]'] =  $obj->formatNumber($rsSalesDetail[$i]['measurement'],4);
                ...
                <div class="div-table-row">
                    ...
                    <div class="div-table" style="width:100%;"> 
                     <div class="div-table-row customer-row-header">   
                         <div class="div-table-col" style="width:550px;">
                             <div class="div-table"  style="width:96%;">
                                <div class="div-table-row">
                                    <div class="div-table-col" style="width:60px; font-weight:bold"><?php echo $obj->lang['code']; ?></div>
                                    <div class="div-table-col">
...
<!--										  	<div class="icon-button add-hbl" style="<?php echo $showButtonHBL; ?>"><i class="fas fa-file-medical"></i></div>-->
                                ...
                                <!--
                                <div class="div-table-row">
                                    <div class="div-table-col" style="font-weight:bold"><?php echo $obj->lang['refHBL']; ?></div>
                                    <div class="div-table-col" style="width:170px;">
                                    <?php echo $obj->inputText('refDetailHBL[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyDetail, 'disabled' => $disable, 'class' => 'form-control label-style')); ?>
                                    </div>
                                </div> 
                                -->
...
-->
                                 ...
                                 <div class="div-table-row">
                                    ...
                                    <div class="div-table-col"> 
                                        <div class="flex">
                                            <div class="consume"><?php echo  $obj->inputNumber('detailQty[]', array('overwritePost' => $overwrite, 'readonly' => true ,'disabled' =>  $disable, 'add-class' => 'label-style', 'etc' => 'style="text-align:right"')); ?></div>
                                            <div  style="font-weight:bold"><?php echo $obj->inputSelect('detailSelUnit[]', $arrUnit, array('overwritePost' => $overwrite, 'readonly' => true,'disabled' =>  $disable,'add-class' => 'label-style')); ?></div>
                                            <div style="width:90px"><?php echo $obj->inputDecimal('detailWeight[]', array('overwritePost' => $overwrite, 'readonly' => true,'disabled' =>  $disable,'add-class' => 'label-style', 'etc' => 'style="text-align:right" mnv-attr-decimal=4' )); ?></div>
                                            <div style="font-weight:bold">KG</div>  
                                            <div style="width:90px"><?php echo $obj->inputDecimal('detailMeasurement[]', array('overwritePost' => $overwrite, 'readonly' => true,'disabled' =>  $disable,'add-class' => 'label-style', 'etc' => 'style="text-align:right" mnv-attr-decimal=4' )); ?></div>
                        ...
                        <?php  
                            ...
                            for ($j=0;$j<=$totalItemRows; $j++){  
                                ...
                                if ($j == $totalItemRows ){
                                    ...
                                    $isPurchaseReimburse = false; //($rsItemDetail[$j]['refpurchaseorderdetailkey'] > 0) ? true : false; 
                                    $readonlyReimburse = ($rsItemDetail[$j]['isreimburse'] > 0 ? true : false);
                                    
                                    // sementara
//                                    if($isPurchaseReimburse){
//                                         $onClickCheckReimburse = 'onclick="return false"';
//                                         $readonly = true;
//                                    }
                                } 
                        ...
                        <div class="div-table-row <?php echo $class; ?>"> 
                            <div class="div-table-col  fcl-only sea-only detail-col-detail"  style="vertical-align:top">
                            ...
                            <div class="div-table-col detail-col-detail"  style="vertical-align:top"><?php echo $obj->inputDecimal('qty[]', array('overwritePost' => $overwrite,'readonly' => $readonly, 'value' => 1, 'etc' => 'style="text-align:right;" mnv-attr-decimal="3";', 'disabled' =>  $disable)); ?></div>
                            <div class="div-table-col detail-col-detail"  style="vertical-align:top">
                                ...
                                <?php echo $obj->inputTextArea('descriptionDetail[]', array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disable,'etc' => 'style="height:6em; margin-top:0.3em"' )); ?>
                            </div>  
                            <div class="div-table-col detail-col-detail"  style="vertical-align:top"><?php echo $obj->inputSelect('selCurrencyDetail[]',$arrCurrency, array('overwritePost' => $overwrite, 'readonly' => $readonly,'disabled' =>  $disable)); ?></div>
                            <div class="div-table-col detail-col-detail"  style="vertical-align:top"><?php echo $obj->inputDecimal('priceInUnit[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"','readonly' => $readonly, 'disabled' =>  $disable, 'class' =>'form-control ' . $numberClass)); ?></div>
	                        <?php if ($updateTaxAtJobOrder == 1) { ?>
								<div class="div-table-col detail-col-detail" style="width:70px;text-align:right;vertical-align:top">
                                    <?php echo $obj->inputSelect('taxDetail[]', TAX_VALUE, array('overwritePost' => $overwrite, 'readonly' => $readonlyReimburse || $readonly, 'disabled' => $disable, 'etc' => 'style="text-align:right;" ' . $etc, 'add-class' => 'no-padding')); ?>
                                ...
                                <div class="div-table-col detail-col-detail" style="width:30px;text-align:center;vertical-align:top;line-height:3.5em">
                            ...
                            <?php } ?>
                            <div class="div-table-col detail-col-detail" style="vertical-align:top"><?php echo $obj->inputDecimal('detailRowCurrencySubtotal[]', array('overwritePost' => $overwrite,'readonly' => true, 'etc' => 'style="text-align:right;" ', 'disabled' =>  $disable)); ?></div>
                            <div class="div-table-col detail-col-detail active-currency text-muted" style="vertical-align:top;line-height:3em"><?php echo $arrCurrencyName[$activeCurrencyKey]['name'] ;?></div>
                            <div class="div-table-col detail-col-detail" style="vertical-align:top"><?php echo $obj->inputDecimal('detailRowSubtotal[]', array('overwritePost' => $overwrite,'readonly' => true, 'etc' => 'style="text-align:right;" ' ,  'disabled' =>  $disable)); ?></div>
							...
							<?php if($updateTaxAtJobOrder == 1) { ?> 
                                <div class="div-table-col detail-col-detail" style="text-align:center; vertical-align:top;line-height:3.5em">
                                    <?php echo $obj->inputCheckBox('chkIsReimburse[]', array('readonly' => $readonly,'disabled' => $disable,'etc'=> $onClickCheckReimburse ,'allowedStatusForEdit' => array(1))); ?>
                                </div>
							<?php } ?>
                            <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col" style="vertical-align:top;line-height:3.5em"><?php echo $obj->inputLinkButton('btnAddDetailRow' , '<i class="fas fa-plus-circle"></i>', array('class' => 'btn btn-link add-row-button', 'etc' => 'attr-template="item-row-template"')) ?></div>
                            <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col" style="vertical-align:top;line-height:3.5em"><?php echo (!$readonly && !$isPurchaseReimburse) ? $obj->inputLinkButton('btnDeleteSalesRows' , '<i class="fas fa-times"></i>', array('class' => 'btn btn-link remove-button', 'etc' => 'tabIndex="-1"')) : ''; ?></div>
                        </div>
