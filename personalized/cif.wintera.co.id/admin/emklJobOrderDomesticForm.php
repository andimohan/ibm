  ...
  <div style="clear:both; height:1em;"></div>  
        ...
        <div class="div-table transaction-detail no-odd-even-style" style="width:100%;border-bottom:1px solid #333;">
            ...
            <div class="div-table-row">
                ...
                <div class="div-table-col detail-col-header " style=""></div>
            ...
            for ($j = 0; $j <= $totalRows; $j++) {
                ...
                <div class="div-table-row <?php echo $class; ?> ">
                    ...
                    <div class="div-table-col detail-col-detail sea-only" style="vertical-align:top">
                        ...
                        <?php echo $obj->inputText('containerNo[]', array('overwritePost' => $overwrite, 'etc' => 'style="" ' . $etc, 'readonly' => $readonly, 'disabled' => $disabled)); ?>
                    ...
                    <div class="div-table-col detail-col-detail air-only" style="vertical-align:top"><?php echo $obj->inputDecimal('chargeWeight[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' . $etc, 'disabled' => $disabled)); ?></div></div>
                    <div class="div-table-col detail-col-detail sea-only" style="vertical-align:top">
                                                ...
                                                for ($j = 0; $j <= $totalItemRows; $j++) {
                                                    ...
                                                    <div class="div-table-row <?php echo $class; ?>">
                                                        ...
                                                        <div class="div-table-col detail-col-detail">
                                                            <?php echo $obj->inputDecimal('qty[]', array('overwritePost' => $overwrite, 'readonly' => $readonly, 'value' => 1, 'etc' => 'style="text-align:right;" mnv-attr-decimal="3"', 'disabled' => $disable)); ?>
                                                        </div>
                                                        <div class="div-table-col detail-col-detail">
