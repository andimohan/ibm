...
includeClass(array('EMKLJobOrder.class.php', 'EMKLCommission.class.php', 'CreditNote.class.php', 'DebitNote.class.php', 'CashAdvanceRealization.class.php'));
...
$generateReportContent = function ($dataset) {
    ...
    $emklPurchaseOrderExportAccess =  true; // $security->hasSecurityAccess($obj->userkey, $security->getSecurityKey($emklPurchaseOrderImport->securityObject), 10);
