...
$generateReportContent = function ($dataset) {
    ...
    $html .= '<table cellpadding="2" width="100%"><tr>
                    <td style="width:250px;">' . $logo . '<br><span style="font-weight:bold;font-size:14px;">' . $companyName . '</span>
                    <br><span style="font-size:11px;">' . nl2br($companyAddress) . '</span>
                    </td>
    ...
    $html .='<div style="clear:both"></div>
        ...
        <tr>
            ...
            <table>
            <tr><td>Jakarta, '. $obj->formatDBDate($rs[0]['trdate'],'d F Y') .'</td></tr>
            </table></td>
        </tr>
        <tr>
            ...
            <table>
                <tr>
                    ...
                    <td style="width:150px;">'. $cargoType .'</td>
                </tr>
                <tr>
    ...
    $html .= '<table cellpadding="4">
        <tr>
            ...
            <td style="width:125px;border-top:1px solid black;border-left:1px solid black; border-right:1px solid black;text-align:center;">JUMLAH RUPIAH</td>
        </tr>';
    ...
    $tableSubtotal ='<table cellpadding="4">
                <tr>
                    <td rowspan="'.(count($arrSubtotal) + 2).'" style="width:80px;">TERBILANG : </td>
                    <td rowspan="'.(count($arrSubtotal) + 2).'" style="width:350px;">' . ucwords($sayNumber) . ' Rupiah.</td>
    ...
    $html .= '<table cellpadding="2">
        <tr>
            ...
            <td style="width:200px;">' . $rs[0]['trdesc'] . '</td>
        </tr>
        <tr><td></td></tr>
        <tr><td></td></tr>
        <tr><td></td></tr>
        ...
        <tr>
            <td style="width:550px;"><table><tr>
                ...
                <tr>
                    <td style="width:300px;">Bank ' . $rsPaymentMethod[0]['bankname'] . '</td>
                </tr>
                <tr>
                    <td style="width:300px;">AC No. ' . $rsPaymentMethod[0]['bankaccountnumber'] . '</td>
                </tr>
                </table>
            </td>
        ...
        <tr><td></td></tr>
        <tr><td></td></tr>
        <tr><td style="width:100px;">Note : </td></tr>
        <tr><td style="width:300pxpx;">Lewat dari 7 hari setelah Debet Nota diterima,</td></tr>
        <tr><td style="width:300pxpx;">maka koreksi/ keberatan tidak dapat kami layani.</td></tr>
    </table>';
