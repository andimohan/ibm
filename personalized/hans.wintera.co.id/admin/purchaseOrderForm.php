       ...
       <div class="div-table main-tab-table-2">
        ...
        <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; ">
                <div class="div-table-row">
                    ...
                    <div class="div-table-col detail-col-header" style="width:100px; text-align:right;"><?php echo ucwords($obj->lang['qty']) . ' Gr'; ?></div>
                    <div class="div-table-col detail-col-header" style="width:50px; text-align:center;"><?php echo ucwords('/Gr'); ?></div>
                    <div class="div-table-col detail-col-header" style="width:100px; text-align:right;"><?php echo ucwords($obj->lang['price']); ?> Unit</div>
                ...
                <?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $readonlyTotalGramasi = ($rsPurchaseDetail[$i]['isweightfixed'] == 1) ? true : false;
                ...
                <div class="div-table-row <?php echo $class; ?>">  
                    <div class="div-table-col detail-col-detail" style="width:60px; text-align:right;"><?php echo $obj->inputInteger('numberDetail[]', array('overwritePost' => $overwrite, 'readonly'=>true, 'etc' => 'style="text-align:right;" ' . $etc)); ?></div>
                    ...
                    <div class="div-table-col detail-col-detail" style="width:100px; text-align:right;"><?php echo $obj->inputNumber('qtyInPcs[]', array('overwritePost' => $overwrite,'readonly' =>$readonlyTotalGramasi, 'etc' => 'style="text-align:right;"' . $etc)); ?>
                    </div>
                    <div class="div-table-col detail-col-detail" style="text-align:center;width:50px;">
                        <?php echo $obj->inputHidden('chkWeightFixed[]',array('overwritePost' => $overwrite, 'etc' => $etc)); ?>
                        <?php echo $obj->inputHidden('gramasi[]',array('overwritePost' => $overwrite, 'etc' => $etc)); ?>
                        <?php echo $obj->inputCheckbox('chkPriceInPcs[]', array('overwritePost' => $overwrite, 'value' => 0, 'etc' => 'style="text-align:center;"' . $etc)) ?>
                    </div>
                    <div class="div-table-col detail-col-detail price-in-unit-wrapper" style="width:120px;text-align:right;">
                        <?php echo $obj->inputNumber('priceInUnit[]', array('overwritePost' => $overwrite, 'readonly' => $readOnlyPriceInUnit, 'etc' => 'style="text-align:right;"' . $etc)); ?>
                    </div>
                    <div class="div-table-col detail-col-detail price-in-pcs-wrapper" style="width:120px;text-align:right;">
                        <?php echo $obj->inputNumber('priceInPcs[]', array('overwritePost' => $overwrite, 'readonly' => $readOnlyPriceInPcs, 'etc' => 'style="text-align:right;"' . $etc)); ?>
                    </div>
