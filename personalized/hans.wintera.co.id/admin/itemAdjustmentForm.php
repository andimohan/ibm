      ...
      <div class="<?php echo $obj->hideOnDisabled(); ?>">
        ...
        <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; ">
                <div class="div-table-row"> 
                    ...
                    <div class="div-table-col detail-col-header" style="width:80px; text-align:right;"><?php echo ucwords($obj->lang['prevQty']); ?></div> 
                    <div class="div-table-col detail-col-header" style="width:80px; text-align:right;"><?php echo ucwords($obj->lang['newQty']); ?></div> 
                    <div class="div-table-col detail-col-header" style="width:80px; text-align:right;"><?php echo ucwords($obj->lang['adjustment']); ?></div> 
                    <div class="div-table-col detail-col-header" style="width:50px"></div>
                    <div class="div-table-col detail-col-header" style="width:90px; text-align:right;"><?php echo ucwords($obj->lang['prevQty'] . ' Gr'); ?></div> 
                    <div class="div-table-col detail-col-header" style="width:90px; text-align:right;"><?php echo ucwords($obj->lang['newQty'] . ' Gr'); ?></div> 
                    <div class="div-table-col detail-col-header" style="width:100px; text-align:right;"><?php echo ucwords($obj->lang['adjustment'] . ' Gr'); ?></div> 
                    <div class="div-table-col detail-col-header" style="width:40px; text-align:center;"><?php echo ucwords('/Gr') ?></div>
					...
					<div class="div-table-col detail-col-header" style="width:100px; text-align:right;"><?php echo ucwords($obj->lang['cogs'] . ' Gr'); ?></div>
				...
				<?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){   
                        ...
                        if ($i == $totalRows ){
                            ...
                            $_POST['chkCostInPcs[]'] =   $obj->formatNumber($rsDetail[$i]['iscostinpcs']); 
                            $_POST['COGS[]'] =   $obj->formatNumber($rsDetail[$i]['costinbaseunit']); 

                            $_POST['COGSInPcs[]'] =   $obj->formatNumber($rsDetail[$i]['costinpcs'],2); 
                            $_POST['hidGramasi[]'] =   $obj->formatNumber($rsDetail[$i]['gramasi'],2); 
                            $_POST['hidIsWeightFixed[]'] =  $rsDetail[$i]['isweightfixed']; 
                            
                            $_POST['qtyBeforeInPcs[]'] =   $obj->formatNumber($rsDetail[$i]['qtybeforeinpcs'],2); 
                            $_POST['qtyAfterInPcs[]'] =   $obj->formatNumber($rsDetail[$i]['qtyafterinpcs'],2); 
                            $_POST['qtyAdjustInPcs[]'] =   $obj->formatNumber($rsDetail[$i]['qtyadjustinpcs'],2); 

                            $rsItem = $item->getDataRowById($rsDetail[$i]['itemkey']);

                            if($rsItem[0]['isweightfixed'] == 1) {
                                $readonlyWeightFixed = true;
                            }

                        if ($rsDetail[$i]['iscostinpcs'] == 1) {
                 ...
                 ?>
                   ...
                   <div class="div-table-row <?php echo $class; ?>"> 
                    <div class="div-table-col detail-col-detail">
                        ...
                        <?php echo $obj->inputHidden('hidIsWeightFixed[]',array('overwritePost' => $overwrite, 'etc' => $etc)); ?>
                    ...
                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputDecimal('qtyBeforeInPcs[]', array('overwritePost' => $overwrite, 'readonly' => true, 'etc' => 'style="text-align:right;" ' .$etc)); ?></div> <!--onChange="itemAdj.calculateTotal(this)" -->
                    <div class="div-table-col detail-col-detail">
                        <?php echo $obj->inputDecimal('qtyAfterInPcs[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyWeightFixed, 'etc' => 'style="text-align:right;"' .$etc)); ?>
                        <?php echo $obj->inputHidden('hidGramasi[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' .$etc)); ?>
                    </div>  <!-- onChange="itemAdj.calculateTotal(this)"-->
                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputDecimal('qtyAdjustInPcs[]', array('overwritePost' => $overwrite, 'readonly' => true, 'etc' => 'style="text-align:right;" ' .$etc)); ?></div>
                    <div class="div-table-col detail-col-detail" style="text-align:center;"><?php echo $obj->inputCheckbox('chkCostInPcs[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:center;"' .$etc)) ?></div>
                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputNumber('COGS[]',array('overwritePost' => $overwrite, 'readonly' => $readOnlyPriceInUnit, 'etc' => 'style="text-align:right;" ' .$etc)); ?></div>
                    <div class="div-table-col detail-col-detail"><div class="text-muted"><span class="baseitemunit">/ <?php echo (!empty($rsDetail[$i]['baseunitname'])) ? $rsDetail[$i]['baseunitname'] : ''; ?></span></div></div>
                    <div class="div-table-col detail-col-detail"><?php echo $obj->inputDecimal('COGSInPcs[]',array('overwritePost' => $overwrite, 'readonly' => $readOnlyPriceInPcs, 'etc' => 'style="text-align:right;" ' .$etc)); ?></div>
