...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
		...
		var varConstant = {  
            TABLEKEY : tablekey, 
            WEIGHT_CALCULATION : {autoCalculate : true, readonlyWeight: true}
         };
             
					 
        salesOrder = new SalesOrder(tabID,<?php echo json_encode($rs); ?>,  
                                    cashTOP,<?php echo json_encode($rsVoucher); ?> ,
                                    varConstant);
      						 ...
      						 <div class="div-tab-panel"> 
                                   <div class="div-table-caption border-orange"><?php echo ucwords($obj->lang['generalInformation']); ?></div> 
                                    ...
                                    <div class="form-group" style="padding-bottom:7px">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['ready']); ?> / <?php echo ucwords($obj->lang['indent']); ?></label> 
                                        <!-- <div class="col-xs-1"> 
                                        ...
                                        <!--<label class="col-xs-3 control-label" style="padding-left:0"><span class="isready" style=""><?php echo ucwords($obj->lang['ready']); ?></span><span class="isindent" style="display:none;"><?php echo ucwords($obj->lang['indent']); ?></span></label> -->
                                    </div>  
                                    <div class="form-group">
        ...
        <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; ">
            ...
            <div class="div-table" style="width:100%">                               
                ...
                <div class="div-table-row">
                    ...
                    <div class="div-table-col detail-col-detail" style="width:80px; text-align:right;"><?php echo $obj->inputNumber('qtyInPcs[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;" mnv-attr-decimal="2"','readonly'=>true, 'disabled' => $disabled)); ?></div>
                ...
                <div class="div-table" style="width:80%; margin-left: 2em">
                    <div class="div-table-row">
                        <div class="div-table-col detail-col-detail"><?php echo $obj->inputText('trDetailDesc[]', array('overwritePost' => $overwrite, 'etc' => 'style="font-size:1.3em" placeholder="' . $obj->lang['description'] . '"')); ?></div>
