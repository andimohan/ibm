         ...
         this.updateSOInformationHeader = function updateSOInformationHeader(){
                ...
                $.ajax({
                    ...
                    if (data.length > 0 ){
                        ...
                        $("#" + tabID + " [name=routeFrom]").val(data.stuffinglocationfromname);
                        $("#" + tabID + " [name=routeTo]").val(data.locationname);
                        ...
                        <div class="div-tab-panel"> 
                            <div class="div-table-caption border-blue"><?php echo $obj->lang['stuffingDestuffingInformation']; ?></div>
                               <div class="form-group">
                                ...
                                <div class="col-xs-9" > 
                                    <div class="flex">
                                        <div class="consume"><?php echo $obj->inputText('routeFrom',array( 'allowedStatusForEdit' => array (1), 'readonly' => true)); ?></div>
                                        <div>-</div>
                                        <div class="consume"><?php echo $obj->inputText('routeTo',array( 'allowedStatusForEdit' => array (1), 'readonly' => true)); ?></div>
                                    </div>
                                </div>   
                            </div>  
                        </div>
