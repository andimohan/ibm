...
if (!empty($_GET['id'])){ 
   ...
   // $rsTariff = $truckingSellingRate->searchData($truckingSellingRate->tableName.'.pkey',$rsServiceOrder[0]['contractkey']);
    ...
    $_POST['netWeight'] = $obj->formatNumber($rs[0]['netweight'],2); 
	$_POST['cargoQtyUnit'] = $rs[0]['cargoqtyunit'];  
	$_POST['cargoWeightUnit'] = $rs[0]['cargoweightunit'];  
    $_POST['netWeightUnit'] = $rs[0]['netweightunit'];  
                                 ...
                                 <label class="col-xs-3 control-label"><?php echo $obj->lang['quantity'];?></label> 
                                	<div class="col-xs-9"> 
										<div class="flex">
											...
											<div style="margin-left: 2em; margin-right:0.2em">GW</div>
                                            ...
                                            <div style="margin-left: 2em; margin-right:0.2em">NW</div>
											<div  style="width: 6em"> <?php echo $obj->inputNumber('netWeight',array('etc' => 'mnv-attr-decimal="2" style="text-align:right"')); ?>  </div>
											<div  class="consume"> <?php echo $obj->inputSelect('netWeightUnit',$arrWeight); ?>  </div>
										</div> 
                                </div> 
                            </div> 
                             <div class="form-group">
