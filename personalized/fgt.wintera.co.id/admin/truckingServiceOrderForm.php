...
if (!empty($_GET['id'])){ 
    ...
    $_POST['goodsDescription'] = $rs[0]['goodsdescription'];

    $_POST['shipperName'] = $rs[0]['shippername'];    
                    ...
                    <div class="div-table-col"> 
      						 <div class="div-tab-panel"> 
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['importirExportir']) ?></label> 
                                        <div class="col-xs-9"> 
                                             <?php echo $obj->inputText('shipperName', array('readonly' => $isCustomerInvoiced)); ?>
                                        </div> 
                                    </div> 
                     ...
                     <div class="div-table-col">   
                        ...
                        <div class="div-tab-panel">      
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">                                                
                                ...
                                <div class="col-xs-9" >     <?php echo $obj->inputText('vesselNumber', array('readonly' => $isCustomerInvoiced)); ?>
                                   <!-- <div class="flex">
                                        <div class="consume">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9"> 
                                    <?php echo  $obj->inputTextArea('goodsDescription', array('etc' => 'style="height:10em;"')); ?>
                                </div> 
                            </div> 
                        </div>   
