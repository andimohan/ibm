<?php
class Texture extends BaseClass
{
    ...
    function validateForm($arr, $pkey = '')
    {
        ...
        if (empty($platingName)) {
            $this->addErrorList($arrayToJs, false, $this->errorMsg['texture'][1]);
        } else if (count($rs) <> 0) {
            $this->addErrorList($arrayToJs, false, $this->errorMsg['texture'][2]);
        }
