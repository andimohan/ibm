<?php
class ItemVariation extends BaseClass
{
    ...
    function __construct()
    {
        ...
        $this->tableName = 'item_variation';
        $this->tableStatus = 'master_status';

        $this->securityObject = 'ItemVariation';
    ...
    function validateForm($arr, $pkey = '')
    {
        ...
        if (empty($ringSizeName)) {
            $this->addErrorList($arrayToJs, false, $this->errorMsg['itemVariation'][1]);
        } else if (count($rs) <> 0) {
            $this->addErrorList($arrayToJs, false, $this->errorMsg['itemVariation'][2]);
        }
