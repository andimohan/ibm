<?php
class CorporateValues extends BaseClass
{
    ...
    function __construct($meetingType = '1')
    {
        ...
        parent::__construct();
        $this->tableName = 'corporate_values';
		$this->tableStatus = 'master_status';
	    $this->tableLangValue = 'corporate_values_lang';
         
		$this->uploadFolder = 'corporate-values/'; 
		$this->newLoad = true;
		
        $this->securityObject = 'CorporateValues';
        ...
        $this->arrData['detail'] = array('txtDetail');
