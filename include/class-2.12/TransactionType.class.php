...
class TransactionType extends BaseClass
{
    ...
    function __construct()
    {
        ...
        $this->tableName = 'transaction_type';
        $this->tableStatus = 'master_status';

        $this->securityObject = 'TransactionType';
		...
		$this->importUrl = 'import/continent';
    ...
    function validateForm($arr, $pkey = '')
    {
        ...
        // } else if (count($rs) <> 0) {
        //     $this->addErrorList($arrayToJs, false, $this->errorMsg['continent'][2]);
        // }
