<?php
class CommodityType extends BaseClass
{
    function __construct()
    {
        ...
        $this->tableName = 'commodity_type';
        $this->tableStatus = 'master_status';

        $this->newLoad = true;
        $this->securityObject = 'CommodityType';
        ...
        $this->arrData['ishscode'] = array('hscode');
        $this->arrData['ismsds'] = array('msds');
        ...
        $defaultFieldName = '   typekey';
        array_push($this->arrLockedTable, array('table' => 'commodity', 'field' => $defaultFieldName));
    ...
    function validateForm($arr, $pkey = '')
    {
        ...
        $rs = $this->isValueExisted($pkey, 'name', $customername);
