...
class ItemInDepot extends BaseClass{ 
 
   function __construct(){
		
		parent::__construct();
       
		$this->tableName = 'item_in_depot_header';
		$this->tableNameDetail = 'item_in_depot_detail';
        ...
        $this->fileType = array();
        $this->fileType[1] = array('title' => $this->lang['doDocuments'], 'uploadFileFolder' => 'item-in-depot-do/','mandatory' => true);
        $this->fileType[2] = array('title' => $this->lang['otherDocuments'], 'uploadFileFolder' => 'item-in-depot-others/' );
        ...
        array_push($this->printMenu,array('code' => 'printTransaction', 'name' => $this->lang['printTransaction'],  'icon' => 'print', 'url' => 'print/itemInDepot'));    
   ...
   function getQuery(){
	   ...
	   $sql = '
            ...
            '.$this->tableDepot.','.$this->tableCustomer.'
