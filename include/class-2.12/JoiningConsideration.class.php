...
class JoiningConsideration extends BaseClass{
	
    function __construct(){

    parent::__construct();

    $this->tableName = 'joining_consideration';
    $this->tableStatus = 'master_status';
    $this->tableLangValue = 'joining_consideration_lang';
    $this->securityObject = 'JoiningConsideration';
