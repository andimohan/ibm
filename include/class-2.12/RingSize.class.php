<?php
class RingSize extends BaseClass
{
    ...
    function __construct()
    {
        ...
        $this->tableName = 'ring_size';
        $this->tableStatus = 'master_status';

        $this->securityObject = 'RingSize';
    ...
    function validateForm($arr, $pkey = '')
    {
        ...
        if (empty($ringSizeName)) {
            $this->addErrorList($arrayToJs, false, $this->errorMsg['ringSize'][1]);
        } else if (count($rs) <> 0) {
            $this->addErrorList($arrayToJs, false, $this->errorMsg['ringSize'][2]);
        }
