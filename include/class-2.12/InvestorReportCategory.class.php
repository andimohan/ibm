...
class InvestorReportCategory extends Category{ 
 
   function __construct(){
		
		parent::__construct();
       
		$this->tableName = 'investor_report_category';  
		$this->securityObject = 'InvestorReportCategory';  
	    $this->tableLangValue = 'investor_report_category_lang';
