function SalesOrderInvoiceReceipt(tabID){   
        var thisObj = this;
        var tabObj = $("#" + tabID);      
        ...
        this.rebindEl = function rebindEl(){   
             ...
             bindAutoCompleteForTransactionDetail('invoiceCode[]',objAndValueForDetailAutoComplete,'ajax-trucking-service-order-invoice.php?action=searchData&statuskey=2&customerkey=' + customerkey,handling); 
