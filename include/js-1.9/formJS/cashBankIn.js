function CashBankIn(tabID, varConstant, opt){   
        var thisObj = this;
        var tabObj = $("#" + tabID);    
...
//            thisObj.onChangeCurrency();
        ...
        this.loadOnReady = function loadOnReady(){   
			...
			tabObj.find("[name=chkUnknownSource]").change(function(){ 
				var unknownSource  = $(this).val();
				
				if(unknownSource == 1) $(".known-source").hide();
				else $(".known-source").show();
			
			})   
			tabObj.find("[name=chkUnknownSource]").change();
