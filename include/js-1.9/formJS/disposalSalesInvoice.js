function DisposalSalesInvoice(tabID, cashTOP, varConstant) {
    var thisObj = this;
    var tabObj = $("#" + tabID);
    ...
    objAndValue.push({ object: 'detailOrderSubtotal[]',  value: 'grandtotal'  });
//    objAndValue.push({ object: 'amount[]',  value: 'grandtotal'  });  // harusnya dr recount
    objAndValue.push({ object: "servicePrice[]",  value:'outstanding' }); 
...
//    }
    ...
    this.rebindEl = function rebindEl() {
        ...
        bindAutoCompleteForTransactionDetail('salesOrderCode[]', objAndValueForDetailAutoComplete, 'ajax-disposal-job-order.php?action=searchDataForInvoice&statustype=' + statustype + '&customerkey=' + customerkey, handling);
        ...
        bindAutoCompleteForTransactionDetail('itemName[]', objAndValueForDetailItemAutoComplete, 'ajax-item.php?action=searchData&itemtype=3');
