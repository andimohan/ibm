function APEmployeePayment(tabID, rs){   
    var thisObj = this;
    var tabObj = $("#" + tabID);      
    ...
    this.rebindEl = function rebindEl(){ 
        ...
        bindAutoCompleteForTransactionDetail('apCode[]',  objAndValueForDetailAutoComplete,'ajax-ap-employee.php?action=searchData&employeekey=' + tabObj.find("[name=hidEmployeeKey]").val(),thisObj.updateDetail); 
