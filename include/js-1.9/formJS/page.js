function Page(tabID, uploadFolder, rsImage){   
    var thisObj = this;
    var tabObj = $("#" + tabID);      
    ...
    this.rebindEl = function rebindEl(){   
        bindAutoCompleteForTransactionDetail('categoryName[]',  objAndValueForDetailAutoComplete,'ajax-page-category.php?action=searchData'); 
    }
