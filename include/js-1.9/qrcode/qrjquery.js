...
function QRReader(opt){  
    var 
        thisObj = this,
        play = (opt && opt.play) ? opt.play : $(".qr-code-play"), //$(".qr-code-play"),
        responseTarget = '', //$(".qr-code-play"),
        barcodeReaderPanel = (opt && opt.barcodeReaderPanel) ? opt.barcodeReaderPanel : $(".barcode-reader"),
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            if (typeof qrReaderResponse === "function") { 
                qrReaderResponse(thisObj,res); 
            }else{
                thisObj.responseTarget.val(res.code);
                
                barcodeReaderPanel.hide();
                hideOverlayScreen();
                decoder.stop();
            }
        },
    ...
    play.on("click", function() {
      ...
      if (typeof qrPlayButtonHandler === "function"){ 
            qrPlayButtonHandler(thisObj, $(this)); 
      }else{
    ...
    */
    ...
    this.playDecoder = function playDecoder(){  decoder.play(); }
    this.stopDecoder = function stopDecoder(){  decoder.stop(); } 
    this.showBarcodeReader = function showBarcodeReader(){  barcodeReaderPanel.show(); } 
    this.hideBarcodeReader = function hideBarcodeReader(){  barcodeReaderPanel.hide(); } 
}
