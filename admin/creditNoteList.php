...
function generateQuickView($obj,$id){ 
    ...
    $decimalPrice =  ($rs[0]['currencykey'] <> CURRENCY['idr']) ? 2 : 0;
        ...
        $detailInformation  = ' <div class="data-card border-green">
                                    ...
                                    <div class="div-table  quick-view-table">
                                            <div class="div-table-row">  
                                                ...
                                                '</div>
                                                 <div class="div-table-col detail-col-header" style="text-align:right;  width: 100px">'
                                                    .ucwords($obj->lang['creditNote']).
                                                '</div>
                                            </div>
                                   ';
		for ($i=0;$i<count($rsDetail);$i++){ 
            $itemname = $rsDetail[$i]['arcode'];
            $trdate =  $obj->formatDBDate($rsDetail[$i]['ardate']);
            $refcode = $rsDetail[$i]['refcode'];
		     ...
		     $detailInformation  .= '   <div class="div-table-row">  
                                                ...
                                                <div class="div-table-col" style="text-align:right;">'.$obj->formatnumber($rsDetail[$i]['artotal'],$decimalPrice).'</div>
                                                <div class="div-table-col" style="text-align:right;">'.$obj->formatnumber($rsDetail[$i]['totalcredit'],$decimalPrice).'</div>
                                            </div>';
