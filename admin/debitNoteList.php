        ...
        $detailInformation  = ' <div class="data-card border-green">
                                    ...
                                    <div class="div-table  quick-view-table">
                                            <div class="div-table-row">  
                                                ...
                                                '</div>
                                                 <div class="div-table-col detail-col-header" style="text-align:right;  width: 100px">'
                                                    .ucwords($obj->lang['debitNote']).
                                                '</div>
                                            </div>
                                   ';
		for ($i=0;$i<count($rsDetail);$i++){ 
            $itemname = $rsDetail[$i]['apcode'];
            $trdate =  $obj->formatDBDate($rsDetail[$i]['apdate']);
//            $refcode = $rsDetail[$i]['refcode'];
		     ...
		     $detailInformation  .= '   <div class="div-table-row">  
                                                ...
                                                <div class="div-table-col" style="text-align:right;">'.$obj->formatnumber($rsDetail[$i]['aptotal'],$decimalPrice).'</div>
                                                <div class="div-table-col" style="text-align:right;">'.$obj->formatnumber($rsDetail[$i]['totaldebit'],$decimalPrice).'</div>
                                            </div>';
