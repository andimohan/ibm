...
$formAction = 'emklJobOrderWarehouseList';
...
$_POST['selTypeOfJob'] = EMKL['jobType']['warehouse'];
$_POST['chkIsMaster'] = 1;
                                ...
                                <div class="col-xs-9">
                                    <div class="flex">
                                        ...
                                        <div class="consume">
                                            ...
                                            echo $obj->inputAutoComplete(
                                                array(
                                                    'objRefer' => $emklJobOrderWarehouse,
                                                    'readonly' => true,
                                                    'revalidateField' => false,
                                                    'element' => array(
                                                        'value' => 'jobOrderCode',
                                                    ...
                                                    'source' => array(
                                                        ...
                                                        'data' => array('action' => 'searchDataMaster', 'jobtype' => EMKL['jobType']['warehouse'])
                                                    ),
                                                    'callbackFunction' => 'getTabObj().updateFromJobOrder(' . EMKL['jobType']['warehouse'] . ')'
                                                )
                                            );
                                            ?>
                                        </div>
...
-->
                                                        ...
                                                        <div class="div-table-col detail-col-detail active-currency text-muted"  style="vertical-align:top; padding-top:13px">
                                                        ...
                                                        <?php } ?>
                                                        <div
                                                            class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col" style="vertical-align:top;padding-top:8px !important">
