...
$addDataFile = 'purchaseOrderJewelryForm';
	...
	$detailInformation = ' <div class="data-card border-green">
            ...
            <div class="div-table quick-view-table" >
                  <div class="div-table-row"> 
                        ...
                        <div class="div-table-col detail-col-header" style="width:70px; text-align:right;">' . ucwords($obj->lang['qty']) . ' Gr</div>
                        <div class="div-table-col detail-col-header" style="width:100px; text-align:right;">' . ucwords($obj->lang['receivedQty']) . '</div>
                        <div class="div-table-col detail-col-header" style="width:100px; text-align:right;">' . ucwords($obj->lang['receivedQty']) . ' Gr</div>
                        <div class="div-table-col detail-col-header" style="width:100px; text-align:right;">' . ucwords($obj->lang['price']) . ' Unit</div> 
