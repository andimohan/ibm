...
$addDataFile = 'itemOutDeliveryForm';
 
$arrSearchColumn = array ();
array_push($arrSearchColumn, array('Kode', $obj->tableName . '.code'));
array_push($arrSearchColumn, array('Tanggal', $obj->tableName . '.trdate'));
array_push($arrSearchColumn, array('Kode Barang Keluar', $obj->tableItemOutHeader. '.code'));
...
function generateQuickView($obj,$id){ 
	...
	$basicInformation  = ' <div class="data-card border-orange">
						...
						<div class="div-table general-information-table">
							...
							<div class="div-table-row">
								<div class="div-table-col">'.ucwords($obj->lang['itemOutCode']).'</div> 
								<div class="div-table-col">'.$rs[0]['itemoutcode'].'</div> 
							</div>
							<div class="div-table-row">
