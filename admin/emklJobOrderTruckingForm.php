...
$formAction = 'emklJobOrderTruckingList';
...
$_POST['selTypeOfJob'] = EMKL['jobType']['trucking'];
$_POST['chkIsMaster'] = 1;
                                            ...
                                            echo $obj->inputAutoComplete(
                                                array(
                                                    ...
                                                    'source' => array(
                                                        ...
                                                        'data' => array('action' => 'searchDataMaster', 'jobtype' => EMKL['jobType']['trucking'])
                                                    ),
                                                    'callbackFunction' => 'getTabObj().updateFromJobOrder(' . EMKL['jobType']['trucking'] . ')'
                                                )
                                            );
                                            ?>
                                        </div>
...
-->
                                                        ...
                                                        <?php if ($updateTaxAtJobOrder == 1) { ?>
                                                            <div class="div-table-col detail-col-detail" style="vertical-align:top;width:70px;text-align:right;">
                                                            ...
                                                            <div class="div-table-col detail-col-detail" style="vertical-align:top;width:30px;text-align:center;  padding-top:10px">
                                                        ...
                                                        <?php if($updateTaxAtJobOrder == 1) { ?> 
                                                                <div class="div-table-col detail-col-detail" style="vertical-align:top;text-align:center;   padding-top:10px">
