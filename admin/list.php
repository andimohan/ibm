...
<!--
<div style=" font-size:2em; position:fixed; top: 0em; right: 1em">
<input type="button" value="restore" name="restore" >  
...
<div class="div-table" style="width:100%; min-width:1200px; height:100vh; table-layout:fixed">
    <div class="div-table-row">
        ...
        <div class="flex justify-content-center show-left-menu-icon"><i class="fas fa-chevron-right"></i></div>
            <!-- left menu --> 
                <div id="profile" >
                	<div  class="div-table" style="margin:0.5em; width: 95%; position:relative">
                       <div class="div-table-row"> 
                            <div class="div-table-col" style="width: 4.5em">
                ...
                <div style="clear:both;"></div>
                <!--<i class="warning-icon fas fa-exclamation-circle"></i>-->
                <div id="tabs-menu" class="user-select-none">
                    <ul class="menu-status-notif-panel">
                        <li class="menu-item"><a href="#left-menu-panel"><i class="fa-regular fa-list"></i></a></li>
                        <li class="status-item"><a href="#left-status-panel"><i class="fa-regular fa-tv"></i></a></li> 
                        <!--<li class="snapshot-item"><a href="#left-snapshot-panel"><i class="fa-light fa-file-medical"></i></a></li> -->
                        <li class="notification-item"><a href="#left-notification-panel"><i class="fa-light fa-bell-exclamation"></i></a></li> 
                    </ul> 
                    <div id="left-menu-panel" class="menu-navigation-tab" style="padding:0 !important">
                       <ul id="main-menu" class="list"><?php include 'menu.php'; ?> </ul>
                    </div>  
