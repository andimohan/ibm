...
includeClass(array('Country.class.php','MeetingPoint.class.php'));
...
<head>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            var meetingPoint = new MeetingPoint(tabID);

            prepareHandler(meetingPoint);
