...
$formAction = 'joiningConsiderationList';
...
<title></title> 
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() { 
            ...
            var joiningConsideration = new JoiningConsideration(tabID);

            prepareHandler(joiningConsideration);
                ...
                <div class="div-table-row">
                    <div class="div-table-col"  style="width:49%; text-align:center">
                        <div class="div-tab-panel"> 
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['joiningConsideration']); ?></label>
                                <div class="col-xs-9">
