...
$obj= $vendorWarrantyClaimReturn;
$securityObject = $obj->securityObject; // the value of security object is manually inserted to handle 
										// some modules that have different security object from that of their class

if(!$security->isAdminLogin($securityObject,10,true)); 

$formAction = 'vendorWarrantyClaimReturnList';
...
if (!empty($_GET['id'])){ 
    ...
    $editBUSWarehouseInactiveCriteria = ' or '.$warehouse->tableName.'.pkey = ' . $obj->oDbCon->paramString($rs[0]['towarehousekey']);   
    $editCurrencyInactiveCriteria = ' or '.$currency->tableName.'.pkey = ' . $obj->oDbCon->paramString($rs[0]['currencykey']);

}

$arrStatus = $obj->convertForCombobox($obj->getAllStatus(),'pkey','status');    
$arrWarehouse = $class->convertForCombobox($warehouse->searchData('','',true,' and (isvendor = 1 and '.$warehouse->tableName.'.statuskey = 1' .$editWarehouseInactiveCriteria.')'),'pkey','name'); 
...
<style> 
    ...
    .tag-list-replacement  {list-style: none; margin: 0.5em 0; padding: 0}
    .tag-list-replacement li {float:left; background-color: #c7c8ca; color: #333; padding: 0.2em 0.5em; margin-right: 0.5em; margin-bottom: 0.3em; display: inline-block; border-radius: 0.2em;height: 2em; text-align: center; }
 
    .transaction-detail>.div-table-row:nth-child(2n+3) .tag-list li {background-color: #dedede !important}
    .options-row .form-panel {margin: 0; padding: 0}
    .options-row .form-panel-result {max-height: 10em; overflow: auto; padding: 0}
...
<script type="text/javascript">  
 jQuery(document).ready(function(){  
         ...
         var vendorWarrantyClaimReturn = new VendorWarrantyClaimReturn(tabID);
        
         prepareHandler(vendorWarrantyClaimReturn);   
...
<div style="width:100%; margin:auto; " class="tab-panel-form">   
  ...
  <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>"> 
                      ...
                      <div class="div-tab-panel"> 
                       <div class="div-table-caption border-orange"><?php echo ucwords($obj->lang['generalInformation']); ?></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9"> 
                                <?php echo $obj->inputSelect('selToWarehouseKey', $arrBUSWarehouse,array('allowedStatusForEdit' => array(1) )); ?>  
                            </div> 
                        </div>
                       <div class="form-group">
                            ...
                            <div class="col-xs-9"> 
                                <?php    
                                                echo $obj->inputAutoComplete(array(
                                                                                ...
                                                                                'callbackFunction' => 'getTabObj().updateClaimInformation()'  
                       ...
                       <div class="form-group">
                            <label class="col-xs-3 control-label">CN / DN</label> 
                               <div class="col-xs-9"> 
                                <?php echo $obj->inputText('cnRef'); ?>  
                            </div> 
                        </div> 
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="col-xs-9"><?php echo $obj->inputButton('btnImport',$obj->lang['import'],array( 'class' => 'btn btn-primary semi-fixed btn-second-tone')); ?></div>
                        </div>
        ...
        <div class="div-table transaction-detail" style="width:100%;"> 
             <div class="div-table-row">     
                 <div class="div-table-col detail-col-header" style="width:150px;text-align:left;"><?php echo ucwords($obj->lang['itemName']); ?> RMA</div>
                 <div class="div-table-col detail-col-header"><?php echo ucwords($obj->lang['replacementItem']); ?></div>
                 <?php if ($showVendorPartNumber) { ?> 
                    <div class="div-table-col detail-col-header" style="width:140px;"><?php echo ucwords($obj->lang['vendorPartNumber']); ?></div>
                <?php } ?>
				...
				<?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $arrSNReplacement = array_column($rsSN, 'serialnumberreplacement');
                               
                            if (!empty($rsSN)){ 
                                $txtSN = "<ul  class=\"tag-list\">"; 
                                $txtSNReplacement = "<ul  class=\"tag-list-replacement\">"; 
                                for($j=0;$j<count($rsSN);$j++){ 
                                    $txtSN .= '<li>'.$rsSN[$j]['serialnumber'].'</li>';
                                
                                    if(!empty($rsSN[$j]['serialnumberreplacement']))
                                        $txtSNReplacement .= '<li>'.$rsSN[$j]['serialnumberreplacement'].'</li>';
                                }
                            ...
                            $_POST['hidOldItemKey[]'] =  $rsDetail[$i]['olditemkey']; 
                            $_POST['selUnit[]'] =  $rsDetail[$i]['unitkey']; 
                            $_POST['oldItemName[]'] =  $rsDetail[$i]['itemname']; 
                            ...
                            $_POST['qtyOutstanding[]'] =   $obj->formatNumber($rsDetail[$i]['qtyoutstanding']); 
                            ...
                            $_POST['snReplacementList[]'] =  implode(chr(13),$arrSNReplacement);
                            ...
                            $_POST['hidClaimDetailKey[]'] =  $rsDetail[$i]['claimdetailkey'];
                                             
                            $arrUnit = $obj->convertForCombobox($item->getAvailableUnit($rsDetail[$i]['olditemkey']),'conversionunitkey','unitname'); 
                            ...
                            <div class="div-table" style="width:100%">
                                <div class="div-table-row">
                                    <div class="div-table-col" style="padding:0">
                                        <div class="div-table" style="width: 100%">
                                         <div class="div-table-row">   
                                            <div class="div-table-col detail-col-detail" style="vertical-align:top; width:150px;"><?php echo $obj->inputText('oldItemName[]',array('overwritePost' => $overwrite, 'readonly' => $readonly, 'etc' => $etc)); ?><?php echo $obj->inputHidden('hidOldItemKey[]',array('overwritePost' => $overwrite, 'etc' => $etc)); ?><?php echo $obj->inputHidden('hidOldNeedSN[]',array('overwritePost' => $overwrite, 'etc' => $etc)); ?><?php echo $obj->inputHidden('hidClaimDetailKey[]',array('overwritePost' => $overwrite, 'etc' => $etc)); ?></div> 
                                            ...
                                            <?php if ($showVendorPartNumber) { ?> 
                                                 <div class="div-table-col detail-col-detail" style="vertical-align:top; width:140px;"><?php echo $obj->inputText('vendorPartNumber[]', array('overwritePost' => $overwrite, 'etc' => $etc)); ?><?php echo $obj->inputHidden('hidVendorPartNumberKey[]',array('overwritePost' => $overwrite, 'etc' => $etc)); ?><?php echo $obj->inputHidden('hidTempItemKey[]',array('overwritePost' => $overwrite, 'etc' => $etc)); ?></div>
                                            <?php } ?>
                                             <div class="div-table-col detail-col-detail" style="vertical-align:top; width:50px; "><?php echo $obj->inputNumber('qty[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;" ' .$etc, 'readonly' => $readonly)); ?></div>
                             ...
                             <div class="options-row" style="<?php if (!$showOptions) { echo 'display:none;'; } ?>">
                                ...
                                <div class="div-table" style="width: 100%">
                                    <div class="div-table-row">
                                        <div class="div-table-col" style="width: 50%">
                                            <div style="font-weight:bold"><?php echo $obj->lang['serialNumber']; ?> RMA</div>
                                            <div class="panel form-panel-result form-panel-result-rma" <?php if(!empty($txtSN)) echo 'style="display:block"'; ?> >
                                                <?php echo $txtSN; ?>
                                                <div style="clear:both"></div>
                                            </div>
                                        </div> 
                                        <div class="div-table-col">
                                             <div style="font-weight:bold"><?php echo $obj->lang['serialNumberReplacement']; ?> RMA</div>
                                             <div class="panel form-panel-result form-panel-result-replacement" <?php if(!empty($txtSNReplacement)) echo 'style="display:block"'; ?> >
                                                <?php echo $txtSNReplacement; ?>
                                                <div style="clear:both"></div>
                                            </div>
                                        </div> 
                                    </div>    
                                ...
                                <div class="panel form-panel" style="display:none; width: 100%">
                                        <div class="div-table" style=" width:100%; ">
                                            <div class="div-table-row">
                                                <div class="div-table-col" style="vertical-align:top; width: 50%;"> 
                                                    <?php echo  $obj->inputTextArea('snList[]', array('overwritePost' => $overwrite, 'etc' => 'attr-label="mnv-opt-sn"  style="height:10em;"')); ?>  
                                                </div>
                                                <div class="div-table-col" style="vertical-align:top; width: 50%;"> 
                                                    <?php echo  $obj->inputTextArea('snReplacementList[]', array('overwritePost' => $overwrite, 'etc' => 'attr-label="mnv-opt-sn"  style="height:10em;"')); ?>
                                                </div>
                                            </div>
                                        </div>
                                </div>
