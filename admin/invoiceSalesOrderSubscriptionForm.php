...
$formAction = 'invoiceSalesOrderSubscriptionList';
...
//                            $_POST['descriptionMonthly[]'] =  $rsMonthly[$j]['description']; 
                            $_POST['hidItemMonthlyKey[]'] =  $rsMonthly[$j]['itemkey']; 
                            $_POST['itemMonthlyName[]'] =  $rsMonthly[$j]['itemname']; 
                            //$_POST['hidGramasiMonthly[]'] =   $obj->formatNumber($rsMonthly[$i]['gramasi']); 
                            //$_POST['hidGramasiMonthlySubtotal[]'] =   $obj->formatNumber($rsMonthly[$i]['gramasi'] * $rsMonthly[$i]['qtyinbaseunit']); 
