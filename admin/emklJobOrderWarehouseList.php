...
$addDataFile = 'emklJobOrderWarehouseForm';
...
array_push($arrSearchColumn, array('Pelanggan', 'customer_invoice.name'));
array_push($arrSearchColumn, array('Pelanggan', $obj->tableName . '.customercache'));
...
array_push($arrSearchColumn, array('Container', $obj->tableName . '.containernumber'));
array_push($arrSearchColumn, array('Container Type', $obj->tableContainerType . '.name'));
array_push($arrSearchColumn, array('Carrier', 'carrier.name'));
array_push($arrSearchColumn, array(ucwords($obj->lang['createdBy']), 'created.name'));
