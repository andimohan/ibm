...
includeClass(array('AP.class.php','APEmployeeCommission.class.php'));
			...
			switch ( $_GET['action']){  
                case 'searchData' :    
                    ...
                    if (isset($_GET) && !empty($_GET['employeekey']))
                        array_push ($arrCriteria, $obj->tableName.'.employeekey ='. $obj->oDbCon->paramString($_GET['employeekey']) );  
