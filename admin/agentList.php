...
array_push($arrColumn,array(ucwords($obj->lang['phone']),'phone',150 ));
array_push($arrColumn,array(ucwords($obj->lang['mobilePhone']),'mobile',150 ));
array_push($arrColumn,array(ucwords($obj->lang['email']),'email',150 ));
