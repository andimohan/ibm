...
$addDataFile = 'vendorWarrantyClaimForm';
 
$arrSearchColumn = array ();
array_push($arrSearchColumn, array('Kode', $obj->tableName . '.code'));
array_push($arrSearchColumn, array('Tanggal', $obj->tableName . '.trdate'));
array_push($arrSearchColumn, array('Tanggal', $obj->tableName . '.refcode')); 
array_push($arrSearchColumn, array('Penerima', $obj->tableName . '.recipientname') ); 
array_push($arrSearchColumn, array('Penerima', $obj->tableSupplier . '.name') ); 
