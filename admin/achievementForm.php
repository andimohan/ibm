...
$achievement = createObjAndAddToCol( new Achievement());  
...
<script type="text/javascript"> 
 jQuery(document).ready(function(){  
        ...
        var achievement = new Achievement(tabID,"<?php echo $obj->uploadFolder; ?>",<?php echo json_encode($rsItemImage); ?>);
    
        prepareHandler(achievement);   
