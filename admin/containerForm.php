...
includeClass(array('Container.class.php'));
...
$formAction = 'containerList'; 
    
$isQuickAdd = ( isset($_GET) && !empty($_GET['quickadd'])) ? true : false;
 
$rs = prepareOnLoadData($obj); 
if (!empty($_GET['id'])){  
    $_POST['volume'] = $obj->formatNumber($rs[0]['volume']);
    $_POST['teus'] = $obj->formatNumber($rs[0]['teus'],2);    
} 

$arrType = $class->convertForCombobox($obj->getContainerType(),'pkey','name'); 
...
<script type="text/javascript"> 
	...
	jQuery(document).ready(function(){   
         ...
         var container = new Container(tabID);
    
         prepareHandler(container);   
                    ...
                    <div class="div-table-col">  
                  		   	<div class="div-tab-panel">     
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                               <?php echo  $obj->inputSelect('selContainerTypeKey', $arrType); ?>
                                        </div> 
                                    </div> 
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['volume']); ?></label> 
                                        <div class="col-xs-9"> 
                                              <?php echo  $obj->inputNumber('volume'); ?> 
                                        </div> 
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords('Teus'); ?></label> 
                                        <div class="col-xs-9"> 
                                              <?php echo  $obj->inputDecimal('teus'); ?> 
                                        </div> 
                                    </div>
                                    <div class="form-group">
