...
$companyPPNType = $obj->loadSetting('companyPPNType');
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        var varConstant = {  
				...
				companyPPNType : <?php echo json_encode($companyPPNType); ?>,
            ...
            <div class="div-table-row">
                <div class="div-table-col"> 
					    ...
					    <div class="div-tab-panel"> 
						 ...
						 <div class="form-group <?php echo $obj->hideOnDisabled(); ?>" style="margin-bottom:1em; margin-left: .5em"> 
							<div class="col-xs-12"> 
                                <div class="flex">
