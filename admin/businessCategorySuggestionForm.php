...
$formAction = 'businessCategorySuggestionList';
...
<head>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            var businessCategorySuggestion = new BusinessCategorySuggestion(tabID);
            prepareHandler(businessCategorySuggestion);
                    ...
                    <div class="div-table-col">
                        <div class="div-tab-panel"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <?php echo $obj->inputText('category'); ?>
