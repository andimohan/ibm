...
includeClass(array('CareerField.class.php'));
...
<script type="text/javascript"> 
	...
	jQuery(document).ready(function(){  
        ...
        var careerField = new CareerField(tabID,"<?php echo $obj->uploadFolder; ?>",<?php echo json_encode($rsItemImage); ?>);
    
        prepareHandler(careerField);   
         ...
         var fieldValidation =  {
                                    ...
                                    name: { 
                                        validators: {
                                            notEmpty: {
                                                message: phpErrorMsg.careerField[1]
                                            }, 
                                        }
                                    },
                                } ; 
