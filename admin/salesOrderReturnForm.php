...
includeClass(array('SalesOrderReturn.class.php'));
$salesOrderReturn = createObjAndAddToCol(new SalesOrderReturn());
...
$formAction = 'salesOrderReturnList';
...
<head>
   ...
   <script type="text/javascript">
      ...
      jQuery(document).ready(function () {
         ...
         salesOrderReturn = new SalesOrderReturn(tabID, <?php echo json_encode($rs); ?>, cashTOP);
         prepareHandler(salesOrderReturn);
...
<body>
   <div style="width:100%; margin:auto; " class="tab-panel-form">
      ...
      <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>">
            ...
            <div class="div-table-row">
               <div class="div-table-col">
                  <div class="div-tab-panel">
                     ...
                     <div class="form-group">
                        <label class="col-xs-3 control-label">
                           <?php echo ucwords($obj->lang['soCode']); ?>
                        </label>
                        <div class="col-xs-9">
                           <?php echo $obj->inputAutoComplete(
                              array( 
                                 ...
                                 'source' => array(
                                    ...
                                    'data' => array('action' => 'searchData', 'statuskey' => '2,3', 'limit' => '25')
                                 ),
                     ...
                     <div class="form-group">
                        <label class="col-xs-3 control-label">
                           <?php echo ucwords($obj->lang['jobOrderDate'] ); ?>
                        </label>
                        <div class="col-xs-9">
                           <?php echo $obj->inputDate('trSODate', array('readonly' => true)); ?>
                        </div>
                     </div>
                     <div class="form-group">
                        <label class="col-xs-3 control-label">
         ...
         <div class="div-table mnv-transaction transaction-detail sales-delivery-detail"
            ...
            <div class="div-table-row">
               ...
               <div class="div-table-col detail-col-header" style="width:100px; text-align:right;">
                  <?php echo ucwords($obj->lang['orderedQty']); ?>
               </div>
               <div class="div-table-col detail-col-header" style="width:100px; text-align:right;">
                  <?php echo ucwords($obj->lang['outstanding']); ?>
               </div>
               <div class="div-table-col detail-col-header" style="width:100px; text-align:right;">
                  <?php echo ucwords($obj->lang['returnQty']); ?>
               </div>
            ...
            for ($i = 0; $i <= $totalRows; $i++) {
               ...
               if ($i == $totalRows) {
                  ...
                  $_POST['returnQtyInBaseUnit[]'] = $obj->formatNumber($rsSalesDetail[$i]['returnqtyinbaseunit']);
               }
               ...
               <div class="div-table-row <?php echo $class; ?>">
                  <div class="div-table-col detail-col-detail">
                     <?php echo $obj->inputText('itemName[]', array('overwritePost' => $overwrite, 'readonly' => true, 'etc' => $etc)); ?>
                     <?php echo $obj->inputHidden('hidItemKey[]', array('overwritePost' => $overwrite, 'etc' => $etc)); ?>
                     <?php echo $obj->inputHidden('hidSODetailKey[]', array('overwritePost' => $overwrite, 'etc' => $etc)); ?>
                     <?php echo $obj->inputHidden('hidDetailKey[]', array('overwritePost' => $overwrite, 'etc' => $etc)); ?>
                  </div>
                  <div class="div-table-col detail-col-detail">
                     <?php echo $obj->inputNumber('orderedQtyInBaseUnit[]', array('overwritePost' => $overwrite, 'readonly' => true, 'etc' => 'style="text-align:right;"' . $etc)); ?>
                  </div>
                  <div class="div-table-col detail-col-detail">
                     <?php echo $obj->inputNumber('qtyMinusInBaseUnit[]', array('overwritePost' => $overwrite, 'readonly' => true, 'etc' => 'style="text-align:right;"' . $etc)); ?>
                  </div>
                  <div class="div-table-col detail-col-detail">
                     <?php echo $obj->inputNumber('returnQtyInBaseUnit[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' . $etc)); ?>
                  </div>
                  <div class="div-table-col detail-col-detail">
                     <div class="text-muted"><span class="baseitemunit"><?php echo (!empty($unitname)) ? $unitname : 'Pcs'; ?></span></div>
                  </div>
                  ...
                  <div class="div-table  transaction-detail" style="width: 100%">
                     ...
                     <div class="div-table-row form-group ">
                        ...
                        <div class="div-table-col-3">
                           <div class="text-link-01 mnv-total-group-hide-detail" style="float:right; text-align:right;">
                              <?php echo ucwords($obj->lang['hideDetail']); ?>
                           </div>
                        </div>
