...
if (!empty($_GET['id'])) {
    ...
    if (!empty($rs[0]['refkey'])) {
        ...
        $_POST['submissionNumber'] = $rsRef[0]['submissionnumber'];
    }
                ...
                <div class="div-table-row">
                    <div class="div-table-col">
                        <div class="div-tab-panel">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-xs-3 control-label"><?php echo ucwords($obj->lang['destinationZone']); ?></label>
                                <div class="col-xs-9">
                                    <?php echo $obj->inputAutoComplete(
                                        array(
                                ...
                                <div class="col-xs-9">
                                    <?php echo $obj->inputAutoComplete(
                                        array(
                                            ...
                                            'callbackFunction' => 'getTabObj().importData(3)'
                                        )
                                    );
                                    ?>
                                </div>
