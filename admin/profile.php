...
$_POST['action'] = 'edit'; 
$_POST['selLang'] = THEME_SETTINGS['lang'];
...
$arrLang = $lang->generateComboboxOpt(array(  'value' => 'code','queryValue' => 'code'),array('criteria' =>' and ('.$lang->tableName.'.statuskey = 1)'));
                        ...
                        <div class="div-tab-panel"> 
                                  <div class="div-table-caption border-green"><?php echo ucwords($obj->lang['personalInformation']); ?></div> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                            <?php echo $obj->inputSelect('selLang',$arrLang); ?>
                                        </div> 
                                    </div>   
                       </div>
                    </div> 
