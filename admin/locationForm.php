...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){  
        var tabID = <?php echo ($isQuickAdd) ?  $_GET['tabID'] :  'selectedTab.newPanel[0].id'; ?>;
            var location = new Location(tabID);

            prepareHandler(location);
              ...
              <div class="div-table-row">
                    <div class="div-table-col">  
                  		   	<div class="div-tab-panel">    
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['latitude'] . ' / '. $obj->lang['longitude']); ?></label> 
                                        <div class="col-xs-9"> 
                                            <div class="flex">
                                                <div class="consume"><?php echo $obj->inputText('latitude'); ?>  </div>
                                                <div>/</div>
                                                <div  class="consume"><?php echo $obj->inputText('longitude'); ?>  </div>
                                            </div>
