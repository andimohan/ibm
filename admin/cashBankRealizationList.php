...
$addDataFile = 'cashBankRealizationForm';
$quickView = true;

$arrSearchColumn = array ();
array_push($arrSearchColumn, array('Kode',$obj->tableName . '.code'));
array_push($arrSearchColumn, array('Nama',$obj->tableEmployee . '.name')); 
array_push($arrSearchColumn, array('SPK',$obj->tableName . '.refcode')); 
array_push($arrSearchColumn, array('SPK',$obj->tableName . '.refcode2')); 
array_push($arrSearchColumn, array('SPK',$obj->tableName . '.refcode3')); 
array_push($arrSearchColumn, array('S/I',$obj->tableTruckingServiceOrder . '.donumber'));  
array_push($arrSearchColumn, array('No. booking',$obj->tableTruckingServiceOrder . '.shipmentnumber')); 
...
function generateQuickView($obj,$id){  
	...
	$basicInformation  = ' <div class="data-card border-orange">
                                ...
                                <div class="div-table  general-information-table">
                                    ...
                                    <div class="div-table-row">
                                        <div class="div-table-col">'.ucwords($obj->lang['realization']).'</div> 
                                        <div class="div-table-col">'.$obj->formatNumber($rs[0]['totalrealization']).'</div> 
                                    </div>
                                    <div class="div-table-row">
                                        <div class="div-table-col">'.ucwords($obj->lang['totalDifference']).'</div> 
                                        <div class="div-table-col">'.$obj->formatNumber($rs[0]['total'] - $rs[0]['totalrealization']).'</div> 
                                    </div>
                                    <div class="div-table-row">
...
//		
		$detailInformation  = ' <div class="data-card border-green">
                                    ...
                                    <div class="div-table  quick-view-table">
                                             <div class="div-table-row">
                                                ...
                                                <div class="div-table-col detail-col-header" style="text-align:right;  width: 80px">'.ucwords($obj->lang['realization']).'</div>
		...
		for ($i=0;$i<count($rsDetail);$i++){
			$detailInformation  .= '
				<div class="div-table-row">
					<div class="div-table-col" style="text-align:right; ">'.$rsDetail[$i]['qty'].'</div> 
					<div class="div-table-col" >'.$rsDetail[$i]['costname'].'</div> 
					...
					<div class="div-table-col" style="text-align:right">'.$obj->formatnumber($rsDetail[$i]['realcostvalue']).'</div> 
