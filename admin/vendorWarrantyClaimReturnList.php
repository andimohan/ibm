...
$addDataFile = 'vendorWarrantyClaimReturnForm';
...
array_push($arrSearchColumn, array(ucwords($obj->lang['RMANumber']), $obj->tableClaim . '.refcode') ); 
array_push($arrSearchColumn, array('CN / DN', $obj->tableName . '.cnref') );  
...
function generateQuickView($obj,$id){ 
    ...
    $currencyName = (!empty($rsCurrency)) ? ' ('.$rsCurrency[0]['name'].')' : '';
	...
	$detailInformation  = ' <div class="data-card no-border">
					...
					<div class="div-table quick-view-table" >
						  <div class="div-table-row"> 
                                '.$vendorPartNumber.' 
                                <div class="div-table-col detail-col-header" style="width:180px;">'.ucwords($obj->lang['itemCode']).'</div>
								...
								<div class="div-table-col detail-col-header" style="width:70px; text-align:right;">'.ucwords($obj->lang['value']).''.$currencyName.'</div>  
