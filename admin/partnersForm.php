...
$partnersCategory =  createObjAndAddToCol(new PartnersCategory()); 
$obj= $partners;
...
if (!empty($_GET['id'])){ 
	...
	$editCategoryInactiveCriteria = ' or '.$partnersCategory->tableName.'.pkey = ' . $obj->oDbCon->paramString($rs[0]['categorykey']);
    
} 

$arrCategory = $partnersCategory->generateComboboxOpt(null,array('criteria' =>' and ('.$partnersCategory->tableName.'.statuskey = 1 '. $editCategoryInactiveCriteria.')'));
