...
$truckingServiceOrderInvoice = createObjAndAddToCol( new TruckingServiceOrderInvoice()); // kekapke di AMT, dr bagi hasil trucking
...
$addDataFile = 'apPaymentForm';

$arrSearchColumn = array ();
array_push($arrSearchColumn, array('Kode', $obj->tableName . '.code'));

// jgn pake forwarding, karena di  getQuerynya suda dipisah, gk ad trucking job order
// nanti dipisah saja field search nya
...
function generateQuickView($obj,$id){ 
	...
	$basicInformation  = ' <div class="data-card border-orange">
		...
		$detailInformation  = ' <div class="data-card border-green">
            ...
            switch (PLAN_TYPE['categorykey']){
                case COMPANY_TYPE['trucking'] :    $detailInformation .= '<div class="div-table-col detail-col-header"  style="width:120px;">'. ucwords($obj->lang['WOCode']).'</div> 
                                                   ...
                                                   <div class="div-table-col detail-col-header"  style="width:120px;">'. ucwords($obj->lang['invoiceReference']).'</div>';
                            break;
                case COMPANY_TYPE['forwarding'] :    $detailInformation .= '<div class="div-table-col detail-col-header"  style="width:120px;">'. ucwords($obj->lang['reference']).'</div> 
                                                   <div class="div-table-col detail-col-header"  style="width:120px;">'. ucwords($obj->lang['invoiceReference']).'</div>';
                            break;
                default :
		...
		for ($i=0;$i<count($rsDetail);$i++){
            ...
            if( in_array(PLAN_TYPE['categorykey'], array(COMPANY_TYPE['trucking']))  )
                $detailInformation .= ' <div class="div-table-col">'.$rsAp[0]['refinvoicecode'].'</div>';
