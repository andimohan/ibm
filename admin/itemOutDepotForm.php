...
<script type="text/javascript">   
	...
	jQuery(document).ready(function(){  
         ...
         itemOutDepot = new ItemOutDepot(tabID);
		...
		// DETAIL CLONE
		 $("#" + tabID + " [name=btnAddRows]").on('click', function() { 
			...
			bindAutoCompleteForTransactionDetail('itemName[]',objAndValueForDetailAutoComplete[tabID],'ajax-item.php?action=searchData&itemtype=4','itemOutDepot.updateDetail');
          });
            ...
            <div class="div-table-row">
                <div class="div-table-col"> 
                    <div class="div-tab-panel"> 
                        ...
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['deliveryNotes']); ?></label> 
                            <div class="col-xs-9"> 
