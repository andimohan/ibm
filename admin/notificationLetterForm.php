...
includeClass(array('NotificationLetter.class.php','Customer.class.php','Warehouse.class.php'));
...
$formAction = 'notificationLetterList';
...
<script type="text/javascript"> 
    ...
    jQuery(document).ready(function(){  
        ...
        var notificationLetter = new NotificationLetter(tabID);

        prepareHandler(notificationLetter);
    ...
    <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>">
        ...
        <div class="div-table main-tab-table-2">
            <div class="div-table-row">
                ...
                <div class="div-table-col"> 
                    <div class="div-tab-panel"> 
                        <div class="div-table-caption border-blue"><?php echo ucwords($obj->lang['notificationLetter']); ?></div>
                        <div class="form-group"> 
                                <div class="col-xs-12"> 
                                    <?php echo $obj->inputEditor('txtDetail', array('etc' => 'style="height:10em;"')); ?>
                            </div>
                        </div>
                    </div>
                </div>
