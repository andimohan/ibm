...
$formAction = 'supplierDownpaymentSettlementList';
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        var tablekey = <?php echo $obj->getTableKeyAndObj($obj->tableName ,array('key'))['key']; ?>;   
         ...
         var supplierDownpaymentSettlement = new SupplierDownpaymentSettlement(tabID,tablekey, <?php echo json_encode($rs); ?>,varConstant);
    
         prepareHandler(supplierDownpaymentSettlement);
				...
				<?php
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
						    ...
						    $rsDownpayment = $supplierDownpayment->getDataRowById($rsDPSettlementDetail[$i]['downpaymentkey']);  
...
-->
                    ...
                    <div class="mnv-total-group mnv-coa" style="margin-top:1em;  <?php echo $displayCoa; ?>">  
                        <div class="div-table" style="width: 100%">
                            <div class="div-table-row  form-group"> 
                                    <div class="div-table-col-3" style="text-align:right;"> 
                                           <?php echo $obj->lang['total'] . ' ' . $obj->lang['cost']; ?>
                                    </div>  
                                    <div class="div-table-col-3" style="width:180px;"> 
