...
includeClass('APCustomerCommissionPayment.class.php');
$apPayment = createObjAndAddToCol( new APCustomerCommissionPayment()); 
...
$addDataFile = 'apCustomerCommissionPaymentForm';
