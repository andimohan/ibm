...
includeClass(array('SalesOrderPropertyType.class.php'));
...
$formAction = 'salesOrderPropertyTypeList';
...
if (!empty($_GET['id'])){ 
	...
	$_POST['percentageValue'] = $obj->formatNumber($rs[0]['percentagevalue'],2);  
}
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        salesOrderPropertyType = new SalesOrderPropertyType(tabID);
        prepareHandler(salesOrderPropertyType); 
      						 ...
      						 <div class="div-tab-panel">  
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                            <?php echo $obj->inputDecimal('percentageValue'); ?> 
                                        </div> 
                                    </div>  
                             </div>  
                    </div> 
