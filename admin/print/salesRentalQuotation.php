...
<tr><td colspan="3"  style="width: 670px;"><br><strong>'.$rs[0]['name'].'</strong></td></tr>  
</table> 
 ';
...
<tr class="header-row-header" ><td style="border:solid 1px black; width:40px;text-align:center;">No</td><td style="border:solid 1px black; width:170px;text-align:center;">Deskripsi</td><td style=" border:solid 1px black; width:60px;text-align:right" >Jumlah</td><td style="width:60px; border:solid 1px black;" >Satuan</td><td style="width:60px;text-align:right;border:solid 1px black;" >Jumlah </td><td style="width:60px;text-align:left;border:solid 1px black;" >Waktu </td><td style="width:120px;text-align:center;border:solid 1px black;" >Tarif Sewa/hari</td><td style="text-align:right;border:solid 1px black; width:110px;">Subtotal</td></tr>
...
$html .= ' 
<tr>
<td style="border:solid 1px black;text-align:right; font-weight:bold;"></td>
<td colspan="6" style="border:solid 1px black;text-align:center; font-weight:bold; ">TOTAL</td>
<td style="border:solid 1px black;text-align:right; font-weight:bold;">'.$obj->formatNumber($rs[0]['grandtotal']).'</td>
</tr>
';  
$html .= '</table>' ;
...
for ($j=0;$j<count($rsDetail);$j++){   
    ...
    $html .= '<tr>
                <td style="text-align:center;border:solid 1px black;">'.($j+1).'</td><td style="border:solid 1px black;">'.$rsDetail[$j]['itemname'].'</td><td style="border:solid 1px black;text-align:right"></td><td style="border:solid 1px black;text-align:right">'.$obj->formatNumber($rsItem[0]['lostprice']).'</td><td style="border:solid 1px black;text-align:right"></td></tr>' ; 
}
