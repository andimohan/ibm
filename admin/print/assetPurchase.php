...
$html .= ' 
<table cellpadding="2" > 
<tr><td><div class="title">ORDER PEMBELIAN ASET</div></td></tr>
...
<tr class="col-header" ><td style="width:350px;">Item</td><td style="width:100px;" >Kategori</td><td style="width:120px;text-align:right" >Harga @</td><td style="text-align:right; width:110px;">Subtotal</td></tr>';
...
if ($rsDetail[$i]['discounttype'] == 2)
  ...
  $html .= '<tr><td>'.$rsDetail[$i]['name'].'</td><td>'. $rsDetail[$i]['categoryname'] .'</td><td style="text-align:right">'.$obj->formatNumber($rsDetail[$i]['priceinunit']).'</td><td style="text-align:right">'.$obj->formatNumber($rsDetail[$i]['subtotal']).'</td></tr>' ;
}
$html .= '</table>' ;
