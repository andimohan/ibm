...
$obj = new EMKLCommission();  
$emklJobOrderExport = new EMKLJobOrder();  
...
$html .= ' 
<table cellpadding="2" > 
<tr><td><div class="title">'.$obj->lang['purchaseRefund'].'</div></td></tr>
...
<table cellpadding="2">
<tr><td class="header-row-header">'.$obj->lang['jobOrder'].'</td><td style="width:10px; text-align:center">:</td><td style="width:170px">'.$rsEmkl[0]['code'].'</td></tr>
...
<table cellpadding="2">
<tr><td class="header-row-header">'.$obj->lang['typeOfJob'].'</td><td style="width:10px; text-align:center">:</td><td style="width:230px">'.$rsEmkl[0]['jobtypeunion'].'</td></tr>
<tr><td class="header-row-header">MBL</td><td style="text-align:center">:</td><td >'.$rsEmkl[0]['mblnumber'].'</td></tr> 
...
for($i=0;$i<count($rsDetail);$i++){ 
    ...
    $html .= '<tr>
				...
				<td>'.$rsDetail[$i]['currencyname'].'</td>
				<td style ="text-align:right">'.$obj->formatNumber($rsDetail[$i]['priceinunit'],$decimalNumber).'</td>   
				<td style ="text-align:right">'.$obj->formatNumber($rsDetail[$i]['subtotal'],$decimalNumber).'</td>
			  </tr>';

    //<td style ="text-align:right">'.$obj->formatNumber($rsDetail[$i]['subtotalcurrency'],$decimalNumber).'</td>
...
if ( !empty($arrSubtotal)){
    array_push($arrSubtotal, '<tr><td style="text-align:right; font-weight:bold;">Total</td><td style="text-align:right; font-weight:bold;"  >'.$obj->formatNumber($rs[0]['grandtotal'],$decimalNumber).'</td></tr>');
}    
...
$payment .= '<td style="text-align:right; width: 80px;">'.$obj->formatNumber($rsPaymentMethodDetail[$j]['amount'],$decimalNumber).'</td>';
$payment .= '</tr>'; 
}
...
<td style="text-align:right; font-weight:bold;  width:110px;">'.$obj->formatNumber($rs[0]['grandtotal'],$decimalNumber).'</td>
</tr>
';  
