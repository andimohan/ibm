...
$obj = new EMKLPurchaseOrder(EMKL['jobType']['trucking']);  
$emklJobOrderTrucking = new EMKLJobOrder(EMKL['jobType']['trucking']);  
$emklJobOrderHeaderTrucking = new EMKLJobOrderHeader(EMKL['jobType']['trucking']);
...
$html .= ' 
<table cellpadding="2" > 
<tr><td><div class="title">Purchase Order Trucking</div></td></tr>
