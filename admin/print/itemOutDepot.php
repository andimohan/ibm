...
$html .= ' 
<table cellpadding="2" > 
<tr><td><div class="title">'.$obj->lang['itemOut'].' '.$obj->lang['depot'].'</div></td></tr>
...
<tr><td class="header-row-header">'.$obj->lang['deliveryNotes'].'</td><td style="width:10px; text-align:center">:</td><td>'. $rs[0]['docode'] .'</td></tr>
</table>
</td>
