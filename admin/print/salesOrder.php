...
$discountVoucher = $obj->getVoucherDetail($rs[0]['pkey']);
...
if (!empty($discountVoucher) && $discountVoucher[0]['vouchercategorykey'] == 2){
    $discountItem = $discountVoucher[0]['amount'];
    array_push($arrSubtotal, '<tr>
    <td style="text-align:right; font-weight:bold;">Diskon Voucher</td>
    <td style="text-align:right; font-weight:bold;"  >-'.$obj->formatNumber($discountItem).'</td>
    </tr>');
}
...
if (!empty($discountVoucher) &&  $discountVoucher[0]['vouchercategorykey'] == 3){
    $discountShipment = $discountVoucher[0]['amount'];

    array_push($arrSubtotal, '<tr>
    <td style="text-align:right; font-weight:bold;">Diskon Ongkos Kirim</td>
    <td style="text-align:right; font-weight:bold;"  >-'.$obj->formatNumber($discountShipment).'</td>
    </tr>');
}  
