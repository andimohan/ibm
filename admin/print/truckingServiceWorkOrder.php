...
if($rs[0]['isoutsource']){
	...
	$carRegistrationNumber = $rs[0]['outsourcecarregistrationnumber'];
}else{
    $driverName = $rs[0]['drivername'];
	$carRegistrationNumber = $rs[0]['policenumber'];
} 
...
<table cellpadding="2" > 
<tr><td><br><div class="title">SURAT PERINTAH KERJA</div></td></tr>
<tr><td><div class="subtitle">'.$rs[0]['code'].'</div></td></tr>
</table> 
</td>
<td style="width: 80px; text-align:center;">
<img src="'.$qrResult['url'].'" /><br>
'.$rs[0]['verificationcode'].' 
</td>
</tr>
</table>
...
<tr><td class="header-row-header" style="width:140px">Booking Pelayaran</td><td style="text-align:center">:</td><td>'. $rs[0]['shipmentnumber'] .'</td></tr>  
<tr><td class="header-row-header" style="width:140px">Jenis Pekerjaan</td><td style="text-align:center">:</td><td>'. $jobInformation .'</td></tr>  
...
<tr><td>'. $carRegistrationNumber .'</td><td>'. $rs[0]['chassisnumber'] .'</td><td>'. $driverName.'</td></tr>  
</table> 
</td>
<td>
<table cellpadding="2" >
...
array_push($cellArray, array('label' => $obj->lang['sealNumber'], 'width' => '140')); 
...
$html .= '  
<tr><td style="text-align:right;">1.</td><td>'.$rsService[0]['name'].'</td><td>'.$container.'</td><td>'.$seal.'</td><td>'.$productDesc.'</td></tr>   
</table>  
'.$trnotes.' 
<div style="clear:both"></div>  
';
...
foreach($rsCashOut as $cashOutRow){
    ...
    <tr><td class="header-row-header">Jenis Pekerjaan</td><td style="width:10px; text-align:center">:</td><td>'. $jobInformation .'</td></tr>   
    <tr><td class="header-row-header">Sopir</td><td style="width:10px; text-align:center">:</td><td>'. $recipientName.'</td></tr>   
    </table> 
    </td>
