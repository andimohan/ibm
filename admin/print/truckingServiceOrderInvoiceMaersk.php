...
$generateReportContent = function ($dataset) {
    ...
    if(!empty($rsCustomer[0]['taxregistrationname'] )) $rsCustomer[0]['name']  = $rsCustomer[0]['taxregistrationname'];
    if(!empty($rsCustomer[0]['taxregistrationaddress'] )) $rsCustomer[0]['address']  = $rsCustomer[0]['taxregistrationaddress'];
    ...
    <tr>
        <td style="width:480px";><table cellpadding="3">
                ...
                <tr>
                    <td class="border-left-top-right-bottom font-bold" style="width:480px;' . $fontSize . '">' . ucwords($sayNumber) . ' Rupiah</td>
                </tr>
            </table>
        ...
        <td style="width:200px";>
            <table cellpadding="3">
                <tr>
                    <td style="width:190px;' . $fontSize . '" class="align-center font-bold" >Bekasi, ' . $obj->toLocalDate($obj->formatDBDate($rs[0]['trdate'], 'd F Y')) . '</td>
                </tr>
                <tr><td></td></tr>
                <tr><td></td></tr>
                <tr><td></td></tr>
