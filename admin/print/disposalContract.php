...
function contractsContent1 ($dataset){ 
...
if ($rsService[0]['duration'] == 12) {
    $periodic = '/ Tahun';
    $frequency = $qtyService. ' kali layanan per periode perjanjian ('.$qtyService.' kali dalam setahun)';
} else {
    $periodic = '/ Bulan';
    $totalqty = $qtyService * 12;
    $frequency = $qtyService. ' kali layanan dalam sebulan atau '.$totalqty.' kali layanan per perioder perjanjian ';
}
$facilities = array();
...
$disposalPrice = $rsWasteDetail[0]['weightprice']; 
$maximuWeight = $obj->formatNumber($rsWasteDetail[0]['maxweight'], 2). ' kg'; 
if ($maximuWeight == 0) {
...
<tr><td style=";" >BAHAN BERBAHAYA DAN BERACUN (B3) MEDIS - (A 337-1)</td></tr>
...
<tr>
<td >Pada hari ini, '.$contractDay.', tanggal '.$contractDate.' bulan '.$contractMonth.' tahun '.$contratctYear.', bertempat di '.$rs[0]['cityname'].'-, dibuat dan ditandatangani <b>Perjanjian Kerjasama Pengangkutan Limbah Bahan Berbahaya dan Beracun (B3) Medis</b> oleh dan antara :</td>
</tr>
</table>
';   
...
<tr>
<td style="border:1px solid black;width:160px;text-align:center;font-weight:bold">Pasal 3<br><b>FASILITAS LAYANAN</b></td>
<td style="border:1px solid black;text-align: justify;">Untuk fasilitas layanan yang disediakan oleh PIHAK KEDUA berupa suplai wadah penampung dengan jenis :<br>'.str_replace(chr(13),'<br>',$facilities).'</td>
</tr>
<tr>
<td style="border:1px solid black;width:160px;text-align:center;font-weight:bold">Pasal 4<br><b>LOKASI LAYANAN</b></td>
<td style="border:1px solid black;text-align: justify;">
<table cellpadding="">
<tr><td style="width:20px;font-size:10px"><b> 1. </b></td><td style="width:480px;text-align: justify;">Untuk lokasi layanan / tempat pengambilan limbah B3 medis terletak di '.$rsCustomer[0]['address'].'</td></tr>
...
<tr>
<td style="border:1px solid black;width:160px;text-align:center;font-weight:bold">Pasal 5<br><b>FREKUENSI DAN KUOTA LAYANAN</b></td>
<td style="border:1px solid black;">
<table cellpadding="">
<tr><td  style="width:20px;"><b> - </b></td><td style="width:480px;text-align: justify;">Untuk frekuensi layanan disepakati bersama '. $frequency .'. </td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;">Maksimal kuota dalam pelayanan adalah maksimal '.$maximuWeight.' per-pelayanan.</td></tr>
</table>
</td>
</tr> 
<tr>
<td style="border:1px solid black;width:160px;text-align:center;font-weight:bold">Pasal 6<br>BIAYA-BIAYA DAN CARA PEMBAYARAN</td>
<td style="border:1px solid black;width:520px">
<table cellpadding="">
<tr><td  style="width:20px;"><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Biaya jasa pengangkutan disepakati sebesar Rp. '.$obj->formatNumber($servicePrice).' per-periode perjanjian.</td></tr>
...
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Apabila ada permintaan Layanan tambahan dari Pihak Pertama maka akan dikenakan biaya tambahan sebesar Rp. '.$obj->formatNumber($additionalPrice).' ('.$obj->sayNumber($additionalPrice).' rupiah) per kedatangan.</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Biaya kelebihan atas kuota berat maksimal per pelayanan Rp.'.$obj->formatNumber($disposalPrice).',- ('.$obj->sayNumber($disposalPrice).' rupiah) per kg per pelayanan</td></tr>
...
<tr>
<td style="border:1px solid black;width:160px;text-align:center;font-weight:bold">Pasal 7<br>KEWAJIBAN PIHAK PERTAMA</td>
<td style="border:1px solid black;width:520px">
<table cellpadding="">
<tr><td  style="width:20px;"><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Pertama membayar Biaya Jasa Pengangkutan kepada Pihak Kedua dimuka pada saat tanggal awal perjanjian dan pembayaran dilakukan tepat waktu.</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Pertama menyediakan 1 (satu) tempat penyimpanan sementara ("TPS") Limbah B3 Medis yang dapat dilalui oleh armada pengangkut milik Pihak Kedua.</td></tr>
...
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Pertama melakukan semua tindakan pencegahan dan keamanan berkaitan dengan penanganan, pemilahan, dan penyimpanan/pengumpulan Limbah B3 Medis sebelum dan hingga waktu pengangkutan oleh Pihak Kedua.</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Pertama menjamin bahwa Limbah B3 Medis harus terpilah dengan baik dan tersimpan dalam wadah / kantong berkode warna dan semua benda tajam tarsimpan terpisah dan dimasukkan ke dalam wadah untuk benda tajam (safety box atau sharp container) sesuai prinsip dasar pengemasan limbah B3 medis (p.56/menlhk-setjen/2015).</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Pertama harus memisahkan Limbah B3 Medis dengan bahan-bahan limbah lainnya yang tidak sesuai dengan spesifikasi pemilahan dan kategori Limbah B3 Medis dalam kondisi siap angkut.</td></tr>
...
<tr>
<td style="border:1px solid black;width:160px;text-align:center;font-weight:bold">Pasal 8<br>KEWAJIBAN PIHAK KEDUA</td>
<td style="border:1px solid black;width:520px">
<table cellpadding="">
<tr><td style="width:20px;"><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Kedua melaksanakan setiap pekerjaan sesuai dengan syarat dan ketentuan dalam Perjanjian ini.</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Kedua menentukan jadwal pengangkutan Limbah B3 Medis sesuai dengan frekuensi layanan.</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Kedua melakukan pengambilan Limbah B3 Medis hanya di TPS yang disediakan oleh Pihak Pertama.</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Sesuai dengan prosedur Keselamatan dan Kesehatan Kerja, Pihak Kedua tidak akan pernah membuka kemasan Limbah B3 Medis yang diserahterimakan dari Pihak Pertama.</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Kedua menimbang Limbah B3 Medis dengan menggunakan timbangan Pihak Kedua dengan didampingi oleh Pihak Pertama, kemudian Dokumen Limbah B3 Medis ditandatangani oleh wakil-wakil Para Pihak.</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Kedua melakukan pengangkutan dari TPS ke tempat Pengolahan Limbah B3 Medis.</td></tr>
<tr><td ><b> - </b></td><td style="width:480px;text-align: justify;font-size:11px">Pihak Kedua menyerahkan dokumen Limbah B3 medis dari pengolah limbah B3 kepada Pihak Pertama.</td></tr>
</table>
</td>
</tr>  
</table> 
...
function contractsContent2 ($dataset){ 
$obj = new DisposalContract(); 
$customer = new Customer(); 
$employee = new Employee(); 
$setting = new Setting(); 
...
<tr>
<td style="border:1px solid black;width:160px;text-align:center;font-weight:bold">Pasal 9 <br>KETENTUAN LAIN</td>
<td style="border:1px solid black;width:520px">
Syarat dan Ketentuan yang terdapat dalam Lampiran 1, merupakan bagian yang tidak terpisahkan dari Perjanjian Kerjasama Pengangkutan Limbah Bahan Berbahaya dan Beracun (B3) Medis ini.
</td>
</tr>
<tr>
<td style="border:1px solid black;width:160px;text-align:center;font-weight:bold">Pasal 10 <br>PEMBERITAHUAN / KORESPONDENSI</td>
<td style="border:1px solid black;width:520px">
...
<tr>
<td>e.</td>
<td ><b>"Limbah B3 Medis"</b> adalah Limbah B3 infeksius yang berasal dari kegiatan operational sarana medis sebagaimana tercantum pada Izin Rekomendasi, Izin Pengumpulan, dan/atau Izin Pengolahan Limbah B3 milik Pihak Kedua maupun Mitra Pihak Kedua.</td>
</tr>
<tr>
<td>f.</td>
...
function terms2($dataset){
     
$rs = $dataset['rs'];
    
$obj = new DisposalContract();
    
$imghow1 = '<img src="'.$obj->templateImgPath.'how1.png" style="height:120px">';
$imghow2 = '<img src="'.$obj->templateImgPath.'how2.png" style="height:120px">';
$imghow3 = '<img src="'.$obj->templateImgPath.'how3.png" style="height:120px">';
$imghow4 = '<img src="'.$obj->templateImgPath.'how4.png" style="height:120px">';
$imghow5 = '<img src="'.$obj->templateImgPath.'how5.png" style="height:120px">';
    
$html = '<div style="font-weight:bold">LAMPIRAN 2 - PRINSIP DASAR PENGEMASAN LIMBAH B3 MEDIS (PERMEN.56/MENLHK-SETJEN/2015)</div>';
$html .='
<br>
<table>
<tr>
<td style="width:20px;">1.</td>
<td style="width:650px;">Limbah harus diletakkan dalam wadah atau kantong sesuai kategori Limbah.</td>
</tr>
<tr>
<td >2.</td>
<td >Volume paling tinggi Limbah yang dimasukkan ke dalam wadah atau kantong Limbah adalah 3/4 (tiga per empat) Limbah dari volume, sebelum ditutup secara aman dan dilakukan pengelolaan selanjutnya.</td>
</tr>
<tr>
<td >3.</td>
<td >Penanganan (handling) Limbah harus dilakukan dengan hati-hati untuk menghindari tertusuk benda tajam, apabila Limbah benda tajam tidak dibuang dalam wadah atau kantong Limbah sesuai kelompok Limbah.</td>
</tr>
<tr>
<td >4.</td>
<td >Pemadatan atau penekanan Limbah dalam wadah atau kantong Limbah dengan tangan atau kaki harus dihindari secara mutlak.</td>
</tr>
<tr>
<td >5.</td>
<td >Penanganan Limbah secara manual harus dihindari. Apabila hal tersebut harus dilakukan, bagian atas kantong Limbah harus tertutup dan penangannya sejauh mungkin dari tubuh.</td>
</tr>
<tr>
<td >6.</td>
<td >Penggunaan wadah atau kantong Limbah ganda harus dilakukan, apabila wadah atau kantong limbah bocor, robek atau tidak tertutup sempuma.</td>
</tr>
</table>

<div style="clear:both"></div> 
<div style="text-align:center; font-weight:bold">Tata cara penanganan dan pengikatan Limbah medis dalam plastik kuning yang benar</div> 
<div style="clear:both"></div> 

<table cellpadding="4">
<tr>
<td style="width:20px;border:1px solid black">1. </td>
<td style="width:140px;border:1px solid black;text-align:center;">'.$imghow1.'</td>
<td style="width:180px;border:1px solid black;text-align:justify">Hanya Limbah infeksius yang boleh dimasukkan ke dalam wadah ini - Limbah terkena darah atau cairan tubuh - Limbah benda tajam ditempatkan pada wadah Limbah benda tajam</td>
<td style="width:20px;border:1px solid black">4.</td>
<td style="width:140px;border:1px solid black;text-align:center;">'.$imghow4.'</td>
<td style="width:180px;border:1px solid black">Gunakan kepang plastik untuk membentuk ikatan tunggal. Dilarang mengikat dengan model "telinga kelinci".</td>
</tr>
<tr>
<td style="border:1px solid black">2. </td>
<td style="border:1px solid black;text-align:center;">'.$imghow2.'</td>
<td style="border:1px solid black;text-align:justify">Limbah harus ditempatkan dalam wadah sesuai dengan jenis dan karakteristik  Limbah. Tarik plastik secara perlahan sehingga udara dalam kantong berkurang. Jangan mendorong kantong ke bawah atau melobanginya</td>
<td style="border:1px solid black">5.</td>
<td style="border:1px solid black;text-align:center;">'.$imghow5.'</td>
<td style="border:1px solid black">Letakkan penutup wadah dan tempat pada tempat penyimpanan sementara (atau pada lokasi pengumpulan internal).</td>
</tr>
<tr>
<td style="border:1px solid black">3. </td>
<td  style="border:1px solid black;text-align:center;">'.$imghow3.'</td>
<td  style="border:1px solid black;text-align:justify">Putar ujung atas plastik untuk membentuk kepang tunggal.</td>
</tr>
</table>
';
...
function packaging ($dataset){
  
$obj = new DisposalContract();    
$rs = $dataset['rs'];
//
$imglimbahtajam = '<img src="'.$obj->templateImgPath.'limbahtajam.png" style="height:120px">';
$imgpengemasanlimbah = '<img src="'.$obj->templateImgPath.'pengemasanlimbah.png" style="height:350px">';
...
<tr>
<td>CONTOH PENGEMASAN YANG BAIK UNTUK LIMBAH MEDIS DAN MEDIS TAJAM</td>
</tr> 
</table>
...
<td style="width:20px;">1.</td>
<td style="width:650px;">Limbah medis harus dikemas dalam plastik kuning dengan diikat tunggal, aman, rapi, dan tidak ada bocor.</td>
<td style="width:40px;"></td>
</tr>
<tr>
<td style="width:40px;"></td>
<td style="width:20px;">2.</td>
<td style="width:650px;"><i>Safety box</i> harus kering, tidak rembes/bocor dan dapat ditutup rapat, apabila kondisi safety box sudah tidak baik maka harus dikemas ulang dangan plastik kuning.</td>
<td style="width:40px;"></td>
</tr>
...
<tr>
<td>CONTOH PENGEMASAN YANG TIDAK BAIK UNTUK LIMBAH MEDIS DAN MEDIS TAJAM</td>
</tr>
...
<td style="width:40px;"></td>
<td style="width:20px;">1.</td>
<td style="width:650px;">Kondisi kemasan plastik sudah sobek.</td>
<td style="width:40px;"></td>
</tr>
<tr>
<td style="width:40px;"></td>
<td style="width:20px;">2.</td>
<td style="width:650px;">Limbah medis dikemas dalam plastik selain wama kuning;</td>
<td style="width:40px;"></td>
</tr>
<tr>
<td style="width:40px;"></td>
<td style="width:20px;">3.</td>
<td style="width:650px;">Limbah medis tajam tidak dikemas dalam <i>safety box</i>.</td>
<td style="width:40px;"></td>
</tr>
<tr>
<td style="width:40px;"></td>
<td style="width:20px;">4.</td>
<td style="width:650px;"><i>Safety box</i> rusak, basah dan bocor.</td>
<td style="width:40px;"></td>
</tr>
</table>
...
function contractsGeneralContent1 ($dataset){ 
$obj = new DisposalContract(); 
$customer = new Customer(); 
$employee = new Employee(); 
$service = new Service(); 
...
function contractsGeneralContent2 ($dataset){ 
$obj = new DisposalContract(); 
$customer = new Customer(); 
$employee = new Employee(); 
$setting = new Setting(); 
...
function termsGeneral1 ($dataset){
...
function attachmentGeneral  ($dataset){
...
$generateReportContent = function ($dataset){
    ...
    if($rsWasteCategory[0]['ismedis'] == 1){  
        ...
        array_push($html,contractsContent1($dataset));
        array_push($html,contractsContent2($dataset)); 
        array_push($html,terms1($dataset)); 
        array_push($html,terms2($dataset)); 
        array_push($html,packaging($dataset));
        
    }else{
        
        array_push($html,contractsGeneralContent1($dataset));
        array_push($html,contractsGeneralContent2($dataset));
        array_push($html,termsGeneral1($dataset));
        array_push($html,attachmentGeneral($dataset));
    }
...
//array_push($generateReportContent , $terms2);
//array_push($generateReportContent , $packaging);
?>
