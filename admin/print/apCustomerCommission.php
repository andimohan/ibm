...
<tr><td style="font-weight:bold">'.$obj->lang['customer'].'</td><td style="text-align:center">:</td><td>'.$rsCustomer[0]['name'].'</td></tr>
<tr><td style="font-weight:bold">'.$obj->lang['amount'].'</td><td style="text-align:center">:</td><td>'.$obj->formatNumber($rsHeader[0]['amount']).'</td></tr>  
