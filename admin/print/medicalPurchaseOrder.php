...
$html .= ' 
<table cellpadding="2" > 
<tr><td><div class="title">ORDER PEMBELIAN MEDIS</div></td></tr>
    ...
    <tr>
        <td style="width:300px;" >
            <table cellpadding="2">
                ...
                <tr>
                    <td class="header-row-header">'.$obj->lang['JOCode'].'</td>
                    <td style="text-align:center">:</td>
                    <td>'.$rsMedicalJobOrder[0]['code'].'</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:center">:</td>
                    <td >'.$rsMedicalJobOrder[0]['categoryname'].'</td>
                </tr>
                <tr>
                    <td class="header-row-header">'.$obj->lang['company'].'</td>
                    <td style="text-align:center">:</td>
                    <td >'.$rsMedicalJobOrder[0]['customername'].'</td>
                </tr>
                <tr>
                    <td class="header-row-header">'.$obj->lang['insuranceCompany'].'</td>
                    <td style="text-align:center">:</td>
                    <td>'.$rsMedicalJobOrder[0]['insurancecompanyname'].'</td>
                </tr>
                <tr>
        ...
        <td style="width:360px;"> 
            <table cellpadding="2">
                <tr>
                    ...
                    <td style="width:10px; text-align:center">:</td>
                    <td style="width:180px">'.$rsMedicalJobOrder[0]['insuredname'].'</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:center">:</td>
                    <td>'.$rsMedicalJobOrder[0]['countryname'].'</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:center">:</td>
                    <td>'.$rsMedicalJobOrder[0]['insuredmobile'].'</td>
                </tr>
                <tr>
                    <td class="header-row-header"></td>
                    <td style="text-align:center"></td>
