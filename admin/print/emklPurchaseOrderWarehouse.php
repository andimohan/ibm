...
$obj = new EMKLPurchaseOrder(EMKL['jobType']['warehouse']);  
$emklJobOrderWarehouse = new EMKLJobOrder(EMKL['jobType']['warehouse']);  
$emklJobOrderHeaderWarehouse = new EMKLJobOrderHeader(EMKL['jobType']['warehouse']);
...
$html .= ' 
<table cellpadding="2" > 
<tr><td><div class="title">Purchase Order Warehouse</div></td></tr>
