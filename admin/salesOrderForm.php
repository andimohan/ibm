...
if (!empty($_GET['id'])){ 
	...
	$_POST['recipientTrDesc'] = $rs[0]['recipienttrdesc'];
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
		...
		var varConstant = {  
            ...
            SN_REGEX : <?php echo $obj->SN_SPLIT_REGEX; ?>
         };
...
<div style="width:100%; margin:auto; " class="tab-panel-form">   
                     ...
                     <div class="div-table-col">   
                        <div class="div-tab-panel"> 
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['note']); ?></label> 
                                <div class="col-xs-9"> 
                                    <?php echo  $obj->inputTextArea('recipientTrDesc', array('etc' => 'style="height:10em;"')); ?> 
                                </div> 
                            </div> 
                            <div class="form-group">
                     ...
                     <?php if($useStorage) {  ?>
                             <div id="file-update-ajax" class="div-tab-panel">
                                 <div class="div-table" style="width:100%"> 
                                    ...
                                    <?php echo $obj->inputUploadFilePlugin($rs,$rsFileDetail, array('allowedStatusForEdit' => array(1))); ?> 
                                 </div>
                            </div>     
                        <?php }else { ?> 
                        <div class="div-tab-panel"> 
  ...
  <div class="div-table transaction-detail" style="width:100%;"> 
            <div class="div-table-row"> 
                ...
                <?php if (USE_SN) { ?> <div class="div-table-col detail-col-header  icon-col <?php echo $obj->hideOnDisabled(); ?>" style="width:35px;"></div><?php } ?>
        ...
        <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; ">
				<?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $_POST['hidNeedSN[]'] = $rsSalesDetail[$i]['needsn'];
                ...
                <div class="div-table-row">
                    ...
                    <div class="div-table-col detail-col-detail">
                        ...
                        <?php echo $obj->inputText('trDetailDesc[]',array('overwritePost' => $overwrite, 'disabled' => $disabled, 'etc'=>'style="margin-top:0.5em" placeholder="'.$obj->lang['note'].'"')); ?>
                    ...
                    <div class="div-table-col detail-col-detail" style="width:80px; text-align:right;vertical-align:top"><?php echo $obj->inputNumber('qty[]', array('overwritePost' => $overwrite,'value' => 1, 'etc' => 'style="text-align:right;"', 'disabled' => $disabled)); ?></div>
                    <div class="div-table-col detail-col-detail" style="width:80px;vertical-align:top"><?php echo $obj->inputSelect('selUnit[]',$arrUnit, array('overwritePost' => $overwrite,  'disabled' => $disabled)); ?></div>
                    <div class="div-table-col detail-col-detail" style="width:100px; text-align:right;vertical-align:top"><?php echo $obj->inputNumber('priceInUnit[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' , 'disabled' => $disabled)); ?></div>
                    <div class="div-table-col detail-col-detail" style="width:100px; text-align:right; padding-right:0;vertical-align:top"><?php echo $obj->inputNumber('discountValueInUnit[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"', 'disabled' => $disabled)); ?></div>
                    <div class="div-table-col detail-col-detail" style="width:80px; text-align:right; padding-left:0.2em;vertical-align:top"><?php echo $obj->inputSelect('selDiscountType[]',$obj->arrDiscountType, array('overwritePost' => $overwrite,  'disabled' => $disabled)); ?></div>
                    <div class="div-table-col detail-col-detail" style="width:180px; text-align:right;vertical-align:top"><?php echo $obj->inputNumber('detailSubtotal[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;" ','readonly' =>true, 'disabled' => $disabled)); ?></div>
                    
                    </div>
                    </div>
                    </div> 
                        <?php if (USE_SN) { ?>
                            <div class="div-table-col detail-col-detail icon-col <?php echo $obj->hideOnDisabled(); ?>"  style="padding-top:6px !important;vertical-align:top;width:35px;"><?php echo $obj->inputLinkButton('btnMoreOptions' , 'SN', array('class' => 'btn btn-link btn-more-options btn-sn-options','disabled' => true )); ?></div>
                        <?php } ?>
                        <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?> icon-col" style="padding-top:6px !important;vertical-align:top;">
                            <?php echo $obj->inputLinkButton('btnDeleteRows', '<i class="fas fa-times"></i>', array('class' => 'btn btn-link remove-button', 'etc' => 'tabIndex="-1"')); ?>
                        </div>

                    </div>
                    </div>  
                        <?php if (USE_SN) { echo $obj->SNPlugin($rsSalesDetail[$i], $overwrite, $etc,$disabled); } ?> 
                    </div> 
                </div>
