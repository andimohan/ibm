...
$addDataFile = 'salesOrderRentalForm';
 
$arrSearchColumn = array ();
array_push($arrSearchColumn, array('Kode', $obj->tableName . '.code'));
array_push($arrSearchColumn, array('Kode Ref', $obj->tableQuotation . '.code'));
...
array_push($arrSearchColumn, array('Nama Penerima',$obj->tableName . '.recipientname'));
array_push($arrSearchColumn, array('Nama Penerima',$obj->tableName . '.recipientphone'));
array_push($arrSearchColumn, array('Nama Penerima',$obj->tableName . '.recipientemail'));
array_push($arrSearchColumn, array('Nama Penerima',$obj->tableName . '.recipientaddress'));
		...
		$detailInformation  = ' <div class="data-card border-green">
						...
						<div class="div-table  quick-view-table">
							  <div class="div-table-row">  
                                ...
                                <div class="div-table-col detail-col-header" style="width:60px; text-align:right;">'.ucwords($obj->lang['delivered']).'</div> 
                                ...
                                <div class="div-table-col detail-col-header" style="width:50px;">'.ucwords($obj->lang['time']).'</div> 
		...
		for ($i=0;$i<count($rsDetail);$i++){
			...
			$detailInformation  .= '
				<div class="div-table-row">  
					...
					<div class="div-table-col" style="text-align:right;">'.$obj->formatNumber($rsDetail[$i]['totaldays']).'</div>
                    <div class="div-table-col">'. $rsDetail[$i]['timename'] .'</div> 
