...
$formAction = 'medicalSalesInvoiceList';
...
<head>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            var medicalSalesInvoice = new MedicalSalesInvoice(tabID, cashTOP, varConstant);
            prepareHandler(medicalSalesInvoice);
                ...
                <div class="div-table mnv-transaction invoice-detail transaction-detail" style="width:100%; border-bottom:1px solid #333; " attr-level="0">
                    ...
                    for ($i = 0; $i <= $totalRows; $i++) {
                        ...
                        if ($i == $totalRows) {
                            ...
                            $_POST['insuredName[]'] =  $rsSalesOrderInvoiceDetail[$i]['insuredname'];
                            $_POST['codeLog[]'] = $rsSalesOrderInvoiceDetail[$i]['codelog'];
                            $_POST['test[]'] =  $rsSalesOrderInvoiceDetail[$i]['codelog'];
                            $_POST['hidCustomerInsurancePolicyKey[]'] =  $rsSalesOrderInvoiceDetail[$i]['customerinsurancepolicykey'];
                    ...
                    ?>
                        ...
                        <div class="div-table-row <?php echo $class; ?>">
                            <div class="div-table-col detail-col-detail" style="padding:0">
                                            ...
                                            <div class="type-1" style="<?php echo $showSO; ?>">
                                                <div class="flex">
                                                    <div>
                                                        ...
                                                        <?php echo $obj->inputHidden('hidSalesOrderKey[]', array('overwritePost' => $overwrite,  'disabled' => $disabled)); ?></div>
                                                    ...
                                                    <div class="consume"><?php echo $obj->inputHidden('hidCustomerInsurancePolicyKey[]', array('overwritePost' => $overwrite, 'disabled' => $disabled)); ?><?php echo $obj->inputText('insuredName[]', array('overwritePost' => $overwrite, 'readonly' => true,  'disabled' => $disabled, )); ?></div>
                                                </div>
                                            </div>
                                ...
                                <div class="div-table" style="width:100%">
                                    <div class="div-table-row"">
                                        <div class="div-table-col detail-col-detail" style="width: 44%;">
                                            <label class="col-xs-3 control-label" style="text-align:left;" ><?php echo ucwords($obj->lang['code'].' / '.$obj->lang['log']); ?></label>
                                            <div class="col-xs-9">
                                                <?php echo $obj->inputText('codeLog[]', array('overwritePost' => true, 'add-class' => 'label-style', 'disabled' => true, 'etc' => 'style="text-align:left;" ')); ?>
                                            </div>
                                        </div>
                                        <div class="div-table-col detail-col-detail" style="width: 56%;">
                                ...
                                <div class="options-row" style="<?php echo $optionRows ?>">
                                    ...
                                    <div class="div-table mnv-transaction transaction-detail" style="width: 100%;" attr-level="1" attr-group="hidDetailItemKey">
                                        <div class="div-table-row">
                                            ...
                                            <div class="div-table-col detail-col-detail col-header no-border" style="width:4em; text-align:right"><?php echo ucwords($obj->lang['qty']); ?></div>
                                            <div class="div-table-col detail-col-detail col-header no-border"><?php echo ucwords($obj->lang['services']); ?></div>
                                            <div class="div-table-col detail-col-detail col-header no-border" style="width:15em; text-align:left"><?php echo ucwords($obj->lang['description']); ?></div>
                                        ...
                                        for ($j = 0; $j <= $totalDetailRows; $j++) {
                                            ...
                                            if ($j == $totalDetailRows) {
                                                ...
                                                $_POST['trDescDetail[]'] =   $rsServiceDetail[$j]['trdesc'];
                                                ...
                                                $_POST['taxDetail[]'] = $obj->formatNumber($rsServiceDetail[$j]['taxdetail'], 0);
                                        ...
                                        ?>
                                            <div class="div-table-row <?php echo $classDetail; ?>">
                                                ...
                                                <div class="div-table-col-3">
                                                    <?php echo $obj->inputText('trDescDetail[]', array('readonly' => true, 'overwritePost' => $overwriteDetail, 'class' => 'form-control label-style',  'disabled' => $disabledDetail)); ?>
                                                </div>
                                                <div class="div-table-col-3">
                                                ...
                                                <?php if ($usePPNDetail) { ?>
                                                    <div class="div-table-col-3">
                                                        <?php echo $obj->inputInteger('taxDetail[]', array('overwritePost' => $overwriteDetail, 'add-class' => 'label-style', 'disabled' => $disabledDetail, 'etc' => 'style="text-align:right;" ')); ?>
