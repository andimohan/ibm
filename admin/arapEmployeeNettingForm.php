...
$formAction = 'arapEmployeeNettingList';
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        var tabID = <?php echo ($isQuickAdd) ?  $_GET['tabID'] :  'selectedTab.newPanel[0].id';  ?>  
         ...
         var arapEmployeeNetting = new ARAPEmployeeNetting(tabID, <?php echo json_encode($rs); ?>);
    
         prepareHandler(arapEmployeeNetting);
                    ...
                    <div class="arap-col div-table-col-5" style="vertical-align:top; width: 50%; padding-right: 1em">  
                                ...
                                <?php
                                    ...
                                    for ($i=0;$i<=$totalRows; $i++){  
                                        ...
                                        if ($i == $totalRows ){
                                            ...
                                            $_POST['arCode[]'] =  $rsARPaymentDetail[$i]['arcode'];
                                            $_POST['arTransRefCode[]'] = $rsARPaymentDetail[$i]['reftranscode2'];
                                            $_POST['arRefCode[]'] = $rsARPaymentDetail[$i]['refcode'];
                                            $_POST['arRefCode2[]'] = $rsARPaymentDetail[$i]['refcode2'];
                                            $_POST['arCustomerName[]'] =  $rsARPaymentDetail[$i]['customername'];
                                    ...
                                    <div class="div-table-col"  style="padding:0">
                                        <div class="div-table" style="width:100%">
                                            <div class="div-table-row"> 
                                                    <div class="div-table-col detail-col-detail">
                                                        ...
                                                        <?php echo $obj->inputText('arCode[]',array('disabled' => $disabled, 'overwritePost' => $overwrite, 'add-class' => 's-input')); ?>
                                                        <?php echo $obj->inputHidden('hidARKey[]',array('overwritePost' => $overwrite,'disabled' => $disabled)); ?>
                                                    </div>
                                                    <div class="div-table-col detail-col-detail" style="width:150px;"><?php echo $obj->inputText('arTransRefCode[]',array('overwritePost' => $overwrite,'readonly' => true, 'disabled' => $disabled, 'add-class' => 's-input')); ?></div> 
                                                    <div class="div-table-col detail-col-detail" style="width:80px;"><?php echo $obj->inputNumber('arOutstanding[]',array('overwritePost' => $overwrite,'readonly' => true, 'disabled' => $disabled, 'add-class' => 's-input',  'etc' => 'style="text-align:right"' )); ?></div> 
                                                    <div class="div-table-col detail-col-detail" style="width:80px;"><?php echo $obj->inputNumber('arAmount[]',array('overwritePost' => $overwrite, 'disabled' => $disabled, 'add-class' => 's-input',  'etc' => 'style="text-align:right"' )); ?></div> 
                                        ...
                                        <div class="div-table options-row" style="width: 100%;display:none;">
                                            <div class="div-table-row">
                                                  <div class="div-table-col detail-col-detail">
                                                      <div class="flex">
                                                        <div style="font-weight:bold"><?php echo $obj->lang['customer']; ?></div>
                                                        <div><?php echo $obj->inputText('arCustomerName[]',array('overwritePost' => $overwrite, 'readonly' => true, 'add-class' => 'label-style')); ?></div>
                                                      </div>
                                                      <div class="flex">
                                                          <div style="font-weight:bold"><?php echo $obj->lang['reference']; ?></div>
                                                          <div><?php echo $obj->inputText('arRefCode[]',array('overwritePost' => $overwrite, 'readonly' => true, 'add-class' => 'label-style')); ?></div>
                                                          <div><?php echo $obj->inputText('arRefCode2[]',array('overwritePost' => $overwrite, 'readonly' => true, 'add-class' => 'label-style')); ?></div>
                                                      </div> 
                                                  </div>   
                                            </div>
                        ...
                        <div class="div-table transaction-detail" style="width:100%;">
                            <div class="div-table-row">
                                ...
                                <div class="div-table-col detail-col-detail"  style="width:110px; vertical-align:top"><?php echo $obj->inputNumber('totalARAmount',array('readonly' => true, 'add-class'=>'s-input', 'etc' => 'style="text-align:right;')); ?></div>
                    ...
                    <div class="arap-col div-table-col-5" style="vertical-align:top; padding-left: 1em">  
                                ...
                                <?php
                                    ...
                                    for ($i=0;$i<=$totalRows; $i++){  
                                        ...
                                        if ($i == $totalRows ){
                                            ...
                                            $_POST['apCode[]'] =  $rsAPPaymentDetail[$i]['arcode'];
                                            $_POST['apTransRefCode[]'] = $rsAPPaymentDetail[$i]['reftranscode2'];
                                            $_POST['apRefCode[]'] = $rsAPPaymentDetail[$i]['refcode'];
                                            $_POST['apRefCode2[]'] =   $rsAPPaymentDetail[$i]['refcode2'];
                                            $_POST['apCustomerName[]'] =   $rsAPPaymentDetail[$i]['customername'];
                                        ...
                                        <div class="div-table" style="width:100%">
                                            <div class="div-table-row"> 
                                                    <div class="div-table-col detail-col-detail">
                                                        ...
                                                        <?php echo $obj->inputText('apCode[]',array('disabled' => $disabled, 'overwritePost' => $overwrite, 'add-class' => 's-input')); ?>
                                                        <?php echo $obj->inputHidden('hidAPKey[]',array('overwritePost' => $overwrite,'disabled' => $disabled)); ?>
                                                    </div>
                                                    <div class="div-table-col detail-col-detail" style="width:150px;"><?php echo $obj->inputText('apTransRefCode[]',array('overwritePost' => $overwrite,'readonly' => true, 'disabled' => $disabled, 'add-class' => 's-input')); ?></div>  
                                                    <div class="div-table-col detail-col-detail" style="width:80px;"><?php echo $obj->inputNumber('apOutstanding[]',array('overwritePost' => $overwrite,'readonly' => true, 'disabled' => $disabled, 'add-class' => 's-input',  'etc' => 'style="text-align:right"' )); ?></div> 
                                                    <div class="div-table-col detail-col-detail" style="width:80px;"><?php echo $obj->inputNumber('apAmount[]',array('overwritePost' => $overwrite, 'disabled' => $disabled, 'add-class' => 's-input',  'etc' => 'style="text-align:right"' )); ?></div> 
                                                    <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?> icon-col"><?php echo $obj->inputLinkButton('btnDeleteRows' , '<i class="fas fa-times"></i>', array('class' => 'btn btn-link remove-button')); ?> </div>
                                            </div>
                                        </div> 
                                        <div class="div-table options-row" style="width: 100%; display:none;">
                                            <div class="div-table-row">
                                                  <div class="div-table-col detail-col-detail">
                                                      <div class="flex">
                                                        <div style="font-weight:bold"><?php echo $obj->lang['customer']; ?></div>
                                                        <div><?php echo $obj->inputText('apCustomerName[]',array('overwritePost' => $overwrite, 'readonly' => true, 'add-class' => 'label-style')); ?></div>
                                                      </div>
                                                      <div class="flex">
                                                          <div style="font-weight:bold"><?php echo $obj->lang['reference']; ?></div>
                                                          <div><?php echo $obj->inputText('apRefCode[]',array('overwritePost' => $overwrite, 'readonly' => true, 'add-class' => 'label-style')); ?></div>
                                                          <div><?php echo $obj->inputText('apRefCode2[]',array('overwritePost' => $overwrite, 'readonly' => true, 'add-class' => 'label-style')); ?></div>
                                                      </div> 
                                                  </div>   
                                            </div>
                        ...
                        <div class="div-table transaction-detail" style="width:100%;">
                            <div class="div-table-row">
                                ...
                                <div class="div-table-col detail-col-detail"  style="width:110px; vertical-align:top"><?php echo $obj->inputNumber('totalAPAmount',array('readonly' => true,'add-class'=>'s-input', 'etc' => 'style="text-align:right;')); ?></div>
                                <div class="div-table-col detail-col-detail <?php echo $obj->hideOnDisabled(); ?> icon-col"></div>
                            </div>
                        </div> 
