...
includeClass(array('WarehouseLayout.class.php','Warehouse.class.php'));
...
$formAction = 'warehouseLayoutList';
...
if (!empty($_GET['id'])){ 
    ...
    $_POST['chkIsTransit'] = $rs[0]['istransit']; 
...
<script type="text/javascript"> 
	...
	jQuery(document).ready(function(){  
        ...
        var warehouseLayout = new WarehouseLayout(tabID,imageUpload);
    
        prepareHandler(warehouseLayout);  
                    ...
                    <div class="div-tab-panel"> 
                        <div class="div-table-caption border-orange"><?php echo ucwords($obj->lang['generalInformation']); ?></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9"> 
                                   <?php echo $obj->inputNumber('capacity', array());?> 
                                </div> 
                            </div>  
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['transitLocation']); ?></label> 
                                <div class="col-xs-9"> 
                                    <?php echo $obj->inputCheckBox('chkIsTransit'); ?> 
                                </div> 
                            </div>    
