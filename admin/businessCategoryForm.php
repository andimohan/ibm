...
includeClass(array('Category.class.php','BusinessCategory.class.php'));
...
$formAction = 'businessCategoryList';
...
if (!empty($_GET['id'])){      
	...
	if (!empty($arrChild))  $editCategoryCriteria = ' and '.$obj->tableName.'.pkey not in ('.implode(",",$arrChild).')';  
} 
...
<script type="text/javascript"> 
	...
	jQuery(document).ready(function(){  
        ...
        var businessCategory = new BusinessCategory(tabID);
    
        prepareHandler(businessCategory);   
