...
$formAction = 'categoryAssetItemList';
...
if (!empty($_GET['id'])){ 
	...
	$_POST['hidCOAKey'] = $obj->formatNumber($rs[0]['coakey']);
	if (!empty($rs[0]['coakey'])){
		$rsCoa = $chartOfAccount->getDataRowById($rs[0]['coakey']);
		$_POST['coa'] = $rsCoa[0]['code'] . ' - ' . $rsCoa[0]['name'];
	}
...
<script type="text/javascript"> 
	...
	jQuery(document).ready(function(){  
        ...
        var categoryAssetItem = new CategoryAssetItem(tabID);
    
        prepareHandler(categoryAssetItem);  
                ...
                <div class="div-table-col"> 
                    <div class="div-tab-panel"> 
                        <div class="div-table-caption border-orange"><?php echo ucwords($obj->lang['generalInformation']); ?></div>
                            ...
                            <!-- <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['maintenanceAccount']); ?></label> 
                                <div class="col-xs-9">  
                                    <?php 
                                        echo $obj->inputAutoComplete(array(
                                                             'objRefer' => $chartOfAccount,
                                                             'revalidateField' => true, 
                                                             'element' => array('value' => 'coa',
                                                                                'key' => 'hidCOAKey'),
                                                             'source' =>array(
                                                                                 'url' => 'ajax-coa.php',
