...
if (!empty($_GET['id'])){ 
    ...
    if (!empty($rs[0]['categorykey'])){
		$rsCategory = $filterCategory->getDataRowById($rs[0]['categorykey']);
                        ...
                        <div class="col-xs-9"> 
                              <?php  
                                        $popupOpt = (!$isQuickAdd) ? array(
                                                            'url' => 'filterCategoryForm.php',
                                                            'element' => array('value' => 'categoryName',
                                                                   'key' => 'hidCategoryKey'),
                                                            'width' => '600px',
                                                            'title' => $obj->lang['add'] . ' - ' . $obj->lang['filterCategory']
                                                        )  : '';
