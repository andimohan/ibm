...
$updatePurchasePriceAllowed = true; // $security->isAdminLogin($obj->updatePurchasePriceSecurityObject, 10); nanti kalo sudah ok baru diaktifkan, karena harus update semua user utk hak aksesnya
         ...
         var tabID = <?php echo ($isQuickAdd) ?  $_GET['tabID'] :  'selectedTab.newPanel[0].id';  ?> ; 
	 	 var tablekey = <?php echo $obj->getTableKeyAndObj($obj->tableName ,array('key'))['key']; ?>;  
            ...
            var varConstant = {  
                            ...
                            isActiveModulePurchasePrice : "<?php echo $obj->activeModule['purchaseprice']; ?>"
                            };
            var cashTOP = Array();
        ...
        <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; ">
                ...
                <?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $_POST['trDetailDesc[]'] =  $rsPurchaseDetail[$i]['trdesc'];
                            ...
                            $_POST['hidNeedSN[]'] = $rsPurchaseDetail[$i]['needsn'];
                ...
                <div class="div-table-row <?php echo $class; ?>"> 
                    ...
                    <div class="div-table" style="width:100%">
                            ...
                            <div class="div-table-col" style="padding:0">
                                <div class="div-table" style="width: 100%">
                                    <div class="div-table-row">
                                        ...
                                        <div class="div-table-col detail-col-detail" style="width:80px; text-align:right;vertical-align:top"><?php echo $obj->inputNumber('qty[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' .$etc)); ?></div>
                                        <div class="div-table-col detail-col-detail" style="width:80px;vertical-align:top"><?php echo $obj->inputSelect('selUnit[]',$arrUnit, array('overwritePost' => $overwrite, 'etc' =>  $etc)); ?></div>
                                        <div class="div-table-col detail-col-detail" style="width:100px; text-align:right;vertical-align:top"><?php echo $obj->inputNumber('priceInUnit[]', array('overwritePost' => $overwrite, 'readonly' => $readonlyPriceInUnit, 'etc' => 'style="text-align:right;"' .$etc)); ?></div>
                                        <div class="div-table-col detail-col-detail" style="width:100px; text-align:right;  padding-right:0;vertical-align:top"><?php echo $obj->inputNumber('discountValueInUnit[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;" ' .$etc)); ?></div>
                                        <div class="div-table-col detail-col-detail" style="width:80px; text-align:right;   padding-left:0.2em;vertical-align:top"><?php echo $obj->inputSelect('selDiscountType[]',$obj->arrDiscountType, array('overwritePost' => $overwrite, 'etc' =>  $etc)); ?></div>
                                        <div class="div-table-col detail-col-detail" style="width:180px; text-align:right;vertical-align:top"><?php echo $obj->inputNumber('detailSubtotal[]', array('overwritePost' => $overwrite, 'readonly' => true, 'etc' => 'style="text-align:right;" ' .$etc)); ?></div> 
                                    </div>
                                </div>
                            </div>

                            <div class="div-table-col detail-col-detail icon-col <?php echo $obj->hideOnDisabled(); ?>"  style="width:35px; vertical-align:top;  padding-top:0.7em !important"><?php echo $obj->inputLinkButton('btnMoreOptions' , 'SN', array('class' => 'btn btn-link btn-more-options btn-sn-options','disabled' => true )); ?></div>
                            <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?> icon-col" style="vertical-align:top; padding-top:0.7em !important">
                        ...
                        <?php echo $obj->SNPlugin($rsPurchaseDetail[$i], $overwrite, $etc,$disabled); ?>
