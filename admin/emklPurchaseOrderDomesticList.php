...
$addDataFile = 'emklPurchaseOrderDomesticForm';
...
array_push($arrSearchColumn, array('Job Order', $emklJobOrderDomestic->tableName. '.code')); 
array_push($arrSearchColumn, array('Job Order', $emklJobOrderHeaderDomestic->tableName. '.code'));
array_push($arrSearchColumn, array('Container', $emklJobOrderDomestic->tableName. '.containernumber')); 
array_push($arrSearchColumn, array('MBL', $emklJobOrderDomestic->tableName. '.mblnumber')); 
...
$obj->printMenu = array();  
array_push($obj->printMenu,array('code' => 'printTransaction', 'name' => $obj->lang['printTransaction'],  'icon' => 'print', 'url' => 'print/emklPurchaseOrderDomestic'));
