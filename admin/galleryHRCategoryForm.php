...
$formAction = 'galleryHRCategoryList';
...
<script type="text/javascript"> 
	...
	jQuery(document).ready(function(){  
        ...
        var galleryHRCategory = new GalleryHRCategory(tabID,"<?php echo $obj->uploadFolder; ?>",<?php echo json_encode($rsItemImage); ?>);
    
        prepareHandler(galleryHRCategory);   
