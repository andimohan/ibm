...
includeClass(array('LogisticSalesOrderManifest.class.php'));
...
$addDataFile = 'logisticSalesOrderManifestForm';
 
		
$arrSearchColumn = array ();
array_push($arrSearchColumn, array('Kode', $obj->tableName . '.code'));
array_push($arrSearchColumn, array('Tanggal', $obj->tableName . '.trdate'));
array_push($arrSearchColumn, array('Tujuan', $obj->tableCity . '.name')); 
