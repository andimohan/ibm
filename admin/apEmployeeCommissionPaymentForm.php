...
includeClass(array('APEmployeeCommissionPayment.class.php','PaymentMethod.class.php','Warehouse.class.php','Currency.class.php','Item.class.php', 'AR.class.php', 'AREmployee.class.php'));
...
$formAction = 'apEmployeeCommissionPaymentList';
...
if (!empty($_GET['id'])){ 
    ...
    $rsAREmployeeDetail =  $obj->getDetailAREmployee($id); 
    $rsAREmployee = $arEmployee->getAvailableAR($rs[0]['employeekey'], array_column($rsAREmployeeDetail,'aremployeekey')); // harus termasuk yg skrg sedang dipilih, kalo gk, setelah dikonfirmasi, gk muncul lg 
    
    $arrAREmployee = $obj->convertForCombobox($rsAREmployee, 'pkey', 'value');
    foreach ($rsAREmployee as $row) {
        $key = $row['pkey'];
        if (isset($row['outstanding'])) {
            $arrAREmployee[$key]['rel'] = ['rel-amount' => $row['outstanding']];
        }
    }
    ...
    $_POST['totalAREmployee'] = $obj->formatNumber($rs[0]['totalaremployee']);
...
jQuery(document).ready(function(){  
        ...
        var tabID = <?php echo ($isQuickAdd) ?  $_GET['tabID'] :  'selectedTab.newPanel[0].id';  ?>  
         ...
         var apEmployeeCommissionPayment = new APEmployeeCommissionPayment(tabID, <?php echo json_encode($rs); ?>);
    
         prepareHandler(apEmployeeCommissionPayment);   
        ...
        <div class="div-table mnv-transaction transaction-detail mnv-checkbox-group" style="width:100%; border-bottom:1px solid #333; ">
                    ...
                    <div class="div-table-col"  style="padding: 0.3em 0">
                        ...
                        <div class="div-table options-row" style="width: 100%">
                            <div class="div-table-row">
                                 ...
                                 <?php if (PLAN_TYPE['categorykey'] == COMPANY_TYPE['trucking']) { ?> 
          ...
          <div>     
                      <div class="div-table transaction-detail" style="float:right;">
                        ...
                        <div class="mnv-total-group mnv-ar-employee" >  
                            <div class="div-table" style="width: 100%">
                                <div class="div-table-row  form-group"> 
                                    <div class="div-table-col-3" style="text-align:right;"> 
                                        ...
                                        <div class="text-green-avocado flex" style="justify-content:flex-end">
                                            ...
                                            <div class="outstanding-ar-employee inputnumber">0</div>
                                        </div>
                                    </div>
                                    <div class="div-table-col-3" style="width:180px">
                                        <?php echo $obj->inputCollapsibleNumber('totalAREmployee', array('readonly' => true, 'etc' => 'style="text-align:right;" ')); ?>
                                    </div>
                                    <div class="div-table-col-3  <?php echo $obj->hideOnDisabled(); ?> icon-col"></div>
                                </div>
                            </div>
                            ...
                            <div class="mnv-total-group-detail ">
                                <div class="div-table transaction-detail" style="width: 100%">
                                    <?php
                                    $totalRows = count($rsAREmployeeDetail);
                                    for ($i = 0; $i <= $totalRows; $i++) {
                                        $class = 'transaction-detail-row';
                                        $overwrite = true;
                                        $disabled = false;
                                        ...
                                        if ($i == $totalRows) {
                                            $class = 'ar-employee-row-template row-template';
                                            $overwrite = false;
                                            $disabled = true;
                                        } else {
                                            $_POST['hidDetailAREmployeeKey[]'] = $rsAREmployeeDetail[$i]['pkey'];
                                            $_POST['selAREmployee[]'] = $rsAREmployeeDetail[$i]['aremployeekey'];
                                            $_POST['arEmployeeAmount[]'] = $obj->formatNumber($rsAREmployeeDetail[$i]['amount']);
                                        }
                                        ?>
                        
                                        <div class="div-table-row form-group <?php echo $class; ?>">
                                            <div class="div-table-col-3" style="text-align:right;">
                                                <?php echo $obj->inputHidden('hidDetailAREmployeeKey[]', array('overwritePost' => $overwrite, 'disabled' => $disabled)); ?>
                                                <?php echo $obj->inputSelect('selAREmployee[]', $arrAREmployee, array('overwritePost' => $overwrite, 'disabled' => $disabled)); ?>
                                            </div>
                                            <div class="div-table-col-3" style="width:180px">
                                                <?php echo $obj->inputNumber('arEmployeeAmount[]', array('overwritePost' => $overwrite, 'class' => 'form-control inputnumber mnv-detail-field', 'disabled' => $disabled, 'etc' => 'style="text-align:right;"')); ?>
                                            </div>
