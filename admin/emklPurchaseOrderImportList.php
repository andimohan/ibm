...
$addDataFile = 'emklPurchaseOrderImportForm';
...
array_push($arrSearchColumn, array('Job Order', $emklJobOrderHeaderImport->tableName. '.code'));
array_push($arrSearchColumn, array('Container', $emklJobOrderImport->tableName. '.containernumber')); 
array_push($arrSearchColumn, array('MBL', $emklJobOrderImport->tableName. '.mblnumber')); 
...
$obj->printMenu = array();  
array_push($obj->printMenu,array('code' => 'printTransaction', 'name' => $obj->lang['printTransaction'],  'icon' => 'print', 'url' => 'print/emklPurchaseOrderImport'));
