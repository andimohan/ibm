...
$formAction = 'templateEMKLJobOrderExportList';
...
$arrCargoType = $obj->convertForCombobox($emklJobOrderExport->getCargoType(),'pkey','name');    
...
$arrVolume = $class->convertForCombobox($emklJobOrderExport->getVolumeUnit(),'pkey','name');  
...
$arrShipmentTerm = $obj->generateComboboxOpt(array('data' => $emklJobOrderExport->getShipmentTerm())); 
$arrShipmentType = $obj->generateComboboxOpt(array('data' => $emklJobOrderExport->getShipmentType()));
...
<script type="text/javascript">  
	jQuery(document).ready(function(){  
         ...
         var emklJobOrder = new TemplateEMKLJobOrder(tabID,<?php echo json_encode(
                                                                array(
                                                                    'rs' => $rs,
