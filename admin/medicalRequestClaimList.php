...
$addDataFile = 'medicalRequestClaimForm';
...
function generateQuickView($obj,$id){ 
	...
	$basicInformation  = ' <div class="data-card border-orange">
						...
						<div class="div-table general-information-table">
							...
							<div class="div-table-row">
								<div class="div-table-col">'.ucwords($obj->lang['callerName']).'</div> 
								<div class="div-table-col">'.$rs[0]['callername'].'</div> 
							</div>
							<div class="div-table-row">
							...
							<div class="div-table-row">
								<div class="div-table-col">'.ucwords($obj->lang['insuredName']).'</div> 
								<div class="div-table-col">'.$rs[0]['insuredname'].'</div> 
							</div> 
							<div class="div-table-row">
								<div class="div-table-col">'.ucwords($obj->lang['policyNumber']).'</div> 
								<div class="div-table-col">'.$rs[0]['policynumber']. '</div> 
							</div> 
							<div class="div-table-row">
							...
							<div class="div-table-row">
								<div class="div-table-col">'.ucwords($obj->lang['company']).'</div> 
								<div class="div-table-col">'.$rs[0]['customername'].'</div> 
							</div>
							<div class="div-table-row">
								<div class="div-table-col">'.ucwords($obj->lang['insuranceCompany']).'</div> 
								<div class="div-table-col">'.$rs[0]['insurancecompanyname'].'</div> 
							</div> 
							<div class="div-table-row">
								<div class="div-table-col" style="height:1em"></div> 
								<div class="div-table-col"></div> 
		...
		$detailInformation  = ' <div class="data-card border-green">
						...
						<div class="div-table  quick-view-table">
							  <div class="div-table-row">  
                                <div class="div-table-col detail-col-header" style="width:80px;">'.ucwords($obj->lang['serviceCode']).'</div>
                                <div class="div-table-col detail-col-header">'.ucwords($obj->lang['serviceName']).'</div>
