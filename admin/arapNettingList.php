	...
	$basicInformation  = ' <div class="data-card border-orange">
						...
						<div class="div-table  general-information-table">
							...
							<div class="div-table-row">
								...
								<div class="div-table-col">'.$obj->formatNumber($rs[0]['totaldiscount']).'</div> 
							</div> 
							<div class="div-table-row">
								<div class="div-table-col">'. ucwords($obj->lang['tax23']).'</div> 
								<div class="div-table-col">'.$obj->formatNumber($rs[0]['prepaidtax23']).'</div> 
							</div> 
							<div class="div-table-row">
		...
		$detailInformation  = ' <div class="data-card border-green">
     	...
     	if ( in_array(PLAN_TYPE['categorykey'], array(COMPANY_TYPE['trucking'],COMPANY_TYPE['forwarding'])))
         	$detailInformation  .= ' <div class="div-table-col detail-col-header" style="width: 120px">'. ucwords($obj->lang['si']).'</div>';
        ...
        $paymentInformation  = ' <div class="data-card border-blue">
						...
						<div class="div-table  general-information-table" style="width:250px">';
        ...
        for ($j=0;$j<count($rsARDP);$j++){  
                ...
                $paymentInformation .= '<div class="div-table-col" style="text-align:right">'.$obj->formatNumber($rsARDP[$j]['amount']).'</div> '; 
        ...
        for ($j=0;$j<count($rsARPaymentMethodDetail);$j++){ 
                ...
                $paymentInformation .= '<div class="div-table-col" style="text-align:right">'.$obj->formatNumber($rsARPaymentMethodDetail[$j]['amount']).'</div> '; 
                $paymentInformation .= '</div>'; 
        } 
