...
includeClass(array('InvestorNewsCategory.class.php'));
...
$formAction = 'investorNewsCategoryList';
...
<head>
   ...
   <script type="text/javascript">
      ...
      jQuery(document).ready(function () {
         ...
         var investorNewsCategory = new InvestorNewsCategory(tabID);

         prepareHandler(investorNewsCategory);
