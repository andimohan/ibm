...
includeClass('SalesOrderRentalInvoice.class.php');
...
$formAction = 'salesOrderRentalInvoiceList';
...
$arrDefaultTimeUnit = $obj->convertForCombobox($timeUnit->searchData('','',true, ' and ('.$timeUnit->tableName.'.statuskey = 1 )'),'pkey','name');  
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        var cashTOP = Array();
         ...
         var salesOrderRentalInvoice = new SalesOrderRentalInvoice(tabID, <?php echo json_encode($rs); ?> ,cashTOP);
    
         prepareHandler(salesOrderRentalInvoice);
                    ...
                    <div class="div-table-col" >
                        <div class="div-table" style="width:100%">
                            <div class="div-table-row">
                                ...
                                <div class="div-table-col detail-col-detail" style="width:100px; padding-left: 13px">
                                    <div class="flex">
                                        <div>/</div>
                                        <div class="consume"><?php echo $obj->inputSelect('selTimeUnit[]',$arrTimeUnit, array('overwritePost' => $overwrite, 'disabled' => $disabled)); ?></div> 
                                    </div> 
                                 </div>
                                <div class="div-table-col detail-col-detail" style="width:80px; text-align:right;"><?php echo $obj->inputNumber('totalDays[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"' , 'disabled' => $disabled)); ?></div>
                                <div class="div-table-col detail-col-detail text-muted time-unit" style="width:60px; "><?php echo $timeunitname; ?></div>
                                <div class="div-table-col detail-col-detail" style="width:130px; text-align:right;"><?php echo $obj->inputNumber('detailSubtotal[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;" ', 'readonly' => true , 'disabled' => $disabled)); ?></div>
