...
includeClass(array('APPayment.class.php','APPayableTax23Payment.class.php'));
...
<script type="text/javascript">  
        ...
        var varConstant = { useStorage : <?php echo ($useStorage) ? "true" : "false"; ?> };
...
-->
        ...
        <div class="div-table mnv-transaction transaction-detail mnv-checkbox-group" style="width:100%; border-bottom:1px solid #333; ">
                <div class="div-table-row"> 
                    ...
                    <div class="div-table-col detail-col-header" style="width:160px;"><?php echo ucwords($obj->lang['reference']); ?></div>
				...
				<?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $_POST['refDate[]'] =   $obj->formatDBDate($rsAP[0]['refdate'],'d / m / Y');
                 ...
                 ?>
                  ...
                  <div class="div-table-row <?php echo $class; ?>"> 
                        ...
                        <div class="div-table-col detail-col-detail"><?php echo $obj->inputNumber('apAmount[]',array('overwritePost' => $overwrite, 'readonly' => true, 'disabled' => $disabled,'etc' => 'style="text-align:right"' )); ?></div> 
