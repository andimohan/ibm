...
includeClass('CreditNote.class.php');
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        var creditNote = new CreditNote(tabID,varConstant);
        prepareHandler(creditNote);     
      ...
      <div class="mnv-checkbox-group">
        <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; "  attr-level="0">
                <div class="div-table-row">  
                    ...
                    <div class="div-table-col detail-col-header" style="width:130px;"><?php echo ucwords($obj->lang['refCode']); ?></div>
                    ...
                    <div class="div-table-col detail-col-header" style="width:150px; text-align:right;"><?php echo ucwords($obj->lang['creditNote']); ?></div>
				...
				<?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $_POST['arCode[]'] =  $rsDetail[$i]['arcode'];
                            $_POST['refCode[]'] =  $rsDetail[$i]['refcode'];
                            $_POST['arDate[]'] =  $obj->formatDBDate($rsDetail[$i]['ardate']);  
                            $_POST['amount[]'] =   $obj->formatNumber($rsDetail[$i]['artotal'],$decimalPrice);
                            $_POST['creditTotal[]'] =   $obj->formatNumber($rsDetail[$i]['totalcredit'],$decimalPrice);
                ...
                <div class="div-table-row <?php echo $class; ?>">  
                    <div class="div-table-col detail-col-detail" >
                        <?php echo $obj->inputText('arCode[]',array('overwritePost' => $overwrite, 'disabled' => $disabled )); ?>
                    ...
                    <div class="div-table-col detail-col-detail" style="width:130px;"><?php echo $obj->inputText('refCode[]', array('overwritePost' => $overwrite, 'readonly'=>true,  'disabled' => $disabled)); ?></div> 
                    <div class="div-table-col detail-col-detail" style="width:130px; text-align:right;"><?php echo $obj->inputText('arDate[]', array('overwritePost' => $overwrite, 'readonly'=>true,  'disabled' => $disabled, 'etc' => 'style="text-align:center;"' )); ?></div> 
                    ...
                    <div class="div-table-col detail-col-detail" style="width:150px; text-align:right;"><?php echo $obj->inputNumber('creditTotal[]', array('overwritePost' => $overwrite,'class'=> 'form-control '.$inputClass,  'disabled' => $disabled, 'etc' => 'style="text-align:right;"' )); ?></div> 
