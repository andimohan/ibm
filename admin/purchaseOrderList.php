...
$addDataFile = 'purchaseOrderForm';
 
$arrSearchColumn = array ();
array_push($arrSearchColumn, array('Kode', $obj->tableName . '.code'));
array_push($arrSearchColumn, array('Permintaan Pembelian', $obj->tablePurchaseRequest . '.code'));
...
array_push($arrSearchColumn, array('Referensi Invoice', $obj->tableName. '.refinvoicecode') );
		...
		'; 	
            ...
            <div class="div-table quick-view-table" >
                  <div class="div-table-row"> 
                        ...
                        <div class="div-table-col detail-col-header" style="width:80px; text-align:right;">'.ucwords($obj->lang['discount']).' @</div>
