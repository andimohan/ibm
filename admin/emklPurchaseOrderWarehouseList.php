...
$addDataFile = 'emklPurchaseOrderWarehouseForm';
...
array_push($arrSearchColumn, array('Job Order', $emklJobOrderWarehouse->tableName. '.code')); 
array_push($arrSearchColumn, array('Job Order', $emklJobOrderHeaderWarehouse->tableName. '.code'));
array_push($arrSearchColumn, array('Container', $emklJobOrderWarehouse->tableName. '.containernumber')); 
array_push($arrSearchColumn, array('MBL', $emklJobOrderWarehouse->tableName. '.mblnumber')); 
...
$obj->printMenu = array();  
array_push($obj->printMenu,array('code' => 'printTransaction', 'name' => $obj->lang['printTransaction'],  'icon' => 'print', 'url' => 'print/emklPurchaseOrderWarehouse'));
