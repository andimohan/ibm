...
includeClass('SalesOrderReturn.class.php');
...
$addDataFile = 'salesOrderReturnForm';
   ...
   $detailInformation = ' <div class="data-card border-green">
						...
						<div class="div-table quick-view-table">
							  <div class="div-table-row"> 
									...
									<div class="div-table-col detail-col-header" style="width:90px; text-align:right;">' . ucwords($obj->lang['returnQty']) . '</div> 
   ...
   for ($i = 0; $i < count($rsDetail); $i++) {
      ...
      $detailInformation .= '
				<div class="div-table-row"> 
					...
					<div class="div-table-col" style="text-align:right;">' . $obj->formatNumber($rsDetail[$i]['returnqtyinbaseunit']) . '</div> 
