...
includeClass(array('InvestorNews.class.php', 'InvestorNewsCategory.class.php'));
$investorNews         = createObjAndAddToCol(new InvestorNews());
...
if (!empty($_GET['id'])) {
   ...
   if (!empty($rs[0]['categorykey'])) {
      $rsCategory            = $investorNewsCategory->getDataRowById($rs[0]['categorykey']);
      $categoryName          = $investorNewsCategory->getPath($rsCategory[0]['pkey']);
...
<head>
   ...
   <script type="text/javascript">
      jQuery(document).ready(function () {
         ...
         var investorNews = new InvestorNews(tabID, "<?php echo $obj->uploadFolder; ?>", <?php echo json_encode($rsItemImage); ?>);

         prepareHandler(investorNews);
            ...
            <div class="div-table-row">
               <div class="div-table-col">
                  <div class="div-tab-panel">
                        ...
                        <div class="col-xs-9">
                           ...
                           echo $obj->inputAutoComplete(
                              array( 
                                 ...
                                 'source'    => array(
                                    'url'  => 'ajax-investor-news-category.php',
                     ...
                     <div class="form-group">
                        <label class="col-xs-3 control-label">
                           <?php echo ucwords($obj->lang['featuredArticle']); ?>
                        </label>
                        <div class="col-xs-9">
                     ...
                     <div class="form-group">
                        <label class="col-xs-3 control-label">
                           <?php echo ucwords($obj->lang['keyword']); ?>
                        </label>
                        <div class="col-xs-9">
