...
$addDataFile = (isset($_GET) && !empty($_GET['showPrivileges'])) ? 'employeeForm?showPrivileges=1' : 'employeeForm';
...
array_push($arrSearchColumn, array('ID Absensi', $obj->tableName . '.attendanceid'));
