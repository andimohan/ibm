...
include '../_include-v2.php'; 
 ...
 includeClass(array('SalesOrderInvoiceReceipt.class.php','EMKLInvoiceReceipt.class.php','Warehouse.class.php'));
...
$formAction = 'emklInvoiceReceiptList';
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        var emklInvoiceReceipt = new EMKLInvoiceReceipt(tabID);
        prepareHandler(emklInvoiceReceipt);     
    ...
    <?php echo $obj->inputHidden('hidCurrentCustomerName'); ?> 
      ...
      <div class="mnv-checkbox-group">
        <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; "  attr-level="0">
                <div class="div-table-row">  
                    <div class="div-table-col detail-col-header"  style="width:180px;"><?php echo ucwords($obj->lang['invoiceCode']); ?></div> 
                    <div class="div-table-col detail-col-header"><?php echo ucwords($obj->lang['note']); ?></div> 
                    <div class="div-table-col detail-col-header" style="width:150px; text-align:center;"><?php echo ucwords($obj->lang['date']); ?></div>
				...
				<?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $_POST['detailNote[]'] =  $rsDetail[$i]['description'];
            ...
            <div class="div-table-row <?php echo $class; ?>"> 
                ...
                <div class="div-table-col detail-col-detail" style="text-align:right;"><?php echo $obj->inputText('detailNote[]',array('overwritePost' => $overwrite, 'etc' =>$etc)); ?></div> 
                <div class="div-table-col detail-col-detail" style="text-align:right;"><?php echo $obj->inputText('invoiceDate[]', array('overwritePost' => $overwrite, 'readonly'=>true,  'disabled' => $disabled, 'etc' => 'style="text-align:center;" ' )); ?></div> 
                <div class="div-table-col detail-col-detail" style="text-align:right;"><?php echo $obj->inputNumber('invoiceTotal[]',array('overwritePost' => $overwrite, 'readonly'=>true,  'class' => 'form-control inputnumber', 'disabled' => $disabled, 'etc' => 'style="text-align:right;"' )); ?></div> 
