...
<style>
    ...
    /*.subpanel {background:rgba(222,222,222, 0.6); border-radius: 0.5em; padding: 0.3em}*/
     .subpanel {border:1px solid #dedede; border-radius: 0.5em; padding: 0.3em}
</style> 
    ...
    <div class="div-table mnv-transaction transaction-detail no-odd-even-style" style="width:100%;" attr-level="0">
        ...
        <div class="div-table-row customer-row <?php echo $class; ?>"> 
            <div class="div-table-col" style="padding:0; padding-top:1.5em">   
                <div class="div-table row-panel subpanel" style="width:100%">
...
<!--                        <div class="div-table-col detail-col-header"><?php echo ucwords($obj->lang['description']); ?></div>-->
                        ...
                        <?php  
                            ...
                            for ($j=0;$j<=$totalItemRows; $j++){  
                                ...
                                if ($j == $totalItemRows ){
                                    ...
                                    $_POST['selDetailItemUnit[]'] = $rsItemDetail[$j]['unitkey'];
                                    $_POST['itemNameAliasDetail[]'] = $rsItemDetail[$j]['alias'];
                        ...
                        <div class="div-table-row <?php echo $class; ?>"> 
                            ...
                            <div class="div-table-col detail-col-detail" style="vertical-align:top;"><?php echo $obj->inputDecimal('qty[]', array('overwritePost' => $overwrite,'readonly' => $readonly, 'value' => 0, 'etc' => 'style="text-align:right;" mnv-attr-decimal="3"', 'disabled' =>  $disable)); ?></div>
                            
                            <div class="div-table-col detail-col-detail" style="vertical-align:top"><?php echo $obj->inputSelect('selDetailItemUnit[]', $arrUnit, array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disable)); ?></div>
                            ...
                            <div class="div-table-col detail-col-detail" style="vertical-align:top;">
                                ...
                                <?php echo $obj->inputText('itemNameAliasDetail[]', array('overwritePost' => $overwrite, 'readonly' => $readonly, 'disabled' => $disable, 'add-class' => 'label-style', 'etc' => 'placeholder="Alias"')); ?>
                            </div> 
<!--
...
-->
                            ...
                            <div class="div-table-col detail-col-detail" style="vertical-align:top;"><?php echo $obj->inputDecimal('priceInUnit[]', array('overwritePost' => $overwrite, 'etc' => 'style="text-align:right;"','readonly' => $readonly, 'disabled' =>  $disable, 'class' =>'form-control ' . $numberClass)); ?></div>
			             	<?php if ($updateTaxAtJobOrder == 1) { ?>
                                ...
                                <div class="div-table-col detail-col-detail" style="width:30px;text-align:center;vertical-align:top;  padding-top:10px">
                            ...
                            <div class="div-table-col detail-col-detail active-currency text-muted" style="vertical-align:top; padding-top:13px"><?php echo $arrCurrencyName[$activeCurrencyKey]['name'] ;?></div>
							...
							<?php if($updateTaxAtJobOrder == 1) { ?> 
									<div class="div-table-col detail-col-detail" style="text-align:center;vertical-align:top;  padding-top:10px">
										<?php echo $obj->inputCheckBox('chkIsReimburse[]', array('readonly' => $readonly,'disabled' => $disable, 'allowedStatusForEdit' => array(1))); ?>
									</div>
							<?php } ?>
                            <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col" style="vertical-align:top;padding-top:8px !important"><?php echo  $obj->inputLinkButton('btnAddDetailRow' , '<i class="fas fa-plus-circle"></i>', array('class' => 'btn btn-link add-row-button', 'etc' => 'attr-template="item-row-template"')); ?></div>
                            <div class="div-table-col detail-col-detail  <?php echo $obj->hideOnDisabled(); ?>  icon-col" style="vertical-align:top;padding-top:8px !important"><?php echo (!$readonly) ? $obj->inputLinkButton('btnDeleteSalesRows' , '<i class="fas fa-times"></i>', array('class' => 'btn btn-link remove-button', 'etc' => 'tabIndex="-1"')) : ''; ?></div>
                        </div>
