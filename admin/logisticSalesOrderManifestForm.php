...
includeClass(array('LogisticSalesOrderManifest.class.php','Warehouse.class.php'));
...
$formAction = 'logisticSalesOrderManifestList';
...
if (!empty($_GET['id'])){ 
	...
	$rsCity = $city->searchData('city.pkey', $rs[0]['recipientcitykey'], true);
	$_POST['cityName'] = $rsCity[0]['name'].', ' . $rsCity[0]['categoryname'];
	$_POST['hidCityKey'] = $rsCity[0]['pkey'] ;
    $_POST['hidCurrentCityName'] = $rsCity[0]['name'] ; 
	$_POST['hidCurrentCityrKey'] = $rsCity[0]['pkey'] ; 
	$_POST['hidCurrentTransportationKey'] = $rs[0]['transportationkey'] ;    
	$_POST['chkDatePeriod'] = $rs[0]['usedateperiod'];   
	$_POST['trStartDate'] = $obj->formatDBDate($rs[0]['startdateperiod'],'d / m / Y',$dateReturnOnEmpty);
	$_POST['trEndDate'] = $obj->formatDBDate($rs[0]['enddateperiod'],'d / m / Y',$dateReturnOnEmpty);
...
$arrTransportation = $obj->generateComboboxOpt(array('data' => $logisticSalesOrder->getTransportationType(), 'label' => 'name'));
...
<script type="text/javascript">  
	...
	jQuery(document).ready(function(){  
        ...
        var logisticSalesOrderManifest = new LogisticSalesOrderManifest(tabID);
        prepareHandler(logisticSalesOrderManifest);     
...
<div style="width:100%; margin:auto; " class="tab-panel-form">   
  ...
  <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>" >
    ...
    <?php echo $obj->inputHidden('hidCurrentCityKey'); ?>
    <?php echo $obj->inputHidden('hidCurrentCityName'); ?> 
    <?php echo $obj->inputHidden('hidCurrentTransportationKey'); ?>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-xs-9"> 
                                      <?php  echo $obj->inputAutoComplete(array( 
                                                                                ...
                                                                                'callbackFunction' => 'getTabObj().updateCityInformation(this,event, ui)'
      ...
      <div class="mnv-checkbox-group">
        <div class="div-table mnv-transaction transaction-detail" style="width:100%; border-bottom:1px solid #333; "  attr-level="0">
                <div class="div-table-row">  
                    <div class="div-table-col detail-col-header"><?php echo ucwords($obj->lang['soCode']); ?></div> 
				...
				<?php 
                    ...
                    for ($i=0;$i<=$totalRows; $i++){  
                        ...
                        if ($i == $totalRows ){
                            ...
                            $_POST['hidLogisticKey[]'] =  $rsDetail[$i]['sokey']; 
                            $_POST['logisticCode[]'] =  $rsDetail[$i]['socode'];
                            $_POST['logisticDate[]'] =  $obj->formatDBDate($rsDetail[$i]['sodate']);  
                            $_POST['logisticTotal[]'] =   $obj->formatNumber($rsDetail[$i]['amount']);
            ...
            <div class="div-table-row <?php echo $class; ?>"> 
                <div class="div-table-col detail-col-detail" >
                    <?php echo $obj->inputText('logisticCode[]',array('overwritePost' => $overwrite, 'disabled' => $disabled )); ?>
                    <?php echo $obj->inputHidden('hidLogisticKey[]',array('overwritePost' => $overwrite, 'disabled' => $disabled)); ?> 
                    <?php echo $obj->inputHidden('hidDetailKey[]',array('overwritePost' => $overwrite,  'disabled' => $disabled)); ?>
                </div>    
                <div class="div-table-col detail-col-detail" style="width:130px; text-align:right;"><?php echo $obj->inputText('logisticDate[]', array('overwritePost' => $overwrite, 'readonly'=>true,  'disabled' => $disabled, 'etc' => 'style="text-align:center;"' )); ?></div> 
                <div class="div-table-col detail-col-detail" style="width:150px; text-align:right;"><?php echo $obj->inputNumber('logisticTotal[]', array('overwritePost' => $overwrite, 'readonly'=>true,  'disabled' => $disabled, 'etc' => 'style="text-align:right;"' )); ?></div> 
