...
$addDataFile = 'emklInvoiceReceiptForm';
	...
	$basicInformation  = ' <div class="data-card border-orange">
        ...
        $detailInformation  = ' <div class="data-card border-green">
                                    ...
                                    <div class="div-table  quick-view-table">
                                            <div class="div-table-row">  
                                                <div class="div-table-col detail-col-header" style="text-align:left;  width: 150px">'.$obj->lang['invoiceCode'].'</div>
                                                <div class="div-table-col detail-col-header" style="text-align:left;">'.$obj->lang['note'].'</div>
                                                <div class="div-table-col detail-col-header" style="text-align:center;  width: 80px">'.$obj->lang['date'].'</div> 
                                                <div class="div-table-col detail-col-header" style="text-align:center;  width: 40px">'.$obj->lang['curr'].'</div>  
                                                <div class="div-table-col detail-col-header" style="text-align:right;  width: 100px">'.$obj->lang['total'].'</div>
                                            </div>
                                   ';
		for ($i=0;$i<count($rsDetail);$i++){ 
            ...
            $trdate =  $obj->formatDBDate($rsDetail[$i]['invoicedate']);
		     ...
		     $detailInformation  .= '   <div class="div-table-row">  
                                                ...
                                                <div class="div-table-col" style="">'.$rsDetail[$i]['description'].'</div>    
