...
$addDataFile = 'salesOrderRentalWorkOrderForm';
 
$arrSearchColumn = array ();
array_push($arrSearchColumn, array('Kode', $obj->tableName . '.code'));
array_push($arrSearchColumn, array('Kode Ref', $obj->tableSalesOrder . '.code'));
...
array_push($arrSearchColumn, array('Nama Penerima',$obj->tableSalesOrder . '.recipientname'));
array_push($arrSearchColumn, array('Nama Penerima',$obj->tableSalesOrder . '.recipientphone'));
array_push($arrSearchColumn, array('Nama Penerima',$obj->tableSalesOrder . '.recipientemail'));
array_push($arrSearchColumn, array('Nama Penerima',$obj->tableSalesOrder . '.recipientaddress'));
...
function generateQuickView($obj,$id){ 
	...
	$basicInformation  = ' <div class="data-card border-orange">
						...
						<div class="div-table general-information-table">
                            ...
                            <div class="div-table-row">
								<div class="div-table-col">'.ucwords($obj->lang['salesOrderRental']).'</div> 
		...
		$detailInformation  = ' <div class="data-card border-green">
						...
						<div class="div-table  quick-view-table">
							  <div class="div-table-row">  
                                <div class="div-table-col detail-col-header" style="width:100px;">'.ucwords($obj->lang['itemCode']).'</div>
                                <div class="div-table-col detail-col-header">'.ucwords($obj->lang['itemName']).'</div>
                                <div class="div-table-col detail-col-header" style="width:90px; text-align:right;">'.ucwords($obj->lang['qty']).'</div> 
                                <div class="div-table-col detail-col-header" style="width:80px;">'.ucwords($obj->lang['unit']).'</div> 
								</div>';
