...
if (!empty($_GET['id'])){ 
	...
	$_POST['youtubeid'] = $rs[0]['youtubeid'];  
  ...
  <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo $formAction; ?>">
       ...
       <div class="div-table main-tab-table-2">
              <div class="div-table-row">
                    <div class="div-table-col">  
                  		   	<div class="div-tab-panel">   
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label class="col-xs-3 control-label">Youtube ID</label> 
                                        <div class="col-xs-9"> 
                                              <?php echo $obj->inputText('youtubeid'); ?> 
                                        </div> 
                                     </div>
                            </div>   
                  </div>
                    <div class="div-table-col">  
                            <div class="div-tab-panel"> 
                                <div class="div-table-caption border-green">Deskripsi Singkat</div>
                                <div class="form-group">
                                 <div class="col-xs-12"> 
