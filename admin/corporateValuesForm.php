...
$corporateValues = createObjAndAddToCol( new CorporateValues()); 
...
$formAction = 'corporateValuesList';
...
<script type="text/javascript"> 
 jQuery(document).ready(function(){  
        ...
        var corporateValues = new CorporateValues(tabID, <?php echo json_encode($arrImages); ?>);
    
        prepareHandler(corporateValues);   
                    ...
                    <div class="div-table-col">  
                  		   	<div class="div-tab-panel">  
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['values']); ?></label> 
                                        <div class="col-xs-9"> 
                                     ...
                                     <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['detail']); ?></label> 
                                        <div class="col-xs-9"> 
                                            <?php echo $obj->inputTextArea('txtDetail',array('etc' => 'style="height:10em;"','multilang' => true )); ?>  
                                        </div> 
                                     </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                             <!-- image uploader --> 
                                            <div class="item-image-uploader item-image-uploader">
