...
if (!empty($_GET['id'])){ 
	...
	if (!empty($rs[0]['saleskey'])){
		$rsEmployee = $employee->searchDataRow(array($employee->tableName.'.pkey',$employee->tableName.'.name'),
	...
	if (!empty($rs[0]['brandkey'])){
		$rsBrand = $brand->searchDataRow(array($brand->tableName.'.pkey',$brand->tableName.'.name'),
         ...
         <div class="div-table main-tab-table-2"> 
            <div class="div-table-row">
               	 ...
               	 <div class="div-tab-panel">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
					 	...
					 	<div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['primarySalesman']); ?></label> 
                                <div class="col-xs-9"> 
                                        <?php   
                ...
                <div class="div-table-col">
                    ...
                    <div class="div-tab-panel"> 
                    <div class="div-table-caption border-purple"><?php echo ucwords($obj->lang['location']); ?></div> 
                            <div class="form-group">
            ...
            <div class="div-table-row">
                <div class="div-table-col">
                    ...
                    <?php   if ($obj->isActiveModule('AssetItem')){  ?>
                        <div class="col-xs-12 section-title"><?php echo strtoupper($obj->lang['inventoryAssetItem']); ?></div>  
                        ...
                        <?php
                            ...
                            ?>
                             <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['inventoryAssetItem']); ?></label> 
                                <div class="col-xs-9">  
                                    <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        ?>
                         <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['tempAssetItemInventory']); ?></label> 
                            <div class="col-xs-9">  
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                    ...
                    <?php 
                       ...
                       <!-- 
						...
						<?php if (PLAN_TYPE['categorykey'] == COMPANY_TYPE['property']) { ?>
							...
							<div class="form-group">
								<label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['adminRevenue']); ?></label> 
								<div class="col-xs-9"> 
									<?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
						...
						<div class="col-xs-12 section-title"><?php echo strtoupper($obj->lang['downpayment']); ?></div>      
						<?php 
                ...
                <div class="div-table-col">
                    ...
                    <div class="div-table-caption border-green" style="border-color:#fff !important">&nbsp;</div> 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['arReimbursement']); ?></label> 
                            <div class="col-xs-9">  
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
...
-->
                       ...
                       <?php  
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"  style="padding-top:0"><?php echo ucwords($obj->lang['commissionCost']); ?> (<?php echo ucwords($obj->lang['employee']); ?>)</label> 
                            <div class="col-xs-9">  
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['driverIncentive']); ?></label> 
                            <div class="col-xs-9">  
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label" style="padding-top:0"><?php echo ucwords($obj->lang['commissionCost']); ?> (<?php echo ucwords($obj->lang['supplier']); ?>)</label> 
                            <div class="col-xs-9">  
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                       ...
                       <?php 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['stampFee']); ?></label> 
                            <div class="col-xs-9">  
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['prepaidExpense']); ?></label> 
                            <div class="col-xs-9">  
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['asset']); ?></label> 
                            <div class="col-xs-9"> 
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['depreciationExpense']); ?></label> 
                            <div class="col-xs-9"> 
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['accumulatedDepreciation']); ?></label> 
                            <div class="col-xs-9"> 
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['vatOut']); ?></label> 
                            <div class="col-xs-9"> 
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['vatIn']); ?></label> 
                            <div class="col-xs-9">   
                                <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
                        ...
                        <?php if($obj->loadSetting('tax23GLInInvoice') == 1) { ?>
                            ...
                            ?>
                            <div class="form-group">
                                <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['prepaidTax23']); ?> (<?php echo ucwords($obj->lang['counterAccount']); ?>)</label> 
                                <div class="col-xs-9">   
                                    <?php echo $obj->inputHidden('hidrefkey[]',array('overwritePost' => false)); ?> 
