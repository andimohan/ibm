...
<script type="text/javascript"> 
	...
	jQuery(document).ready(function(){  
        ...
        var careerCategory = new CareerCategory(tabID,"<?php echo $obj->uploadFolder; ?>",<?php echo json_encode($rsItemImage); ?>);
    
        prepareHandler(careerCategory);   
