...
$arrImages = array();
array_push($arrImages, array('key' => 'image', 'uploadFolder' => $obj->uploadFolder,'uploaderTarget' => 'subsidiaries-image-uploader'));
array_push($arrImages, array('key' => 'imagecover', 'uploadFolder' => $obj->uploadCoverFolder,'uploaderTarget' => 'subsidiaries-cover-image-uploader'));
...
<script type="text/javascript"> 
 jQuery(document).ready(function(){  
        ...
        var subsidiaries = new Subsidiaries(tabID, <?php echo json_encode($arrImages); ?>);
    
        prepareHandler(subsidiaries);   
                    ...
                    <div class="div-table-col">  
                  		   	<div class="div-tab-panel">   
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                             <!-- image uploader --> 
                                            <div class="item-image-uploader subsidiaries-cover-image-uploader">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                             <!-- image uploader --> 
                                            <div class="item-image-uploader subsidiaries-image-uploader">
                                                <ul class="image-list" ></ul>
                                                <div style="clear:both; height:1em; "></div>
                                                <div class="file-uploader">	
                                                    <noscript><p>Please enable JavaScript to use file uploader.</p></noscript> 
