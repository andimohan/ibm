...
$formAction = 'emklJobOrderDomesticHeaderList';
...
$arrBillType = $class->convertForCombobox($emklJobOrderDomestic->getBillType(),'pkey','name');  
$arrFreight = $class->convertForCombobox($emklJobOrderDomestic->getFreightTerm(),'pkey','name'); 
$arrUnit = $class->convertForCombobox($itemUnit->searchData('','',true, ' and ('.$itemUnit->tableName.'.statuskey = 1 )'),'pkey','name');
