...
includeClass(array('News.class.php','NewsCategory.class.php'));
...
if (!empty($_GET['id'])){ 
    ...
    if (!empty($rs[0]['categorykey'])){
		$rsCategory = $newsCategory->getDataRowById($rs[0]['categorykey']);
        $categoryName =  $newsCategory->getPath($rsCategory[0]['pkey']);
...
<script type="text/javascript"> 
 jQuery(document).ready(function(){  
        ...
        var news = new News(tabID,"<?php echo $obj->uploadFolder; ?>",<?php echo json_encode($rsItemImage); ?>,"<?php echo $obj->uploadFileFolder; ?>",<?php echo json_encode($rsFile); ?>);
                    ...
                    <div class="div-table-col">
                    		<div class="div-tab-panel">  
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-xs-9"> 
                                             <?php    
                                                echo $obj->inputAutoComplete(array( 
                                                                                    'objRefer' => $newsCategory,
                                                                                    'element' => array('value' => 'categoryName',
                                                                                                       'key' => 'hidCategoryKey'),
                                                                                    'source' =>array(
                                                                                                        'url' => 'ajax-news-category.php',
                                                                                                        'data' => array(  'action' =>'searchData', 'isleaf' => 1 )
                                                                                                    ) ,
                                                                                    'popupForm' => array(
                                                                                                            'url' => 'newsCategoryForm.php',
                                                                                                            'element' => array('value' => 'categoryName',
                                                                                                                   'key' => 'hidCategoryKey'),
                                                                                                            'width' => '600px',
                                                                                                            'title' => $obj->lang['add'] . ' - ' . $obj->lang['newsCategory']
                                                                                                        )
                                                                                  )
                                                                            );  
                                                ?> 
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label"><?php echo ucwords($obj->lang['video']); ?></label> 
                                        <div class="col-xs-9"> 
                                              <?php echo $obj->inputText('videoURL'); ?>  
                                        </div> 
                                    </div> 
                                    <div class="form-group">
