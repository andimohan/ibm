...
$features = createObjAndAddToCol( new Features()); 
...
<script type="text/javascript"> 
 jQuery(document).ready(function(){  
        ...
        var features = new Features(tabID, <?php echo json_encode($arrImages); ?>);
    
        prepareHandler(features);   
