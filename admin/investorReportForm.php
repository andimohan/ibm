...
$investorReportCategory = createObjAndAddToCol(new InvestorReportCategory());
...
$arrCat = $investorReportCategory->generateComboboxOpt(null,array('criteria' =>' and '.$investorReportCategory->tableName.'.statuskey = 1 and  '.$investorReportCategory->tableName.'.isleaf = 1 ' ));
?>
<!DOCTYPE html
...
<head>
   ...
   <script type="text/javascript">
      jQuery(document).ready(function () {
         ...
         var investorReport = new InvestorReport(tabID,"<?php echo $obj->uploadFolder; ?>",<?php echo json_encode($rsItemImage); ?>,"<?php echo $obj->uploadFileFolder; ?>",<?php echo json_encode($rsFile); ?>);

         prepareHandler(investorReport);
