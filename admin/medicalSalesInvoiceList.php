...
$addDataFile = 'medicalSalesInvoiceForm';
...
array_push($arrSearchColumn, array('codeLog', $obj->tableSalesOrder . '.codelog')); 
	...
	$basicInformation  = ' <div class="data-card border-orange">
		...
		for ($i=0;$i<count($rsDetail);$i++){ 
             ...
             if ( $rsDetail[$i]['invoicetype'] == 1) { 
                 ...
                 $insuredname = $rsDetail[$i]['insuredname'];
                 $codelog = $rsDetail[$i]['codelog'];
		     ...
		     $detailInformation  .= '   <div class="div-table-row">  
                                                ...
                                                <div class="div-table-col" style="text-align:left;">'.$codelog.'</div>  
                                                <div class="div-table-col" style="text-align:left;">'.$insuredname.'</div>  
