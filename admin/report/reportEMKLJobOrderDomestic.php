...
$securityObject = 'reportSalesOrderDomesticFF'; // the value of security object is manually inserted to handle 
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['salesOrderDomesticReport']; 
...
/*        if(isset($_POST) && !empty($_POST['selCurrency'])) { 
    ...
    for( $i=0;$i<$totalRs;$i++) {    
        ...
        $rs[$i]['code'] = '<a href="/admin/print/emklJobOrderDomestic/'.$rs[$i]['pkey'].'" target="_blank">'.$rs[$i]['code'].'</a>';
