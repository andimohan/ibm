...
$arrDataStructure['refcode'] = array('title'=>ucwords($obj->lang['WOCode']),  'width'=>"100px", 'dbfield' => 'refcode');  
...
$arrDataStructure['salesman'] = array('title'=>ucwords($obj->lang['salesman']),'dbfield' => 'salesman', 'width'=>"170px" );
...
if (isset($_POST) && !empty($_POST['hidAction'])){   
    ...
    $tempreport = '';  
		...
		for( $i=0;$i<count($rs);$i++) { 
            ...
            $rsPayment = $apCommissionPayment->getDetailPaymentByAPKey($rs[$i]['pkey']);  
            if ($rs[$i]['datediff']  > 0 ){
