...
$arrDataStructure['totalInvoiced'] = array('title'=>ucwords($obj->lang['invoiced']),'dbfield' => 'totalinvoiced','align'=>'right', 'width'=>"110px",'format'=>'number','calculateTotal' => true); 

if($hasPurchaseRefundAccess)
	$arrDataStructure['totalRefund'] = array('title'=>ucwords($obj->lang['purchaseRefund']),'dbfield' => 'totalrefund','align'=>'right', 'width'=>"160px",'format'=>'number','calculateTotal' => true); 
...
//	} 
    ...
    for( $i=0;$i<$totalRs;$i++) {   
        ...
        //$rs[$i]['invoicenumber'] = (isset($rsInvoiceCol[$rs[$i]['pkey']])) ? implode('<br>',array_column($rsInvoiceCol[$rs[$i]['pkey']],'code')) : '';
        ...
        if ($rs[$i]['totalinvoiced'] < $rs[$i]['grandtotal']){ 
		...
		$rs[$i]['party'] = $rsPartyCol[$rs[$i]['pkey']];
...
echo $twig->render('reportTruckingServiceOrder.html', $arrTwigVar);  
