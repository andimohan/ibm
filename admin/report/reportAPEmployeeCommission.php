...
includeClass(array('AP.class.php','APPayment.class.php','APEmployeeCommission.class.php','APEmployeeCommissionPayment.class.php','Warehouse.class.php','Employee.class.php','Location.class.php'));
...
$arrDataStructure['refcode2'] = array('title'=>ucwords($obj->lang['reference']. ' 2'), 'width'=>"120px", 'dbfield'=>'refcode2');
$arrDataStructure['refdate'] = array('title'=>ucwords($obj->lang['jobsDate']), 'align'=>'center', 'width'=>"120px", 'dbfield'=>'refdate','format'=>'date');
$arrDataStructure['consignee'] = array('title'=>ucwords($obj->lang['consignee']), 'width'=>"200px", 'dbfield'=>'consigneename');
$arrDataStructure['route'] = array('title'=>ucwords($obj->lang['route']), 'width'=>"160px", 'dbfield'=>'route');
$arrDataStructure['location'] = array('title'=>ucwords($obj->lang['location']), 'width'=>"120px", 'dbfield'=>'locationname');
...
$arrDataStructure['currency'] = array('title'=>ucwords($obj->lang['currencyShort']), 'align'=>'center',     'width'=>"100px", 'dbfield'=>'currencyname');
