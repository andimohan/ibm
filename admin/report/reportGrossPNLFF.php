    ...
    for ($i = 0; $i < $totalRs; $i++) {
       ...
       switch ($rs[$i]['jobtypekey']) {
            ...
            case EMKL['jobType']['domestic']:
                ...
                break;
            case EMKL['jobType']['warehouse']:
                    $printUrl = '/admin/print/emklJobOrderWarehouse/' . $rs[$i]['pkey'];
                break;
            case EMKL['jobType']['trucking']:
                    $printUrl = '/admin/print/emklJobOrderTrucking/' . $rs[$i]['pkey'];
                break;
            default:
                    $printUrl = '#'; 
                break;
