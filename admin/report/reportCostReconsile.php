...
//$arrDataStructure['margin'] = array('title'=>ucwords($obj->lang['margin']),'dbfield' => 'profitloss', 'width'=>"100px" ,'format'=>'autodecimal');
...
if ($isDetail){ 
    ...
    $arrDataDetailStructure['refcode'] = array('title'=>ucwords($obj->lang['prepaidCost']),  'dbfield' => 'pecode', 'width'=>"100px" );  
