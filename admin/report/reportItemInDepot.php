...
$obj = $itemInDepot;
$securityObject = 'reportItemInDepot'; // the value of security object is manually inserted to handle 
...
$arrDataDetailStructure['qty'] = array('title'=>ucwords($obj->lang['quantity']),  'dbfield' => 'qty', 'width'=>"60px", 'format' => 'number' ,'calculateTotal' => true); 
...
if (isset($_POST) && !empty($_POST['hidAction'])){
    ...
    if(isset($_POST) && !empty($_POST['doCode'])) { 
	    ...
	    array_push($arrFilterInformation,array("label" => 'Kode Do', 'filter' => $_POST['doCode']));
	}
...
$arrTwigVar['inputDOCode'] =  $class->inputText('doCode'); 
...
echo $twig->render('reportItemInDepot.html', $arrTwigVar);   
