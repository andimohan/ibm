...
$securityObject = 'reportCashBankTrucking'; // the value of security object is manually inserted to handle 
...
$arrDataStructure['JOCode'] = array('title'=>ucwords($obj->lang['JOCode']),'dbfield' => 'jocode', 'width'=>"150px", "sortable" => false  );
$arrDataStructure['WOCode'] = array('title'=>ucwords($obj->lang['WOCode']),'dbfield' => 'wocode', 'width'=>"150px" , "sortable" => false ); 
$arrDataStructure['location'] = array('title'=>ucwords($obj->lang['location']),'dbfield' => 'location', 'width'=>"100px" , "sortable" => false ); 
$arrDataStructure['customer'] = array('title'=>ucwords($obj->lang['customer']),'dbfield' => 'customername', 'width'=>"180px" , "sortable" => false ); 
$arrDataStructure['consignee'] = array('title'=>ucwords($obj->lang['consignee']),'dbfield' => 'consigneename', 'width'=>"180px" , "sortable" => false ); 
$arrDataStructure['recipient'] = array('title'=>ucwords($obj->lang['recipient']),'dbfield' => 'recipient', 'width'=>"180px" , "sortable" => false );
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['garageCashVoucherReport'];
...
/*	if(isset($_POST) && !empty($_POST['cashBankCode'])) {
 ...
 // ============================= GENERATE DATA ============================= 
    ...
    $arrColumn = array('refcode','recipient','jocode', 'wocode', 'location', 'customername', 'consigneename');
    ...
    //$cashBank->setTimeLog('for get',true);
    ...
    //$cashBank->setTimeLog('end for get',true);
    
    //$cashBank->setTimeLog('for related',true);
    ...
    //$cashBank->setTimeLog('end for related',true);
    
    //$cashBank->setTimeLog('start',true);
...
echo $twig->render('reportCashBankVoucherTrucking.html', $arrTwigVar);   
