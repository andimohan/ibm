...
$securityObject = 'reportSalesCarServiceReturn'; // the value of security object is manually inserted to handle 
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['salesReturnReport']; 
...
$arrDataDetailStructure['returnedQty'] = array('title'=>"Dikembalikan",  'dbfield' => 'qty', 'width'=>"100px" , 'format' => 'number'); 
$arrDataDetailStructure['unit'] = array('title'=>ucwords($obj->lang['unit']),  'dbfield' => 'unitname', 'width'=>"100px" );  

$arrDetailTemplate = array();
$arrDetailTemplate['reportWidth'] = "550px";
...
if (isset($_POST) && !empty($_POST['hidAction'])){  
	...
	if(isset($_POST) && !empty($_POST['refCode'])) {
		$criteria .= ' AND '.$obj->tableSalesOrderHeader.'.code LIKE ('.$class->oDbCon->paramString('%'.$_POST['refCode'].'%').')';
...
echo $twig->render('reportSalesCarServiceReturn.html', $arrTwigVar);  
