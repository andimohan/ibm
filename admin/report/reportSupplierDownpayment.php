...
includeClass(array('Downpayment.class.php','SupplierDownpayment.class.php','Warehouse.class.php'));
...
$securityObject = 'reportSupplierDownpayment'; // the value of security object is manually inserted to handle 
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['supplierDownpaymentReport'];
...
echo $twig->render('reportSupplierDownpayment.html', $arrTwigVar);   
?>
