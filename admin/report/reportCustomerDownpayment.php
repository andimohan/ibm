...
$securityObject = 'reportCustomerDownpayment'; // the value of security object is manually inserted to handle 
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['customerDownpaymentReport'];
...
if (isset($_POST) && !empty($_POST['hidAction'])){   
	...
	// 	$criteria .= ' AND '.$obj->tableCustomer.'.name LIKE ('.$class->oDbCon->paramString('%'.$_POST['selCustomer'].'%').')';
	// 	array_push($arrFilterInformation,array("label" => 'Nama Customer', 'filter' =>  $_POST['selCustomer']));
	// }
    ...
    for( $i=0;$i<count($rs);$i++) {   
        ...
        //$outstandingStyle = ($aging > 0) ? 'text-red-cardinal' : 'text-blue-munsell' ;
...
echo $twig->render('reportCustomerDownpayment.html', $arrTwigVar);   
?>
