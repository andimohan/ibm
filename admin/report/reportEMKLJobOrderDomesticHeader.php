...
$securityObject = 'reportEmklJobOrderHeaderDomestic'; // the value of security object is manually inserted to handle 
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['jobOrderHeaderDomesticReport']; 
...
echo $twig->render('reportEMKLJobOrderDomesticHeader.html', $arrTwigVar);  
