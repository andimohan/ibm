...
$obj = $cashBankIn;
$securityObject = 'reportCashBankIn'; // the value of security object is manually inserted to handle 
...
$_POST['module'] = IMPORT_TEMPLATE['cashBankIn'];
switch($EXPORT_TYPE){
    case 2 :
...
$arrHeaderTemplate['reportTitle'] = str_replace('/','',$obj->lang['cashBankInReport']);
...
if (isset($_POST) && !empty($_POST['hidAction'])){
	...
	if(isset($_POST) && !empty($_POST['cashBankInCode'])) {
		$criteria .= ' AND '.$obj->tableName.'.code LIKE ('.$class->oDbCon->paramString('%'.$_POST['cashBankInCode'].'%').')';
		array_push($arrFilterInformation,array("label" => $obj->lang['code'], 'filter' => $_POST['cashBankInCode']));
	}
...
$arrTwigVar['inputCashBankInCode'] =  $class->inputText('cashBankInCode');
$arrTwigVar['arrTemplate'] =  $arrHeaderTemplate;      
echo $twig->render('reportCashBankIn.html', $arrTwigVar);   
