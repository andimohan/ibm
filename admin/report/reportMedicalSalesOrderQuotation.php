...
$securityObject = 'ReportMedicalSalesOrderQuotation'; // the value of security object is manually inserted to handle 
...
$_POST['module'] = IMPORT_TEMPLATE['salesOrderQuotation'];
...
switch($EXPORT_TYPE){
    case 2 :
        ...
        $arrDataStructure['attention'] = array('title' => ucwords($obj->lang['attention']),  'width' => "150px", 'dbfield' => 'attention');
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['priceQuotationReport'];
...
if (isset($_POST) && !empty($_POST['hidAction'])){  
    ...
    foreach ($rsReIndex as $index) {
        $rsInitialDiagnoseDetail = $medicalRequestClaim->getDetailDiagnose($index['refrequestkey']);
...
echo $twig->render('reportMedicalSalesOrderQuotation.html', $arrTwigVar);  
