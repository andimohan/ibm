...
$securityObject = 'reportEMKLInvoiceReceipt'; // the value of security object is manually inserted to handle 
...
$arrDataDetailStructure['currency'] = array('title'=>ucwords($obj->lang['currency']),'dbfield' => 'currencyname', 'width'=>"120px");
$arrDataDetailStructure['description'] = array('title'=>ucwords($obj->lang['note']),'dbfield' => 'description', 'width'=>"300px");
...
echo $twig->render('reportEMKLInvoiceReceipt.html', $arrTwigVar);   
?>