...
$securityObject = 'reportEmklJobOrderHeaderExport'; // the value of security object is manually inserted to handle 
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['jobOrderHeaderExportReport']; 
...
echo $twig->render('reportEMKLJobOrderExportHeader.html', $arrTwigVar);  
