...
$securityObject = 'reportPurchaseOrderImportFF'; // the value of security object is manually inserted to handle 
...
$arrDataStructure['Consignee'] = array('title'=>ucwords($obj->lang['consignee']),'dbfield' => 'shippername', 'width'=>"150px" );
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['purchaseOrderImportReport']; 
