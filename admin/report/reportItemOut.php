...
$obj = $itemOut;
$securityObject = 'reportItemOut'; // the value of security object is manually inserted to handle 
...
$_POST['module'] = IMPORT_TEMPLATE['itemOut'];
...
if (isset($_POST) && !empty($_POST['hidAction'])){
    ...
    $rs = array();
    if ($EXPORT_TYPE != 2)
          $rs = (!$isGrouping) ? $obj->generateItemOutReport($criteria.$detailCriteria,$order) :  $obj->searchData('','',true,$criteria,$order);
...
echo $twig->render('reportItemOut.html', $arrTwigVar);   
