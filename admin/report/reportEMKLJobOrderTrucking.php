...
$securityObject = 'reportSalesOrderTruckingFF'; // the value of security object is manually inserted to handle 
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['salesOrderTruckingReport'];
...
//	}
    ...
    for ($i = 0; $i < $totalRs; $i++) {
        ...
        $rs[$i]['code'] = '<a href="/admin/print/emklJobOrderTrucking/' . $rs[$i]['pkey'] . '" target="_blank">' . $rs[$i]['code'] . '</a>';
