...
$arrDataStructure['taxIdentificationNumber'] = array('title'=> 'NPWP pemotong / pemungut',  'width'=>"200px", 'dbfield'=>'customertaxid', "sortable" => false);
$arrDataStructure['namePPH'] = array('title'=> 'Nama pemotong / pemungut',  'width'=>"200px", 'dbfield' => 'customertaxregistrationname',"sortable" => false);
$arrDataStructure['address'] = array('title'=> 'Alamat pemotong / pemungut',  'width'=>"200px", 'dbfield' => 'customertaxregistrationaddress',"sortable" => false);
$arrDataStructure['mapcode'] = array('title' => 'Kode MAP / iuran pembayaran',  'width'=>"200px", 'dbfield' => 'mapcode',"sortable" => false);
$arrDataStructure['NTPP'] = array('title' => 'NTPP','dbfield' => 'ntpp', 'width'=>"170px" , "sortable" => false);
...
if (isset($_POST) && !empty($_POST['hidAction'])){   
    ...
    for( $i=0;$i<count($rs);$i++) {   
            ...
            $percentage = (!empty($rs[$i]['customertaxid'])) ? 0.02 : 0.04;
...
echo $twig->render('reportARPrepaidTax23PaymentTemplate.html', $arrTwigVar);   
?>
