...
// init, ad kemungkinan jenis AR dr UM dan Retail
$truckingType = 0;
...
if(!empty($isActiveModule['truckingserviceorder'])){ 
    ...
    // kalo jenis trucking 
    $truckingType = $truckingServiceOrderInvoice->getTableKeyAndObj($truckingServiceOrderInvoice->tableName ,array('key'))['key'];
}
