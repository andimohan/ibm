...
$obj= $purchaseReceive;
$securityObject = 'reportPurchaseReceive'; // the value of security object is manually inserted to handle 
...
$arrDataStructure['purchaseOrder'] = array('title'=>ucwords($obj->lang['purchaseOrder']),  'width'=>"100px", 'dbfield' => 'purchaseordercode');
$arrDataStructure['supplier'] = array('title'=>ucwords($obj->lang['supplier']),'dbfield' => 'suppliername', 'width'=>"200px", 'mergeExcelCell' => 2);
...
$arrHeaderTemplate['reportTitle'] = $obj->lang['purchaseReceiveReport']; 
...
$arrDataDetailStructure['receivedQty'] = array('title'=>ucwords($obj->lang['receivedQty']),  'dbfield' => 'receivedqty', 'width'=>"100px" , 'format' => 'number'); 
...
if (isset($_POST) && !empty($_POST['hidAction'])){  
	...
	if(isset($_POST) && !empty($_POST['purchaseCode'])) {
		$criteria .= ' AND '.$obj->tablePurchaseOrderHeader.'.code LIKE ('.$class->oDbCon->paramString('%'.$_POST['purchaseCode'].'%').')';
		array_push($arrFilterInformation,array("label" => 'Kode PO', 'filter' => $_POST['purchaseCode']));
	}
...
echo $twig->render('reportPurchaseReceive.html', $arrTwigVar);  
