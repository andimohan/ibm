...
$addDataFile = 'emklJobOrderExportForm';
...
$detail = '';
	...
	$basicInformation  = ' <div class="data-card border-orange">
						...
						<div class="div-table  general-information-table">
							...
							<div class="div-table-row">
								<div class="div-table-col">AJU</div> 
								<div class="div-table-col">'.$rs[0]['aju'].'</div> 
							</div> 
							<div class="div-table-row">
								<div class="div-table-col">PEB</div> 
								<div class="div-table-col">'.$rs[0]['peb'].'</div> 
							</div>   
                            <div class="div-table-row">
