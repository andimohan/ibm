...
$addDataFile = 'currencyRateMasterForm';
...
function generateQuickView($obj,$id){  
	...
	$rate  = '<div class="data-card border-red" style="margin:auto;">
						<h1>'.$obj->lang['currencyRate'].'</h1>
						<div class="content">';
						
	$rate  .= '<div class="div-table  quick-view-table">
                     <div class="div-table-row"> 
                            <div class="div-table-col detail-col-header" style="width:100px;">'.ucwords($obj->lang['currency']).'</div>  
     ...
     for($i=0;$i<count($rsDetail);$i++){
         $rate .= ' <div class="div-table-row">
                            <div class="div-table-col" style="width:50px">'. $rsDetail[$i]['currencyname'] .' </div> 
