...
$addDataFile = 'salesOrderSubscriptionForm';
...
function generateQuickView($obj,$id){ 
    ...
    $rsDetail = $obj->getMonthlyDetailRelatedInformation($id);
    $rsDetailFirst = $obj->getDetailWithRelatedInformation($id);
	...
	$basicInformation  = ' <div class="data-card border-orange">
                                ...
                                <div class="div-table  general-information-table">
                                    ...
                                    <div class="div-table-row">
                                        <div class="div-table-col">'.ucwords($obj->lang['tax']).' '.ucwords($obj->lang['initialCost']).'</div> 
                                        <div class="div-table-col">'.$obj->formatnumber($rs[0]['taxvalue']).'</div> 
                                    </div>
									<div class="div-table-row">
                                        <div class="div-table-col">'.ucwords($obj->lang['tax']).' '.ucwords($obj->lang['monthlyCost']).'</div> 
                                        <div class="div-table-col">'.$obj->formatnumber($rs[0]['taxvaluemonthly']).'</div> 
                                    </div>
                                    <div class="div-table-row">
        ...
        $detailFirstInformation  = ' <div class="data-card border-green">
						<h1>'.ucwords($obj->lang['initialCost']).'</h1> 
						<div class="content">
		...
		for ($i=0;$i<count($rsDetailFirst);$i++){
			 
			$detailFirstInformation  .= '
				<div class="div-table-row">  
					<div class="div-table-col">'.$rsDetailFirst[$i]['itemname'].'</div>
					<div class="div-table-col" style="text-align:right;">'.$obj->formatNumber($rsDetailFirst[$i]['qty']).'</div>
                    <div class="div-table-col" style="text-align:right;">'.$obj->formatNumber($rsDetailFirst[$i]['priceinunit']).'</div>
					<div class="div-table-col" style="text-align:right;">'.$obj->formatNumber($rsDetailFirst[$i]['total']).'</div> 
				</div>
			';
		}
		...
		$detailInformation  = ' <div class="data-card border-red">
						<h1>'.ucwords($obj->lang['monthlyCost']).'</h1> 
						<div class="content">
						<div class="div-table  quick-view-table">
							  <div class="div-table-row">  
                                <div class="div-table-col detail-col-header">'.ucwords($obj->lang['description']).'</div>
