...
$addDataFile = 'emklPurchaseOrderTruckingForm';
...
array_push($arrSearchColumn, array('Job Order', $emklJobOrderTrucking->tableName. '.code')); 
array_push($arrSearchColumn, array('Job Order', $emklJobOrderHeaderTrucking->tableName. '.code'));
array_push($arrSearchColumn, array('Container', $emklJobOrderTrucking->tableName. '.containernumber')); 
array_push($arrSearchColumn, array('MBL', $emklJobOrderTrucking->tableName. '.mblnumber')); 
...
$obj->printMenu = array();  
array_push($obj->printMenu,array('code' => 'printTransaction', 'name' => $obj->lang['printTransaction'],  'icon' => 'print', 'url' => 'print/emklPurchaseOrderTrucking'));
