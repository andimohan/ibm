...
$sql = 'select pkey from customer_downpayment where statuskey in (2,3) and year(trdate) = 2022 order by trdate asc, code asc '; // and month(trdate) = 1
...
foreach($result as $chunkRow){ 
    $link =  'https://eai.local/admin/print/customerDownpayment/'.implode(',', $chunkRow);  
