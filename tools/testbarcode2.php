...
foreach ($linear as $type => $code) {
    ...
    $examples .= '<img alt="Embedded Image" src="data:image/png;base64,'.base64_encode($bobj->getPngData()).'" />';
}
...
$bobj = $barcode->getBarcodeObj('QRCODE,H', 'https://tecnick.com', -4, -4, 'black', array(-2, -2, -2, -2));
