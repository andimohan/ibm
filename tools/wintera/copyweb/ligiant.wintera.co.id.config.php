...
// JS 
array_push($arrFiles,'include/js-1.9/formJS-1.310.min.js'); // ini berubah terus
array_push($arrFiles,'include/js-1.9/main-3.109.min.js');
...
array_push($arrFiles,'include/js-1.9/jquery.jquery.contextMenu-1.1.min.js');
...
array_push($arrFiles,'include/'.CLASS_VERSION.'/TimeUnit.class.php');

// ecommerce
array_push($arrFiles,'include/'.CLASS_VERSION.'/Voucher.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/VoucherTransaction.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/Xendit.class.php');
...
array_push($arrFiles,'include/'.CLASS_VERSION.'/Event.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/EventCategory.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/SalesOrder.class.php');
...
array_push($arrFiles,'include/'.CLASS_VERSION.'/Country.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/Currency.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/Shipment.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/BusinessCategory.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/JobPosition.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/CustomerFeatures.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/TermOfPayment.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/PaymentMethod.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/PartnersCategory.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/AR.class.php');
...
array_push($arrFiles,'include/'.CLASS_VERSION.'/ContactCategory.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/PricingCategory.class.php');
...
array_push($arrFiles,'include/'.CLASS_VERSION.'/CustomerIssue.class.php'); 
...
array_push($arrFiles,'include/'.CLASS_VERSION.'/Biteship.class.php');
...
array_push($arrFiles,'include/'.CLASS_VERSION.'/PackagingCode.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/VatOut.class.php');
array_push($arrFiles,'include/'.CLASS_VERSION.'/RewardsPoint.class.php');
...
array_push($arrFiles,'admin/employeeForm.php');
...
array_push($arrFiles,'admin/templateCustomerList.php');
array_push($arrFiles,'admin/templateCustomerForm.php');
array_push($arrFiles,'admin/itemUnitForm.php');
array_push($arrFiles,'admin/itemUnitList.php');
array_push($arrFiles,'admin/brandForm.php');
array_push($arrFiles,'admin/brandList.php');
array_push($arrFiles,'admin/ajax-item-category.php');
array_push($arrFiles,'admin/ajax-marketplace.php');
...
array_push($arrFiles,'admin/voucherForm.php');
array_push($arrFiles,'admin/voucherList.php');
array_push($arrFiles,'admin/voucherTransactionForm.php');
array_push($arrFiles,'admin/voucherTransactionList.php');
array_push($arrFiles,'admin/salesOrderFormphp');
array_push($arrFiles,'admin/salesOrderList.php');
// 
...
array_push($arrFiles,'admin/eventCategoryForm.php');
array_push($arrFiles,'admin/eventCategoryList.php');

array_push($arrFiles,'api/sso/google-login.php');
array_push($arrFiles,'api/sso/fb-login.php');
array_push($arrFiles,'api/sso/login.php');
array_push($arrFiles,'api/xendit/payment.php');

array_push($arrFiles,'admin/print/print.php');
array_push($arrFiles,'admin/print/_global.php');
array_push($arrFiles,'admin/print/salesOrder.php');
...
array_push($arrFiles,'transaction-history-detail.php');
array_push($arrFiles,'customer-issue.php');
array_push($arrFiles,'ajax-customer-issue.php');
array_push($arrFiles,'ajax-voucher.php');
array_push($arrFiles,'ajax-voucher-transaction.php');
array_push($arrFiles,'redeem-voucher.php');
array_push($arrFiles,'popup-voucher.php');
array_push($arrFiles,'shipping-address.php');
array_push($arrFiles,'invoice.php');
array_push($arrFiles,'popup-registration.php');
array_push($arrFiles,'popup-login.php');
array_push($arrFiles,'popup-multi-address.php');
array_push($arrFiles,'popup-voucher-tnc.php');
array_push($arrFiles,'popup-voucher.php');
array_push($arrFiles,'_include-customer-information.php');
array_push($arrFiles,'payment.php');
array_push($arrFiles,'payment-success.php');
