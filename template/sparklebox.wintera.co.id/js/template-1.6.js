...
jQuery(document).ready(function(){ 
        ...
        if (window.location.pathname === '/') {
            // console.log('home');
            $('.header-menu').removeClass('bg-blue-sbox text-white').addClass('bg-white');
            $('.mobile-menu-bar').removeClass('bg-blue-sbox text-white').addClass('bg-white');
            $('.user-menu li, .user-menu li a').addClass('text-black-jet');

        } else {
            // console.log('not home');
            $('.header-menu').removeClass('bg-white').addClass('bg-blue-sbox');
            $('.mobile-menu-bar').removeClass('bg-white').addClass('bg-blue-sbox');
            $('.mobile-menu-bar .burger span').attr('style', 'background: #FFFFFF !important');
            $('.main-menu a, .user-menu i').addClass('text-white');
            $('.user-menu li a').addClass('text-white');
        }
