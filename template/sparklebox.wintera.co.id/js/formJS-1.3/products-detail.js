function ProductsDetail(opt){   
    ...
    this.loadOnReady = function loadOnReady(){
     ...
     $('.icon-desc').click(function() {
        ...
        descObj.find('.description').css('margin', '2.2em 0');

        var iconObj = $('.description-header .icon-desc');
        iconObj.toggleClass("fa-plus");
        iconObj.toggleClass("fa-minus");
