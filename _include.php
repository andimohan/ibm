...
require_once DOC_ROOT. 'include/'.CLASS_VERSION.'/CashAdvance.class.php';   
require_once DOC_ROOT. 'include/'.CLASS_VERSION.'/CashAdvanceRealization.class.php';  
require_once DOC_ROOT. 'include/'.CLASS_VERSION.'/EMKLHouseBL.class.php';  
require_once DOC_ROOT. 'include/'.CLASS_VERSION.'/CustomCode.class.php';  
...
require_once DOC_ROOT. 'include/'.CLASS_VERSION.'/EMKLInvoiceReceipt.class.php';  
require_once DOC_ROOT. 'include/'.CLASS_VERSION.'/APCommission.class.php';  
require_once DOC_ROOT. 'include/'.CLASS_VERSION.'/APCommissionPayment.class.php';  
...
$class->setLog(date('d / m / Y H:i') . ' '.$_SERVER['HTTP_REFERER'] . ' => ' . $_SERVER['PHP_SELF'] ,true,'includelog.txt');
