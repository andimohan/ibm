...
// sementara disini dulu biar ggk perlu udate setiap page,
// nanti kalo ad waktu baru pindahin ke setiap page
$IS_ACTIVE_MODULE = $class->isActiveModule(array('banner','item','partners','testimonial','youtube','page','portfolio',
                                                 'service','course','quiz','gallery','news','article' , 'event',
                                                 'investorRelations','corporatevalues','subsidiaries','investornews','achievement',
                                                 'csrcategory','features','goodcorporategovernmentcategory','newrelease','city'));
